...
export const BUILDING_PRESETS: BuildingPreset[] = [
  ...
  //   structure: [{ position: [0, 2, 0], scale: [2, 4, 2] }],
  // },
  ...
  //   structure: [{ position: [0, 0.75, 0], scale: [3, 1.5, 3] }],
  // },
  ...
  // 2: ㄱ자 건물
  {
    ...
    structure: [
      { position: [1, 1.5, 0], scale: [2, 3, 1] },
      { position: [0.25, 1.5, 2], scale: [1, 3, 3] },
    ],
  },
  ...
  // 6: T자 건물
  {
    ...
    structure: [
      { position: [0, 1, -0.5], scale: [4, 2, 1] },
      { position: [0, 1, 1.25], scale: [1.5, 2, 2] },
    ],
  },

  // 7: 십자 건물 (겹치지 않게 수정: 가로와 세로 박스를 분리)
  {
    meshIndex: 7,
    name: "크로스 빌딩",
    description: "십자 형태의 건물",
    structure: [
      { position: [0, 1.5, -1], scale: [1, 3, 3] },
      { position: [-1, 1.5, 0], scale: [1.5, 3, 1] },
      { position: [1, 1.5, 0], scale: [1.5, 3, 1] },
    ],
  },
  ...
  // 10: 중앙 타워 + 날개
  {
    ...
    structure: [
      ...
      { position: [-1.875, 0.5, 0], scale: [1.5, 1, 2] },
      { position: [1.875, 0.5, 0], scale: [1.5, 1, 2] },
    ],
  },
