(async ()=>{
    (function() {
        ...
        new MutationObserver((t)=>{
            for (const e of t)if (e.type === "childList") for (const r of e.addedNodes)r.tagName === "LINK" && r.rel === "modulepreload" && l(r);
        }).observe(document, {
            childList: !0,
            subtree: !0
        });
    ...
    const d = "modulepreload", m = function(s) {
        return "/" + s;
    }, u = {}, h = function(o, i, l) {
        ...
        return Promise.all(i.map((e)=>{
            ...
            if (!!l) for(let c = t.length - 1; c >= 0; c--){
                const a = t[c];
                if (a.href === e && (!r || a.rel === "stylesheet")) return;
            }
            else if (document.querySelector(`link[href="${e}"]${f}`)) return;
            const n = document.createElement("link");
            if (n.rel = r ? "stylesheet" : d, r || (n.as = "script", n.crossOrigin = ""), n.href = e, document.head.appendChild(n), r) return new Promise((c, a)=>{
                n.addEventListener("load", c), n.addEventListener("error", ()=>a(new Error(`Unable to preload CSS for ${e}`)));
            });
        })).then(()=>o()).catch((e)=>{
    ...
    h(()=>import("./index-a2509fac.js").then(async (m)=>{
            await m.__tla;
            return m;
        }), []).catch((s)=>console.error("Error importing `index.js`:", s));
})();
