...
` + i.stack;
  ...
  var X_ = /* @__PURE__ */ new Set(), q_ = {};
  function rr(t, e) {
    Wr(t, e), Wr(t + "Capture", e);
  }
  function Wr(t, e) {
    for (q_[t] = e, t = 0; t < e.length; t++) X_.add(e[t]);
  }
  ...
  var YE = Ti && "documentMode" in document && 11 >= document.documentMode, wr = null, kh = null, ll = null, Xh = false;
  function E0(t, e, n) {
    var i = n.window === n ? n.document : n.nodeType === 9 ? n : n.ownerDocument;
    Xh || wr == null || wr !== ju(i) || (i = wr, "selectionStart" in i && Am(i) ? i = {
  ...
  var u1 = lr("animationend"), c1 = lr("animationiteration"), f1 = lr("animationstart"), GE = lr("transitionrun"), PE = lr("transitionstart"), kE = lr("transitioncancel"), h1 = lr("transitionend"), d1 = /* @__PURE__ */ new Map(), qh = "abort auxClick beforeToggle cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");
  qh.push("scrollEnd");
  function Hn(t, e) {
    d1.set(t, e), rr(e, [
      t
  ...
  function Va(t) {
    try {
      ...
      throw n !== null && typeof n == "object" && typeof n.then == "function" ? (Xa = n, Ss) : n;
    }
  }
  var Xa = null;
  function z0() {
  ...
  function Fo(t) {
    var e = Ll;
    return Ll += 1, Xr === null && (Xr = []), S1(Xr, t, e);
  }
  function ks(t, e) {
  ...
  function T1(t) {
    ...
    function u(v, g, S, A) {
      var w = S.type;
      return w === Sr ? f(v, g, S.props.children, A, S.key) : g !== null && (g.elementType === w || typeof w == "object" && w !== null && w.$$typeof === Bi && Va(w) === g.type) ? (g = a(g, S.props), ks(g, S), g.return = v, g) : (g = fu(S.type, S.key, S.props, null, v.mode, A), ks(g, S), g.return = v, g);
    }
    function c(v, g, S, A) {
        ...
        switch (S.$$typeof) {
          case Ho:
            t: {
              ...
              S.type === Sr ? (A = Pa(S.props.children, v.mode, A, S.key), A.return = v, v = A) : (A = fu(S.type, S.key, S.props, null, v.mode, A), ks(A, S), A.return = v, v = A);
            }
            return s(v);
          case Js:
            t: {
  ...
  var es = ei(null), ku = ei(0);
  function V0(t, e) {
    t = wi, Et(ku, t), Et(es, e), wi = t | e.baseLanes;
  }
  function Ih() {
    Et(ku, wi), Et(es, es.current);
  }
  function Vm() {
    wi = ku.current, de(es), de(ku);
  }
  ...
  function Gm(t, e, n) {
    ...
    if (r = t.baseState, a === null) t.memoizedState = r;
      ...
      if (u === null ? s = r : u.next = l, !cn(r, t.memoizedState) && (oe = true, f && (n = kr, n !== null))) throw n;
  ...
  function Q1(t, e, n, i) {
    return cn(n, e) ? n : es.current !== null ? (t = Xm(t, n, i), cn(t, e) || (oe = true), t) : !(xi & 42) || xi & 1073741824 && !(ot & 261930) ? (oe = true, t.memoizedState = n) : (t = Lb(), at.lanes |= t, da |= t, e);
  }
  ...
  function hb(t, e, n) {
    ...
    if (u !== null && (l = u.dehydrated, l !== null)) {
      if (r) e.flags & 256 ? (Gi(e), e.flags &= -257, e = Gf(t, e, n)) : e.memoizedState !== null ? (Pi(), e.child = t.child, e.flags |= 128, e = null) : (Pi(), l = i.fallback, a = e.mode, i = Qu({
        ...
        if (s = xt, s !== null && (i = P_(s, n), i !== 0 && i !== u.retryLane)) throw u.retryLane = i, or(t, i), ke(s, t, i), Qm;
        _d(l) || Wu(), e = Gf(t, e, n);
  ...
  function wb(t, e) {
    ...
    switch (t.tag) {
      ...
      case 26:
        ...
        break;
      case 27:
        Be(e, t), He(t), i & 512 && (ae || n === null || Qn(n, n.return)), n !== null && i & 4 && Xf(t, t.memoizedProps, n.memoizedProps);
        break;
      case 5:
        ...
        i & 4 && t.stateNode != null && (a = t.memoizedProps, Xf(t, a, n !== null ? n.memoizedProps : a)), i & 1024 && (Ff = true);
        break;
      case 6:
        if (Be(e, t), He(t), i & 4) {
  ...
  function tp() {
    if (lt !== null) {
      ...
      else t = lt, gi = ur = null, Hm(t), Xr = null, Ll = 0, t = lt;
    ...
    W_(function() {
      ...
      if (!(e & 7)) {
        ...
        switch (z = c ? Ws(c) : window, t) {
          case "focusin":
            (_0(z) || z.contentEditable === "true") && (wr = z, kh = c, ll = null);
            break;
          case "focusout":
            ll = kh = wr = null;
            break;
...
Please change the parent <Route path="${g}"> to <Route path="${g === "/" ? "*" : `${g}/*`}">.`);
  ...
  function KM() {
    var _a2;
    let t = D.useContext(up), e = XM("useRouteError"), n = hp("useRouteError");
    return t !== void 0 ? t : (_a2 = e.errors) == null ? void 0 : _a2[n];
  }
  function QM() {
    let { router: t } = kM("useNavigate"), e = hp("useNavigate"), n = D.useRef(false);
    return AS(() => {
      n.current = true;
  ...
  }, ZS = (t) => (e) => typeof e == "string" && e.startsWith(t), Ap = ZS("--"), XC = ZS("var(--"), Ep = (t) => XC(t) ? qC.test(t.split("/*")[0].trim()) : false, qC = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu, Ms = {
  ...
  class JD extends KD {
    ...
    updateMotionValue(e) {
      ...
      n.setWithVelocity(l.sample(u - kg).value, l.sample(u).value, kg), l.stop();
    }
  }
  ...
  function nO(t, e, n, i, a) {
    var _a2, _b2;
    const { visualElement: r } = D.useContext(Xc), s = D.useContext(AT), l = D.useContext(yp), u = D.useContext(xT).reducedMotion, c = D.useRef(null);
  ...
  function vO(t, e, n, i) {
    kT(t, e, void 0, i);
    for (const a in e.attrs) t.setAttribute(XT.has(a) ? a : qp(a), e.attrs[a]);
  }
  class _O extends PT {
    constructor() {
    ...
    readValueFromInstance(e, n) {
      ...
      return n = XT.has(n) ? n : qp(n), e.getAttribute(n);
    }
    scrapeMotionValuesFromProps(e, n, i) {
      return UT(e, n, i);
    }
  ...
  function FT(t, e, { delay: n = 0, transitionOverride: i, type: a } = {}) {
    ...
    for (const f in l) {
      ...
      kd(t, f), d.start(Fp(f, d, m, t.shouldReduceMotion && dT.has(f) ? {
        type: false
      } : y, t, b));
      const x = d.animation;
      x && u.push(x);
  ...
  function VO(t, e, n = 0, i = 0, a = 0, r = 1, s) {
    const l = [];
    for (const u of t.variantChildren) u.notify("AnimationStart", e), l.push(Xd(u, e, {
      ...s,
  ...
  function YO(t) {
    ...
    function s(u) {
      ...
      for (let x = 0; x < BO; x++) {
        ...
        let Y = B.reduce(a(v), {});
        w === false && (Y = {});
        const { prevResolvedValues: F = {} } = g, k = {
          ...F,
          ...Y
        }, $ = (P) => {
  ...
  class u3 {
    ...
    startAxisValueAnimation(e, n) {
      ...
      return kd(this.visualElement, e), i.start(Fp(e, i, 0, n, this.visualElement, false));
    }
    stopAnimation() {
  ...
  function lx({ attachResizeListener: t, defaultParent: e, measureScroll: n, checkIsScrollRoot: i, resetTransform: a }) {
    return class {
      ...
      setAnimationOrigin(s, l = false) {
        ...
        const m = Jt(), y = u ? u.source : void 0, T = this.layout ? this.layout.source : void 0, b = y !== T, x = this.getStack(), v = !x || x.members.length <= 1, g = !!(b && !v && this.options.crossfade === true && !this.path.some(k3));
  ...
  function kv({ text: t, speed: e = 50, maxIterations: n = 10, sequential: i = false, revealDirection: a = "start", useOriginalCharsOnly: r = false, characters: s = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz!@#$%^&*()_+", className: l = "", parentClassName: u = "", encryptedClassName: c = "", animateOn: f = "hover", ...d }) {
    ...
    D.useEffect(() => {
      ...
      }, Y = r ? Array.from(new Set(t.split(""))).filter((k) => k !== " ") : s.split(""), F = (k, $) => {
        if (r) {
      ...
      return T ? (v(true), O = setInterval(() => {
        S((k) => {
          ...
          else return y(F(t, k)), U++, U >= n && (clearInterval(O), v(false), y(t)), k;
        });
  ...
  const u4 = ({ marqueeText: t = "", speed: e = 2, className: n, curveAmount: i = 400, direction: a = "left", interactive: r = true, decryptSpeed: s = 50, maxIterations: l = 10, sequential: u = false, revealDirection: c = "start", useOriginalCharsOnly: f = false, characters: d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz!@#$%^&*()_+", animateOn: m = "view", encryptedClassName: y = "" }) => {
    const T = D.useMemo(() => (/\s|\u00A0$/.test(t) ? t.replace(/\s+$/, "") : t) + "\xA0", [
      t
    ]), b = D.useRef(null), x = D.useRef(null), v = D.useRef(null), g = D.useRef(null), [S, A] = D.useState(0), [w, V] = D.useState(0), O = `curve-${D.useId()}`, U = `M-100,40 Q500,${40 + i} 1540,40`, B = D.useRef(false), Y = D.useRef(0), F = D.useRef(a), k = D.useRef(0), [$, K] = D.useState(T), [N, P] = D.useState(false), [G, Q] = D.useState(false), [it, Pt] = D.useState(/* @__PURE__ */ new Set()), [Kt, te] = D.useState(false), Nt = S, pe = Nt ? Math.ceil(1800 / Nt) + 2 : 1, Ta = S > 0;
    D.useEffect(() => {
    ...
    const Jc = (wt) => {
      ...
      r && (B.current = false, F.current = k.current > 0 ? "right" : "left");
  ...
  var un = {
  ...
  }, De = Array.isArray, Qd = /(?:-?\.?\d|\.)+/gi, dx = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Br = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, _h = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, mx = /[+-]=-?[.\d]+/, px = /[^,'"\[\]\s]+/gi, p4 = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, Bt, Xn, Zd, Jp, hn = {}, mc = {}, yx, gx = function(e) {
    ...
    if (a && (s.duration = n[1]), s.parent = i, e) {
      for (l = s, u = i; u && !("immediateRender" in l); ) l = u.vars.defaults || {}, u = Xe(u.vars.inherit) && u.parent;
    ...
    return e && ti(e) && "length" in e && (!n && !e.length || e.length - 1 in e && ti(e[0])) && !e.nodeType && e !== Xn;
  }, C4 = function(e, n, i) {
    ...
    return d = {
      ...
      wake: function() {
        yx && (!Zd && Zp() && (Xn = Zd = window, Jp = Xn.document || {}, hn.gsap = Ze, (Xn.gsapVersions || (Xn.gsapVersions = [])).push(Ze.version), gx(mc || Xn.GreenSockGlobals || !Xn.gsap && Xn || {}), Lx.forEach(Nx)), f = typeof requestAnimationFrame < "u" && requestAnimationFrame, u && d.sleep(), c = f || function(x) {
  ...
  var ze = function(t) {
    ...
    return n.to = function(a, r, s) {
      ...
      return s.runBackwards = 1, xl(s).immediateRender = Xe(s.immediateRender), this.staggerTo(a, r, s, l, u, c, f);
    }, n.staggerFromTo = function(a, r, s, l, u, c, f, d) {
      return l.startAt = s, xl(l).immediateRender = Xe(l.immediateRender), this.staggerTo(a, r, l, u, c, f, d);
  ...
  var G4 = function(e, n, i, a, r, s, l) {
    ...
    var a = e.vars, r = a.ease, s = a.startAt, l = a.immediateRender, u = a.lazy, c = a.onUpdate, f = a.runBackwards, d = a.yoyoEase, m = a.keyframes, y = a.autoRevert, T = e._dur, b = e._startAt, x = e._targets, v = e.parent, g = v && v.data === "nested" ? v.vars.targets : x, S = e._overwrite === "auto" && !Kp, A = e.timeline, w, V, z, O, U, B, Y, F, k, $, K, N, P;
    if (A && (!m || !r) && (r = "none"), e._ease = Ja(r, cs.ease), e._yEase = d ? Yx(Ja(d === true ? r : d, cs.ease)) : 0, d && e._yoyo && !e._repeat && (d = e._yEase, e._yEase = e._ease, e._ease = d), e._from = !A && !!a.runBackwards, !A || m && !a.stagger) {
      ...
      for (e._pt = e._ptCache = 0, u = T && Xe(u) || u && !T, V = 0; V < x.length; V++) {
        if (U = x[V], Y = U._gsap || ty(x)[V]._gsap, e._ptLookup[V] = $ = {}, Jd[Y.id] && oa.length && pc(), K = g === x ? V : g.indexOf(U), F && (k = new F()).init(U, N || w, e, K, g) !== false && (e._pt = O = new Fe(e._pt, U, k.name, 0, 1, k.render, k, 0, k.priority), k._props.forEach(function(G) {
          $[G] = O;
        }), k.priority && (B = 1)), !F || N) for (z in w) We[z] && (k = Xx(z, w, e, K, U, g)) ? k.priority && (B = 1) : $[z] = O = ny.call(e, U, z, "get", w[z], K, g, 0, a.stringFilter);
  ...
  var re = function(t) {
    ...
    return n.render = function(a, r, s) {
      ...
      return this._initted || iy(this, c), f = this._ease(c / this._dur), k4(this, a, r, s, l, f, c, u) ? this.resetTo(a, r, s, l, 1) : (Zc(this, 0), this.parent || Ax(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
    }, n.kill = function(a, r) {
      ...
      for (d = this._op = this._op || [], r !== "all" && (me(r) && (b = {}, qe(r, function(g) {
        return b[g] = 1;
      }), r = b), r = X4(l, r)), v = l.length; v--; ) if (~u.indexOf(l[v])) {
  ...
  var $a = [], Ou = {}, W4 = [], Jv = 0, I4 = 0, Ah = function(e) {
    ...
    e - Jv > 2 && (Ah("matchMediaInit"), $a.forEach(function(i) {
      ...
      for (l in a) s = Xn.matchMedia(a[l]).matches, s && (u = 1), s !== r[l] && (r[l] = s, c = 1);
    ...
    return e.add = function(i, a, r) {
      ...
      for (c in i) c === "all" ? f = 1 : (u = Xn.matchMedia(i[c]), u && ($a.indexOf(s) < 0 && $a.push(s), (l[c] = u.matches) && (f = 1), u.addListener ? u.addListener(im) : u.addEventListener("change", im)));
  ...
  var $v, Ji, Zr, ly, Ya, Wv, oy, iz = function() {
    ...
    var a = e.style, r = i.scaleX < 0, s = "px", l = "deg", u = getComputedStyle(e), c = Dn(e, Ke) || "0", f, d, m, y, T, b, x, v, g, S, A, w, V, z, O, U, B, Y, F, k, $, K, N, P, G, Q, it, Pt, Kt, te, Nt, pe;
    return f = d = m = b = x = v = g = S = A = 0, y = T = 1, i.svg = !!(e.getCTM && a2(e)), u.translate && ((u.translate !== "none" || u.scale !== "none" || u.rotate !== "none") && (a[Yt] = (u.translate !== "none" ? "translate3d(" + (u.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (u.rotate !== "none" ? "rotate(" + u.rotate + ") " : "") + (u.scale !== "none" ? "scale(" + u.scale.split(" ").join(",") + ") " : "") + (u[Yt] !== "none" ? u[Yt] : "")), a.scale = a.rotate = a.translate = "none"), z = cy(e, i.svg), i.svg && (i.uncache ? (G = e.getBBox(), c = i.xOrigin - G.x + "px " + (i.yOrigin - G.y) + "px", P = "") : P = !n && e.getAttribute("data-svg-origin"), lm(e, P || c, !!P || i.originIsAbsolute, i.smooth !== false, z)), w = i.xOrigin || 0, V = i.yOrigin || 0, z !== eo && (Y = z[0], F = z[1], k = z[2], $ = z[3], f = K = z[4], d = N = z[5], z.length === 6 ? (y = Math.sqrt(Y * Y + F * F), T = Math.sqrt($ * $ + k * k), b = Y || F ? yr(F, Y) * ja : 0, g = k || $ ? yr(k, $) * ja + b : 0, g && (T *= Math.abs(Math.cos(g * Jr))), i.svg && (f -= w - (w * Y + V * k), d -= V - (w * F + V * $))) : (pe = z[6], te = z[7], it = z[8], Pt = z[9], Kt = z[10], Nt = z[11], f = z[12], d = z[13], m = z[14], O = yr(pe, Kt), x = O * ja, O && (U = Math.cos(-O), B = Math.sin(-O), P = K * U + it * B, G = N * U + Pt * B, Q = pe * U + Kt * B, it = K * -B + it * U, Pt = N * -B + Pt * U, Kt = pe * -B + Kt * U, Nt = te * -B + Nt * U, K = P, N = G, pe = Q), O = yr(-k, Kt), v = O * ja, O && (U = Math.cos(-O), B = Math.sin(-O), P = Y * U - it * B, G = F * U - Pt * B, Q = k * U - Kt * B, Nt = $ * B + Nt * U, Y = P, F = G, k = Q), O = yr(F, Y), b = O * ja, O && (U = Math.cos(O), B = Math.sin(O), P = Y * U + F * B, G = K * U + N * B, F = F * U - Y * B, N = N * U - K * B, Y = P, K = G), x && Math.abs(x) + Math.abs(b) > 359.9 && (x = b = 0, v = 180 - v), y = $t(Math.sqrt(Y * Y + F * F + k * k)), T = $t(Math.sqrt(N * N + pe * pe)), O = yr(K, N), g = Math.abs(O) > 2e-4 ? O * ja : 0, A = Nt ? 1 / (Nt < 0 ? -Nt : Nt) : 0), i.svg && (P = e.getAttribute("transform"), i.forceCSS = e.setAttribute("transform", "") || !s2(Dn(e, Yt)), P && e.setAttribute("transform", P))), Math.abs(g) > 90 && Math.abs(g) < 270 && (r ? (y *= -1, g += b <= 0 ? 180 : -180, b += b <= 0 ? 180 : -180) : (T *= -1, g += g <= 0 ? 180 : -180)), n = n || i.uncache, i.x = f - ((i.xPercent = f && (!n && i.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-f) ? -50 : 0))) ? e.offsetWidth * i.xPercent / 100 : 0) + s, i.y = d - ((i.yPercent = d && (!n && i.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-d) ? -50 : 0))) ? e.offsetHeight * i.yPercent / 100 : 0) + s, i.z = m + s, i.scaleX = $t(y), i.scaleY = $t(T), i.rotation = $t(b) + l, i.rotationX = $t(x) + l, i.rotationY = $t(v) + l, i.skewX = g + l, i.skewY = S + l, i.transformPerspective = A + s, (i.zOrigin = parseFloat(c.split(" ")[2]) || !n && i.zOrigin || 0) && (a[Ke] = bc(c)), i.xOffset = i.yOffset = 0, i.force3D = un.force3D, i.renderTransform = i.svg ? Tz : n2 ? l2 : Sz, i.uncache = 0, i;
  }, bc = function(e) {
  ...
  (function() {
    ...
    r("Promise", function(o) {
      ...
      return h.prototype.L = function(M) {
        ...
        return L.done ? _([]) : new h(function(H, X) {
          ...
          var Z = [], q = 0;
          do
            Z.push(void 0), q++, _(L.value).T(W(Z.length - 1), X), L = R.next();
          while (!L.done);
        });
      }, h;
    });
      ...
      if (!C) {
        ...
        for (var X = M, W = 0; W < R.length; W++) {
          ...
          if (I = I === void 0 ? false : I, Z = Array.isArray(Z) ? new q(Z) : I ? new q() : void 0, Z !== void 0) {
            q = Z.o;
            var rt = I = Zt(q);
            M && (rt |= 2), L && (rt |= 16), rt != I && Yn(q, rt), q = rt, X = X || !!(2 & q), C.push(Z);
          }
        }
        return o.h[p] = C, L = Zt(R), h = L | 33, h = X ? h & -9 : h | 8, L != h && (X = R, Object.isFrozen(X) && (X = Array.prototype.slice.call(X)), Yn(X, h), R = X), H !== R && Ls(o, p, R), (E || _ && M) && Ma(C, 2), _ && Object.freeze(C), C;
      }
    ...
    var Ln = Bs(function(o, h, p) {
      ...
      if (o = o.i, v2) {
        ...
        R = E, _ = R + _, E = [];
        for (var L = null, H, X; R < _; ) H = o[R++], 128 > H ? E.push(H) : 224 > H ? R >= _ ? Aa() : (X = o[R++], 194 > H || (X & 192) !== 128 ? (R--, Aa()) : E.push((H & 31) << 6 | X & 63)) : 240 > H ? R >= _ - 1 ? Aa() : (X = o[R++], (X & 192) !== 128 || H === 224 && 160 > X || H === 237 && 160 <= X || ((C = o[R++]) & 192) !== 128 ? (R--, Aa()) : E.push((H & 15) << 12 | (X & 63) << 6 | C & 63)) : 244 >= H ? R >= _ - 2 ? Aa() : (X = o[R++], (X & 192) !== 128 || (H << 28) + (X - 144) >> 30 || ((C = o[R++]) & 192) !== 128 || ((M = o[R++]) & 192) !== 128 ? (R--, Aa()) : (H = (H & 7) << 18 | (X & 63) << 12 | (C & 63) << 6 | M & 63, H -= 65536, E.push((H >> 10 & 1023) + 55296, (H & 1023) + 56320))) : Aa(), 8192 <= E.length && (L = hy(L, E), E.length = 0);
        R = hy(L, E);
      }
...
` + o.getShaderInfoLog(p));
    ...
    function q2(o) {
      return {
        ...
        y: kn(o, 2),
        z: kn(o, 3),
        visibility: of(o, 4) != null ? kn(o, 4) : void 0
      };
    }
    function yf(o, h) {
...
` + p.getProgramInfoLog(C));
    ...
    function eA(o, h, p) {
      var _, E, C, M, R, L, H, X, W, Z, q, I, rt, Ct;
      return Y(function(At) {
        switch (At.h) {
          ...
          case 2:
            ...
            if (X = M.value, W = p[X], typeof W == "string") return rt = _, Ct = X, A(At, nA(o, X, h[W]), 14);
            if (Z = h[W.stream], W.type === "detection_list") {
              if (Z) {
                for (var ye = Z.getRectList(), pn = Z.getLandmarksList(), je = Z.getClassificationsList(), ht = [], ge = 0; ge < ye.size(); ++ge) {
                  var Li = k2(ye.get(ge)), aA = kn(Li, 1), rA = kn(Li, 2), sA = kn(Li, 3), lA = kn(Li, 4), oA = kn(Li, 5, 0), jo = void 0;
            ...
            return q = o.v[X], q || (q = new yf(o.i, o.K), o.v[X] = q), A(At, Zy(q, Z, o.M), 13);
          case 13:
            I = At.i, _[X] = I;
          case 7:
    ...
    function iA(o, h) {
      ...
      C = o.i.PacketListener.implement({
        onResults: function(R) {
          ...
          var X = o.listeners[p];
          X && (o.I = eA(o, L, h.outs).then(function(W) {
            W = X(W);
...
\uC774\uC81C, \uB2F9\uC2E0\uC758 \uD14D\uC2A4\uD2B8\uB97C \uB0A8\uACA8\uBCF4\uC138\uC694.`
      ...
      const k = Y.length, N = k * (F || 90) / 1e3;
      return console.log(`Duration \uACC4\uC0B0: ${k}\uAE00\uC790, ${N.toFixed(2)}\uCD08`), N;
    }, []), B = D.useCallback(() => {
      const Y = n.current;
      if (!Y) return;
      const F = document.documentElement.clientWidth, k = document.documentElement.clientHeight;
      Y.width = F, Y.height = k;
      const $ = Math.floor(F / (Wi + 1)), K = Math.floor(k / (Wi + 1));
    ...
    return fy(() => {
      ...
      const Y = e.current, F = n.current, k = F == null ? void 0 : F.getContext("2d");
      if (!Y || !F || !k) return;
      const $ = async () => {
        var _a2;
    ...
    basename: "/Web_Interaction_2025/week8",
    children: J.jsxs($M, {
      children: [
        J.jsx(Tu, {
          path: "/",
