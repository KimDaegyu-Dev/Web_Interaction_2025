(async () => {
      ...
      case "object":
        switch (t.$$typeof) {
          ...
          case fA:
            ...
            break;
          case g_:
            return s = t._init, vr(s(t._payload), e, n, i, a);
        }
    }
    if (s) return a = a(t), s = i === "" ? "." + _f(t, 0) : i, t0(a) ? (n = "", s != null && (n = s.replace(e0, "$&/") + "/"), vr(a, e, n, "", function(c) {
      return c;
    })) : a != null && (hm(a) && (a = TA(a, n + (a.key == null || t && t.key === a.key ? "" : ("" + a.key).replace(e0, "$&/") + "/") + s)), e.push(a)), 1;
    s = 0;
    var l = i === "" ? "." : i + ":";
    if (t0(t)) for (var u = 0; u < t.length; u++) i = t[u], r = l + _f(i, u), s += vr(i, e, n, r, a);
    else if (u = SA(t), typeof u == "function") for (t = u.call(t), u = 0; !(i = t.next()).done; ) i = i.value, r = l + _f(i, u++), s += vr(i, e, n, r, a);
    else if (r === "object") {
      if (typeof t.then == "function") return vr(AA(t), e, n, i, a);
  ...
  (function(t) {
    ...
    var u = [], c = [], f = 1, d = null, m = 3, y = false, T = false, b = false, x = false, v = typeof setTimeout == "function" ? setTimeout : null, g = typeof clearTimeout == "function" ? clearTimeout : null, S = typeof setImmediate < "u" ? setImmediate : null;
    function A(N) {
      for (var P = n(c); P !== null; ) {
        if (P.callback === null) i(c);
        else if (P.startTime <= N) i(c), P.sortIndex = P.expirationTime, e(u, P);
        else break;
        P = n(c);
      }
    }
    function w(N) {
      if (b = false, A(N), !T) if (n(u) !== null) T = true, V || (V = true, F());
      else {
        var P = n(c);
      ...
      if (x = false, V) {
        ...
        try {
          t: {
            ...
            try {
              e: {
                for (A(N), d = n(u); d !== null && !(d.expirationTime > N && B()); ) {
                  var Q = d.callback;
    ...
    if (typeof S == "function") F = function() {
      ...
      X.port1.onmessage = Y, F = function() {
        $.postMessage(null);
      };
    } else F = function() {
      v(Y, 0);
    ...
    t.unstable_IdlePriority = 5, t.unstable_ImmediatePriority = 1, t.unstable_LowPriority = 4, t.unstable_NormalPriority = 3, t.unstable_Profiling = null, t.unstable_UserBlockingPriority = 2, t.unstable_cancelCallback = function(N) {
      ...
      return it = G + it, N = {
        ...
        expirationTime: it,
        sortIndex: -1
      }, G > Q ? (N.sortIndex = G, e(c, N), n(u) === null && N === n(c) && (b ? (g(z), z = -1) : b = true, K(w, G - Q))) : (N.sortIndex = it, e(u, N), T || y || (T = true, V || (V = true, F()))), N;
  ...
  function de(t) {
    0 > Tr || (t.current = Vh[Tr], Vh[Tr] = null, Tr--);
  }
  function Et(t, e) {
    Tr++, Vh[Tr] = t.current, t.current = e;
  }
  var Jn = ei(null), Dl = ei(null), Ii = ei(null), Uu = ei(null);
  function Vu(t, e) {
    switch (Et(Ii, e), Et(Dl, t), Et(Jn, null), e.nodeType) {
      case 9:
      case 11:
  ...
  function Lh(t) {
    ...
    var e = Jn.current, n = eS(e, t.type);
    e !== n && (Et(Dl, t), Et(Jn, n));
  }
  function Lu(t) {
    Dl.current === t && (de(Jn), de(Dl)), Uu.current === t && (de(Uu), Yl._currentValue = Ga);
  }
  var bf, r0;
  function za(t) {
    if (bf === void 0) try {
...
`), c = l.split(`
`);
        for (a = i = 0; i < u.length && !u[i].includes("DetermineComponentFrameRoot"); ) i++;
        for (; a < c.length && !c[a].includes("DetermineComponentFrameRoot"); ) a++;
        if (i === u.length || a === c.length) for (i = u.length - 1, a = c.length - 1; 1 <= i && 0 <= a && u[i] !== c[a]; ) a--;
        for (; 1 <= i && 0 <= a; i--, a--) if (u[i] !== c[a]) {
          if (i !== 1 || a !== 1) do
            if (i--, a--, 0 > a || u[i] !== c[a]) {
              var f = `
...
` + i.stack;
  ...
  var Nh = Object.prototype.hasOwnProperty, pm = ce.unstable_scheduleCallback, xf = ce.unstable_cancelCallback, HA = ce.unstable_shouldYield, YA = ce.unstable_requestPaint, rn = ce.unstable_now, GA = ce.unstable_getCurrentPriorityLevel, N_ = ce.unstable_ImmediatePriority, j_ = ce.unstable_UserBlockingPriority, Nu = ce.unstable_NormalPriority, PA = ce.unstable_LowPriority, B_ = ce.unstable_IdlePriority, XA = ce.log, kA = ce.unstable_setDisableYieldValue, ro = null, sn = null;
  function ki(t) {
    if (typeof XA == "function" && kA(t), sn && typeof sn.setStrictMode == "function") try {
      sn.setStrictMode(ro, t);
    } catch {
    }
  }
  var ln = Math.clz32 ? Math.clz32 : KA, qA = Math.log, FA = Math.LN2;
  function KA(t) {
    return t >>>= 0, t === 0 ? 32 : 31 - (qA(t) / FA | 0) | 0;
  }
  ...
  function ZA(t, e, n, i, a, r) {
    ...
    var l = t.entanglements, u = t.expirationTimes, c = t.hiddenUpdates;
    for (n = s & ~n; 0 < n; ) {
      var f = 31 - ln(n), d = 1 << f;
      l[f] = 0, u[f] = -1;
      var m = c[f];
  ...
  var va = Math.random().toString(36).slice(2), be = "__reactFiber$" + va, Qe = "__reactProps$" + va, vs = "__reactContainer$" + va, jh = "__reactEvents$" + va, JA = "__reactListeners$" + va, $A = "__reactHandles$" + va, o0 = "__reactResources$" + va, oo = "__reactMarker$" + va;
  function vm(t) {
  ...
  var k_ = /* @__PURE__ */ new Set(), q_ = {};
  function rr(t, e) {
    Wr(t, e), Wr(t + "Capture", e);
  }
  function Wr(t, e) {
    for (q_[t] = e, t = 0; t < e.length; t++) k_.add(e[t]);
  }
  ...
  function K_(t) {
    ...
    if (!e) return true;
    var n = e.getValue(), i = "";
    return t && (i = F_(t) ? t.checked ? "true" : "false" : t.value), t = i, t !== n ? (e.setValue(t), true) : false;
  }
  function ju(t) {
    ...
    if (e && (t = e.stateNode)) {
      ...
      t: switch (t = e.stateNode, e.type) {
        ...
        case "textarea":
          ...
          break t;
        case "select":
          e = n.value, e != null && Gr(t, !!n.multiple, e, false);
      }
    }
  }
  var Ef = false;
  function W_(t, e, n) {
    ...
    try {
      ...
      if (Ef = false, (Ar !== null || Pr !== null) && (Bc(), Ar && (e = Ar, t = Pr, Pr = Ar = null, h0(e), t))) for (e = 0; e < t.length; e++) h0(t[e]);
    }
  }
  function Rl(t, e) {
    var n = t.stateNode;
  ...
  var qi = null, Sm = null, uu = null;
  function I_() {
    if (uu) return uu;
    var t, e = Sm, n = e.length, i, a = "value" in qi ? qi.value : qi.textContent, r = a.length;
  ...
  function Je(t) {
    function e(n, i, a, r, s) {
      ...
      return this.isDefaultPrevented = (r.defaultPrevented != null ? r.defaultPrevented : r.returnValue === false) ? ko : d0, this.isPropagationStopped = d0, this;
    }
    return zt(e.prototype, {
      preventDefault: function() {
        this.defaultPrevented = true;
        var n = this.nativeEvent;
        n && (n.preventDefault ? n.preventDefault() : typeof n.returnValue != "unknown" && (n.returnValue = false), this.isDefaultPrevented = ko);
      },
      stopPropagation: function() {
        var n = this.nativeEvent;
        n && (n.stopPropagation ? n.stopPropagation() : typeof n.cancelBubble != "unknown" && (n.cancelBubble = true), this.isPropagationStopped = ko);
      },
      persist: function() {
      },
      isPersistent: ko
  ...
  function zE(t, e) {
    if (Er) return t === "compositionend" || !xm && e1(t, e) ? (t = I_(), uu = Sm = qi = null, Er = false, t) : null;
    switch (t) {
      case "paste":
        return null;
      case "keypress":
  ...
  function i1(t, e, n, i) {
    Ar ? Pr ? Pr.push(i) : Pr = [
      i
    ] : Ar = i, e = ec(e, "onChange"), 0 < e.length && (n = new Mc("onChange", "change", null, n, i), t.push({
      event: n,
      listeners: e
    }));
  }
  ...
  var YE = Ti && "documentMode" in document && 11 >= document.documentMode, wr = null, Xh = null, ll = null, kh = false;
  function E0(t, e, n) {
    var i = n.window === n ? n.document : n.nodeType === 9 ? n : n.ownerDocument;
    kh || wr == null || wr !== ju(i) || (i = wr, "selectionStart" in i && Am(i) ? i = {
    ...
    }), ll && zl(ll, i) || (ll = i, i = ec(Xh, "onSelect"), 0 < i.length && (e = new Mc("onSelect", "select", null, e, n), t.push({
      event: e,
      listeners: i
    }), e.target = wr)));
  }
  ...
  Ti && (o1 = document.createElement("div").style, "AnimationEvent" in window || (delete Mr.animationend.animation, delete Mr.animationiteration.animation, delete Mr.animationstart.animation), "TransitionEvent" in window || delete Mr.transitionend.transition);
  function lr(t) {
    if (Of[t]) return Of[t];
    if (!Mr[t]) return t;
    var e = Mr[t], n;
  ...
  var u1 = lr("animationend"), c1 = lr("animationiteration"), f1 = lr("animationstart"), GE = lr("transitionrun"), PE = lr("transitionstart"), XE = lr("transitioncancel"), h1 = lr("transitionend"), d1 = /* @__PURE__ */ new Map(), qh = "abort auxClick beforeToggle cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");
  qh.push("scrollEnd");
  function Hn(t, e) {
    d1.set(t, e), rr(e, [
      t
  ...
  function Oc(t, e, n, i) {
    _n[Cr++] = t, _n[Cr++] = e, _n[Cr++] = n, _n[Cr++] = i, Em |= i, t.lanes |= i, t = t.alternate, t !== null && (t.lanes |= i);
  }
  function wm(t, e, n, i) {
  ...
  function fu(t, e, n, i, a, r) {
    ...
    else if (typeof t == "string") s = Zw(t, n, Jn.current) ? 26 : t === "html" || t === "head" || t === "body" ? 27 : 5;
    else t: switch (t) {
      case zh:
  ...
  var Rr = [], Or = 0, Yu = null, Ul = 0, Sn = [], Tn = 0, ca = null, Fn = 1, Kn = "";
  function hi(t, e) {
    Rr[Or++] = Ul, Rr[Or++] = Yu, Yu = t, Ul = e;
  }
  function g1(t, e, n) {
    Sn[Tn++] = Fn, Sn[Tn++] = Kn, Sn[Tn++] = ca, ca = t;
    var i = Fn;
    t = Kn;
    var a = 32 - ln(i) - 1;
    i &= ~(1 << a), n += 1;
    ...
    if (30 < r) {
      var s = a - a % 5;
      r = (i & (1 << s) - 1).toString(32), i >>= s, a -= s, Fn = 1 << 32 - ln(e) + a | n << a | i, Kn = r + t;
    } else Fn = 1 << r | n << a | i, Kn = t;
  }
  function Cm(t) {
    t.return !== null && (hi(t, 1), g1(t, 1, 0));
  }
  function Dm(t) {
    for (; t === Yu; ) Yu = Rr[--Or], Rr[Or] = null, Ul = Rr[--Or], Rr[Or] = null;
    for (; t === ca; ) ca = Sn[--Tn], Sn[Tn] = null, Kn = Sn[--Tn], Sn[Tn] = null, Fn = Sn[--Tn], Sn[Tn] = null;
  }
  function v1(t, e) {
    Sn[Tn++] = Fn, Sn[Tn++] = Kn, Sn[Tn++] = ca, Fn = e.id, Kn = e.overflow, ca = t;
  }
  var Se = null, Rt = null, ut = false, ta = null, En = false, Fh = Error(j(519));
  function fa(t) {
    ...
    for (a !== null && (a.return = t); a !== null; ) {
      ...
      if (r !== null) {
        ...
        t: for (; r !== null; ) {
          var l = r;
          r = a;
          for (var u = 0; u < e.length; u++) if (l.context === e[u]) {
  ...
  }, FE = ce.unstable_scheduleCallback, KE = ce.unstable_NormalPriority, se = {
    $$typeof: pi,
    Consumer: null,
    Provider: null,
    _currentValue: null,
  ...
  function co(t) {
    t.refCount--, t.refCount === 0 && FE(KE, function() {
      t.controller.abort();
    });
  }
  var ol = null, Jh = 0, ts = 0, Xr = null;
  function QE(t, e) {
    if (ol === null) {
      var n = ol = [];
      Jh = 0, ts = ep(), Xr = {
  ...
  function hu(t, e) {
    e === null ? Et(Xa, Xa.current) : Et(Xa, e.pool);
  }
  function b1() {
    var t = Om();
    return t === null ? null : {
  ...
  var Ss = Error(j(460)), zm = Error(j(474)), zc = Error(j(542)), Pu = {
    then: function() {
    }
  };
  function O0(t) {
  ...
  function Va(t) {
    try {
      ...
      throw n !== null && typeof n == "object" && typeof n.then == "function" ? (ka = n, Ss) : n;
    }
  }
  var ka = null;
  function z0() {
    if (ka === null) throw Error(j(459));
    var t = ka;
    return ka = null, t;
  }
  function U0(t) {
    if (t === Ss || t === zc) throw Error(j(483));
  }
  var kr = null, Ll = 0;
  function Fo(t) {
    var e = Ll;
    return Ll += 1, kr === null && (kr = []), S1(kr, t, e);
  }
  function Xs(t, e) {
  ...
  function T1(t) {
    ...
    function u(v, g, S, A) {
      var w = S.type;
      return w === Sr ? f(v, g, S.props.children, A, S.key) : g !== null && (g.elementType === w || typeof w == "object" && w !== null && w.$$typeof === Bi && Va(w) === g.type) ? (g = a(g, S.props), Xs(g, S), g.return = v, g) : (g = fu(S.type, S.key, S.props, null, v.mode, A), Xs(g, S), g.return = v, g);
    }
    function c(v, g, S, A) {
    ...
    function d(v, g, S) {
      ...
      if (typeof g == "object" && g !== null) {
        switch (g.$$typeof) {
          case Ho:
            return S = fu(g.type, g.key, g.props, null, v.mode, S), Xs(S, g), S.return = v, S;
          case Js:
        ...
        if (typeof g.then == "function") return d(v, Fo(g), S);
        if (g.$$typeof === pi) return d(v, qo(v, g), S);
        Ko(v, g);
      }
      return null;
    }
    function m(v, g, S, A) {
      ...
      if (typeof S == "object" && S !== null) {
        ...
        if (typeof S.then == "function") return m(v, g, Fo(S), A);
        if (S.$$typeof === pi) return m(v, g, qo(v, S), A);
        Ko(v, S);
      }
      return null;
    }
    function y(v, g, S, A, w) {
      ...
      if (typeof A == "object" && A !== null) {
        switch (A.$$typeof) {
          case Ho:
            return v = v.get(A.key === null ? S : A.key) || null, u(g, v, A, w);
          case Js:
        ...
        if (typeof A.then == "function") return y(v, g, S, Fo(A), w);
        if (A.$$typeof === pi) return y(v, g, S, qo(g, A), w);
        Ko(g, A);
      }
      return null;
    }
    ...
    function b(v, g, S, A) {
      ...
      return t && z.forEach(function(F) {
        return e(v, F);
      }), ut && hi(v, O), w;
    }
    function x(v, g, S, A) {
      if (typeof S == "object" && S !== null && S.type === Sr && S.key === null && (S = S.props.children), typeof S == "object" && S !== null) {
        switch (S.$$typeof) {
          case Ho:
            t: {
              for (var w = S.key; g !== null; ) {
                if (g.key === w) {
                  if (w = S.type, w === Sr) {
                    ...
                    n(v, g.sibling), A = a(g, S.props), Xs(A, S), A.return = v, v = A;
                    break t;
                  }
                  n(v, g);
                  break;
              ...
              S.type === Sr ? (A = Pa(S.props.children, v.mode, A, S.key), A.return = v, v = A) : (A = fu(S.type, S.key, S.props, null, v.mode, A), Xs(A, S), A.return = v, v = A);
            }
            return s(v);
          case Js:
            t: {
        ...
        if (typeof S.then == "function") return x(v, g, Fo(S), A);
        if (S.$$typeof === pi) return x(v, g, qo(v, S), A);
        Ko(v, S);
      }
  ...
  function fl(t, e, n, i) {
    ...
    if (l !== null) {
      ...
      var u = l, c = u.next;
      u.next = null, s === null ? r = c : s.next = c, s = u;
      var f = t.alternate;
      f !== null && (f = f.updateQueue, l = f.lastBaseUpdate, l !== s && (l === null ? f.firstBaseUpdate = c : l.next = c, f.lastBaseUpdate = u));
    }
    if (r !== null) {
      var d = a.baseState;
      s = 0, f = c = u = null, l = r;
      do {
        ...
        if (y ? (ot & m) === m : (i & m) === m) {
          m !== 0 && m === ts && (Wh = true), f !== null && (f = f.next = {
            lane: 0,
            tag: l.tag,
            payload: l.payload,
            callback: null,
          ...
          callback: l.callback,
          next: null
        }, f === null ? (c = f = y, u = d) : f = f.next = y, s |= m;
        if (l = l.next, l === null) {
          if (l = a.shared.pending, l === null) break;
          y = l, l = y.next, y.next = null, a.lastBaseUpdate = y, a.shared.pending = null;
        }
      } while (true);
      f === null && (u = d), a.baseState = u, a.firstBaseUpdate = c, a.lastBaseUpdate = f, r === null && (a.shared.lanes = 0), da |= s, t.lanes = s, t.memoizedState = d;
    }
  }
  function A1(t, e) {
  ...
  var es = ei(null), Xu = ei(0);
  function V0(t, e) {
    t = wi, Et(Xu, t), Et(es, e), wi = t | e.baseLanes;
  }
  function Ih() {
    Et(Xu, wi), Et(es, es.current);
  }
  function Vm() {
    wi = Xu.current, de(es), de(Xu);
  }
  var fn = ei(null), Rn = null;
  function Gi(t) {
    var e = t.alternate;
    Et(Wt, Wt.current & 1), Et(fn, t), Rn === null && (e === null || es.current !== null || e.memoizedState !== null) && (Rn = t);
  }
  function td(t) {
  ...
  var xi = 0, at = null, bt = null, ie = null, qu = false, qr = false, nr = false, Fu = 0, Nl = 0, Fr = null, JE = 0;
  function Xt() {
    throw Error(j(321));
  }
  function Lm(t, e) {
  ...
  function M1(t) {
    ...
    if (xi = 0, ie = bt = at = null, qu = false, Nl = 0, Fr = null, e) throw Error(j(300));
  ...
  function C1(t, e, n, i) {
    ...
    var a = 0;
    do {
      if (qr && (Fr = null), Nl = 0, qr = false, 25 <= a) throw Error(j(301));
  ...
  function Hm(t) {
    ...
    xi = 0, ie = bt = at = null, qr = false, Nl = Fu = 0, Fr = null;
  }
  function Oe() {
    var t = {
      memoizedState: null,
  ...
  function fo(t) {
    var e = Nl;
    return Nl += 1, Fr === null && (Fr = []), t = S1(Fr, t, e), e = at, (ie === null ? e.memoizedState : ie.next) === null && (e = e.alternate, et.H = e === null || e.memoizedState === null ? ib : Km), t;
  }
  function Vc(t) {
  ...
  function Gm(t, e, n) {
    ...
    if (r = t.baseState, a === null) t.memoizedState = r;
      ...
      e = a.next;
      var l = s = null, u = null, c = e, f = false;
      do {
        ...
        if (d !== c.lane ? (ot & d) === d : (xi & d) === d) {
          ...
          if (m === 0) u !== null && (u = u.next = {
            ...
            eagerState: c.eagerState,
            next: null
          }, u === null ? (l = u = d, s = r) : u = u.next = d, at.lanes |= m, da |= m;
          ...
          eagerState: c.eagerState,
          next: null
        }, u === null ? (l = u = m, s = r) : u = u.next = m, at.lanes |= d, da |= d;
        c = c.next;
      } while (c !== null && c !== e);
      if (u === null ? s = r : u.next = l, !cn(r, t.memoizedState) && (oe = true, f && (n = Xr, n !== null))) throw n;
      t.memoizedState = r, t.baseState = s, t.baseQueue = u, i.lastRenderedState = r;
    }
  ...
  function j0(t, e) {
    ...
    return n = Oe(), n.memoizedState = n.baseState = e, i = {
      ...
      lastRenderedState: e
    }, n.queue = i, n = tb.bind(null, at, i), i.dispatch = n, i = ed(false), r = Fm.bind(null, at, false, i.queue), i = Oe(), a = {
      state: e,
      dispatch: null,
      action: t,
      pending: null
  ...
  function H1(t, e, n) {
    ...
    return n !== e.memoizedState && (at.flags |= 2048, ns(9, {
      destroy: void 0
  ...
  function mu(t, e, n, i) {
    var a = Oe();
    at.flags |= t, a.memoizedState = ns(1 | e, {
      destroy: void 0
    }, n, i === void 0 ? null : i);
  }
  function Lc(t, e, n, i) {
    ...
    bt !== null && i !== null && Lm(i, bt.memoizedState.deps) ? a.memoizedState = ns(e, r, n, i) : (at.flags |= t, a.memoizedState = ns(1 | e, r, n, i));
  }
  function Y0(t, e) {
    mu(8390656, 8, t, e);
  }
  ...
  function q1(t, e, n) {
    n = n != null ? n.concat([
      t
    ]) : null, Lc(4, 4, k1.bind(null, e, t), n);
  }
  function Xm() {
  }
  function F1(t, e) {
  ...
  function Q1(t, e, n, i) {
    return cn(n, e) ? n : es.current !== null ? (t = km(t, n, i), cn(t, e) || (oe = true), t) : !(xi & 42) || xi & 1073741824 && !(ot & 261930) ? (oe = true, t.memoizedState = n) : (t = Lb(), at.lanes |= t, da |= t, e);
  }
  function Z1(t, e, n, i, a) {
    var r = mt.p;
    mt.p = r !== 0 && 8 > r ? r : 8;
    var s = et.T, l = {};
    et.T = l, Fm(t, false, e, n);
    try {
      var u = a(), c = et.S;
      if (c !== null && c(l, u), u !== null && typeof u == "object" && typeof u.then == "function") {
        var f = ZE(u, i);
        hl(t, e, f, on(t));
      } else hl(t, e, i, on(t));
    } catch (d) {
  ...
  function iw(t, e, n) {
    ...
    n = {
      ...
      eagerState: null,
      next: null
    }, Nc(t) ? eb(e, n) : (n = wm(t, e, n, i), n !== null && (Xe(n, t, i), nb(n, e, i)));
  }
  function tb(t, e, n) {
    var i = on();
    hl(t, e, n, i);
  ...
  function hl(t, e, n, i) {
    ...
    if (Nc(t)) eb(e, a);
      ...
      if (n = wm(t, e, a, i), n !== null) return Xe(n, t, i), nb(n, e, i), true;
    }
    return false;
  }
  function Fm(t, e, n, i) {
    ...
    } else e = wm(t, n, i, 2), e !== null && Xe(e, t, 2);
  }
  function Nc(t) {
    var e = t.alternate;
  ...
  var ib = {
    ...
    useImperativeHandle: function(t, e, n) {
      n = n != null ? n.concat([
        t
      ]) : null, mu(4194308, 4, k1.bind(null, e, t), n);
    },
    ...
    useId: function() {
      ...
      if (ut) {
        var n = Kn, i = Fn;
        n = (i & ~(1 << 32 - ln(i) - 1)).toString(32) + n, e = "_" + e + "R_" + n, n = Fu++, 0 < n && (e += "H" + n.toString(32)), e += "_";
      } else n = JE++, e = "_" + e + "r_" + n.toString(32) + "_";
      return t.memoizedState = e;
    },
    useHostTransitionStatus: qm,
    useFormState: j0,
    useActionState: j0,
    useOptimistic: function(t) {
      ...
      return e.queue = n, e = Fm.bind(null, at, true, n), n.dispatch = e, [
        t,
        e
      ];
    },
  ...
  var ab = {
    ...
    useDeferredValue: function(t, e) {
      var n = It();
      return bt === null ? km(n, t, e) : Q1(n, bt.memoizedState, t, e);
    },
    useTransition: function() {
  ...
  var ad = {
    enqueueSetState: function(t, e, n) {
      t = t._reactInternals;
      var i = on(), a = ea(i);
      a.payload = e, n != null && (a.callback = n), e = na(t, a, i), e !== null && (Xe(e, t, i), ul(e, t, i));
    },
    enqueueReplaceState: function(t, e, n) {
      t = t._reactInternals;
      var i = on(), a = ea(i);
      a.tag = 1, a.payload = e, n != null && (a.callback = n), e = na(t, a, i), e !== null && (Xe(e, t, i), ul(e, t, i));
    },
    enqueueForceUpdate: function(t, e) {
      t = t._reactInternals;
      var n = on(), i = ea(n);
      i.tag = 2, e != null && (i.callback = e), e = na(t, i, n), e !== null && (Xe(e, t, n), ul(e, t, n));
    }
  };
  ...
  function ub(t, e, n, i) {
    ...
    s !== null && typeof s.componentDidCatch == "function" && (t.callback = function() {
      X0(e, n, i), typeof a != "function" && (ia === null ? ia = /* @__PURE__ */ new Set([
        this
      ]) : ia.add(this));
      var l = i.stack;
  ...
  function aw(t, e, n, i, a) {
    if (n.flags |= 32768, i !== null && typeof i == "object" && typeof i.then == "function") {
      if (e = n.alternate, e !== null && bs(e, n, a, true), n = fn.current, n !== null) {
        switch (n.tag) {
          case 31:
          case 13:
            return Rn === null ? Wu() : n.alternate === null && qt === 0 && (qt = 3), n.flags &= -257, n.flags |= 65536, n.lanes = a, i === Pu ? n.flags |= 16384 : (e = n.updateQueue, e === null ? n.updateQueue = /* @__PURE__ */ new Set([
              i
    ...
    if (ut) return e = fn.current, e !== null ? (!(e.flags & 65536) && (e.flags |= 256), e.flags |= 65536, e.lanes = a, i !== Fh && (t = Error(j(422), {
      cause: i
    }), Vl(An(t, n)))) : (i !== Fh && (e = Error(j(423), {
      cause: i
    }), Vl(An(e, n))), t = t.current.alternate, t.flags |= 65536, a &= -a, t.lanes |= a, i = An(i, n), a = rd(t.stateNode, i, a), Lf(t, a), qt !== 4 && (qt = 2)), false;
    var r = Error(j(520), {
      cause: i
    });
    if (r = An(r, n), pl === null ? pl = [
      r
    ] : pl.push(r), qt !== 4 && (qt = 2), e === null) return true;
    i = An(i, n), n = e;
    do {
      switch (n.tag) {
        case 3:
  ...
  function fb(t, e, n, i) {
    ...
    if (t === null && e.stateNode === null && (e.stateNode = {
      ...
      else return i = e.lanes = 536870912, F0(t, e, r !== null ? r.baseLanes | n : n, n, i);
  ...
  function F0(t, e, n, i, a) {
    ...
    return r = r === null ? null : {
      ...
      baseLanes: n,
      cachePool: r
    }, t !== null && hu(e, null), Ih(), w1(e), t !== null && bs(t, e, i, true), e.childLanes = a, null;
  }
  function pu(t, e) {
    return e = Qu({
      mode: e.mode,
  ...
  function rw(t, e, n) {
    ...
    if (r !== null) {
      ...
      else if (oe || bs(t, e, n, false), a = (n & t.childLanes) !== 0, oe || a) {
        if (i = xt, i !== null && (s = P_(i, n), s !== 0 && s !== r.retryLane)) throw r.retryLane = s, or(t, s), Xe(i, t, s), Qm;
        Wu(), e = K0(t, e, n);
  ...
  function Z0(t, e, n, i, a) {
    if (tr(e), e.stateNode === null) {
      var r = Dr, s = n.contextType;
      typeof s == "object" && s !== null && (r = Te(s)), r = new n(i, r), e.memoizedState = r.state !== null && r.state !== void 0 ? r.state : null, r.updater = ad, e.stateNode = r, r._reactInternals = e, r = e.stateNode, r.props = i, r.state = e.memoizedState, r.refs = {}, Um(e), s = n.contextType, r.context = typeof s == "object" && s !== null ? Te(s) : Dr, r.state = e.memoizedState, s = n.getDerivedStateFromProps, typeof s == "function" && (jf(e, n, s, i), r.state = e.memoizedState), typeof n.getDerivedStateFromProps == "function" || typeof r.getSnapshotBeforeUpdate == "function" || typeof r.UNSAFE_componentWillMount != "function" && typeof r.componentWillMount != "function" || (s = r.state, typeof r.componentWillMount == "function" && r.componentWillMount(), typeof r.UNSAFE_componentWillMount == "function" && r.UNSAFE_componentWillMount(), s !== r.state && ad.enqueueReplaceState(r, r.state, null), fl(e, i, r, a), cl(), r.state = e.memoizedState), typeof r.componentDidMount == "function" && (e.flags |= 4194308), i = true;
    } else if (t === null) {
      r = e.stateNode;
      var l = e.memoizedProps, u = ir(n, l);
      r.props = u;
      var c = r.context, f = n.contextType;
      s = Dr, typeof f == "object" && f !== null && (s = Te(f));
      ...
      r.state = m, fl(e, i, r, a), cl(), c = e.memoizedState, l || m !== c || Hi ? (typeof d == "function" && (jf(e, n, d, i), c = e.memoizedState), (u = Hi || G0(e, n, u, i, m, c, s)) ? (f || typeof r.UNSAFE_componentWillMount != "function" && typeof r.componentWillMount != "function" || (typeof r.componentWillMount == "function" && r.componentWillMount(), typeof r.UNSAFE_componentWillMount == "function" && r.UNSAFE_componentWillMount()), typeof r.componentDidMount == "function" && (e.flags |= 4194308)) : (typeof r.componentDidMount == "function" && (e.flags |= 4194308), e.memoizedProps = i, e.memoizedState = c), r.props = i, r.state = c, r.context = s, i = u) : (typeof r.componentDidMount == "function" && (e.flags |= 4194308), i = false);
    } else {
      r = e.stateNode, $h(t, e), s = e.memoizedProps, f = ir(n, s), r.props = f, d = e.pendingProps, m = r.context, c = n.contextType, u = Dr, typeof c == "object" && c !== null && (u = Te(c)), l = n.getDerivedStateFromProps, (c = typeof l == "function" || typeof r.getSnapshotBeforeUpdate == "function") || typeof r.UNSAFE_componentWillReceiveProps != "function" && typeof r.componentWillReceiveProps != "function" || (s !== d || m !== u) && P0(e, r, i, u), Hi = false, m = e.memoizedState, r.state = m, fl(e, i, r, a), cl();
      var y = e.memoizedState;
      s !== d || m !== y || Hi || t !== null && t.dependencies !== null && Gu(t.dependencies) ? (typeof l == "function" && (jf(e, n, l, i), y = e.memoizedState), (f = Hi || G0(e, n, f, i, m, y, u) || t !== null && t.dependencies !== null && Gu(t.dependencies)) ? (c || typeof r.UNSAFE_componentWillUpdate != "function" && typeof r.componentWillUpdate != "function" || (typeof r.componentWillUpdate == "function" && r.componentWillUpdate(i, y, u), typeof r.UNSAFE_componentWillUpdate == "function" && r.UNSAFE_componentWillUpdate(i, y, u)), typeof r.componentDidUpdate == "function" && (e.flags |= 4), typeof r.getSnapshotBeforeUpdate == "function" && (e.flags |= 1024)) : (typeof r.componentDidUpdate != "function" || s === t.memoizedProps && m === t.memoizedState || (e.flags |= 4), typeof r.getSnapshotBeforeUpdate != "function" || s === t.memoizedProps && m === t.memoizedState || (e.flags |= 1024), e.memoizedProps = i, e.memoizedState = y), r.props = i, r.state = y, r.context = u, i = f) : (typeof r.componentDidUpdate != "function" || s === t.memoizedProps && m === t.memoizedState || (e.flags |= 4), typeof r.getSnapshotBeforeUpdate != "function" || s === t.memoizedProps && m === t.memoizedState || (e.flags |= 1024), i = false);
    }
  ...
  function hb(t, e, n) {
    ...
    if (u !== null && (l = u.dehydrated, l !== null)) {
      ...
      } else if (oe || bs(t, e, n, false), s = (n & t.childLanes) !== 0, oe || s) {
        if (s = xt, s !== null && (i = P_(s, n), i !== 0 && i !== u.retryLane)) throw u.retryLane = i, or(t, i), Xe(s, t, i), Qm;
        _d(l) || Wu(), e = Gf(t, e, n);
      } else _d(l) ? (e.flags |= 192, e.child = t.child, e = null) : (t = u.treeContext, Rt = On(l.nextSibling), Se = e, ut = true, ta = null, En = false, t !== null && v1(e, t), e = ld(e, i.children), e.flags |= 4096);
      return e;
    }
    return a ? (Pi(), l = i.fallback, a = e.mode, u = t.child, c = u.sibling, i = vi(u, {
      mode: "hidden",
      children: i.children
    }), i.subtreeFlags = u.subtreeFlags & 65011712, c !== null ? l = vi(c, l) : (l = Pa(l, a, n, null), l.flags |= 2), l.return = e, i.return = e, i.sibling = l, e.child = i, Is(null, i), i = e.child, l = t.child.memoizedState, l === null ? l = Hf(n) : (a = l.cachePool, a !== null ? (u = se._currentValue, a = a.parent !== u ? {
      parent: u,
      pool: u
    } : a) : a = b1(), l = {
  ...
  function db(t, e, n) {
    ...
    switch (a) {
      case "forwards":
        for (n = e.child, a = null; n !== null; ) t = n.alternate, t !== null && ku(t) === null && (a = n), n = n.sibling;
  ...
  function Ei(t, e, n) {
    if (t !== null && (e.dependencies = t.dependencies), da |= e.lanes, !(n & e.childLanes)) if (t !== null) {
      if (bs(t, e, n, false), (n & e.childLanes) === 0) return null;
    } else return null;
  ...
  function sw(t, e, n) {
    switch (e.tag) {
      ...
      case 19:
        var a = (t.flags & 128) !== 0;
        if (i = (n & e.childLanes) !== 0, i || (bs(t, e, n, false), i = (n & e.childLanes) !== 0), a) {
  ...
  function mb(t, e, n) {
    ...
    switch (e.lanes = 0, e.tag) {
        ...
        t: {
          ...
          if (t = Va(e.elementType), e.type = t, typeof t == "function") Mm(t) ? (i = ir(t, i), e.tag = 1, e = Z0(null, e, t, i, n)) : (e.tag = 0, e = sd(null, e, t, i, n));
            ...
            if (t != null) {
              var a = t.$$typeof;
              if (a === dm) {
                e.tag = 11, e = k0(null, e, t, i, n);
                break t;
              } else if (a === mm) {
                e.tag = 14, e = q0(null, e, t, i, n);
                break t;
              }
            }
      ...
      case 11:
        return k0(t, e, e.type, e.pendingProps, n);
      case 7:
      ...
      case 14:
        return q0(t, e, e.type, e.pendingProps, n);
      case 15:
  ...
  function Qo(t, e) {
    e !== null && (t.flags |= 4), t.flags & 16384 && (e = t.tag !== 22 ? H_() : 536870912, t.lanes |= e, is |= e);
  }
  function ks(t, e) {
  ...
  function lw(t, e, n) {
    ...
    switch (Dm(e), e.tag) {
      ...
      case 1:
        return Dt(e), null;
      case 3:
        return n = e.stateNode, i = null, t !== null && (i = t.memoizedState.cache), e.memoizedState.cache !== i && (e.flags |= 2048), _i(se), $r(), n.pendingContext && (n.context = n.pendingContext, n.pendingContext = null), (t === null || t.child === null) && (mr(e) ? li(e) : t === null || t.memoizedState.isDehydrated && !(e.flags & 256) || (e.flags |= 1024, Vf())), Dt(e), null;
      case 26:
        var a = e.type, r = e.memoizedState;
        return t === null ? (li(e), r !== null ? (Dt(e), W0(e, r)) : (Dt(e), Xf(e, a, null, i, n))) : r ? r !== t.memoizedState ? (li(e), Dt(e), W0(e, r)) : (Dt(e), e.flags &= -16777217) : (t = t.memoizedProps, t !== i && li(e), Dt(e), Xf(e, a, t, i, n)), null;
      case 27:
        if (Lu(e), n = Ii.current, a = e.type, t !== null && e.stateNode != null) t.memoizedProps !== i && li(e);
          ...
          t = Jn.current, mr(e) ? M0(e) : (t = aS(a, i, n), e.stateNode = t, li(e));
        }
        return Dt(e), null;
      case 5:
      ...
      case 13:
        if (i = e.memoizedState, t === null || t.memoizedState !== null && t.memoizedState.dehydrated !== null) {
          if (a = mr(e), i !== null && i.dehydrated !== null) {
            if (t === null) {
      ...
      case 4:
        return $r(), t === null && np(e.stateNode.containerInfo), Dt(e), null;
      case 10:
        return _i(e.type), Dt(e), null;
      case 19:
        if (de(Wt), i = e.memoizedState, i === null) return Dt(e), null;
        if (a = (e.flags & 128) !== 0, r = i.rendering, r === null) if (a) ks(i, false);
        else {
          if (qt !== 0 || t !== null && t.flags & 128) for (t = e.child; t !== null; ) {
            if (r = ku(t), r !== null) {
              for (e.flags |= 128, ks(i, false), t = r.updateQueue, e.updateQueue = t, Qo(e, t), e.subtreeFlags = 0, t = n, n = e.child; n !== null; ) p1(n, t), n = n.sibling;
              return Et(Wt, Wt.current & 1 | 2), ut && hi(e, i.treeForkCount), e.child;
            }
            t = t.sibling;
          }
          i.tail !== null && rn() > Ju && (e.flags |= 128, a = true, ks(i, false), e.lanes = 4194304);
        }
        else {
          if (!a) if (t = ku(r), t !== null) {
            if (e.flags |= 128, a = true, t = t.updateQueue, e.updateQueue = t, Qo(e, t), ks(i, true), i.tail === null && i.tailMode === "hidden" && !r.alternate && !ut) return Dt(e), null;
          } else 2 * rn() - i.renderingStartTime > Ju && n !== 536870912 && (e.flags |= 128, a = true, ks(i, false), e.lanes = 4194304);
  ...
  function ow(t, e) {
    switch (Dm(e), e.tag) {
      ...
      case 3:
        return _i(se), $r(), t = e.flags, t & 65536 && !(t & 128) ? (e.flags = t & -65537 | 128, e) : null;
      case 26:
      case 27:
      case 5:
        return Lu(e), null;
      ...
      case 22:
      case 23:
        return Ie(e), Vm(), t !== null && de(Xa), t = e.flags, t & 65536 ? (e.flags = t & -65537 | 128, e) : null;
      case 24:
        return _i(se), null;
      case 25:
        return null;
  ...
  var mi = false, ae = false, Ff = false, I0 = typeof WeakSet == "function" ? WeakSet : Set, fe = null;
  function uw(t, e) {
    if (t = t.containerInfo, pd = sc, t = l1(t), Am(t)) {
      if ("selectionStart" in t) var n = {
        ...
        if (i && i.rangeCount !== 0) {
          ...
          var s = 0, l = -1, u = -1, c = 0, f = 0, d = t, m = null;
          e: for (; ; ) {
            for (var y; d !== n || a !== 0 && d.nodeType !== 3 || (l = s + a), d !== r || i !== 0 && d.nodeType !== 3 || (u = s + i), d.nodeType === 3 && (s += d.nodeValue.length), (y = d.firstChild) !== null; ) m = d, d = y;
            for (; ; ) {
              if (d === t) break e;
              if (m === n && ++c === a && (l = s), m === r && ++f === i && (u = s), (y = d.nextSibling) !== null) break;
              d = m, m = d.parentNode;
            }
            d = y;
          }
  ...
  function xb(t, e, n) {
    ...
    switch (n.tag) {
      case 26:
        ae || Qn(n, e), oi(t, e, n), n.memoizedState ? n.memoizedState.count-- : n.stateNode && (n = n.stateNode, n.parentNode.removeChild(n));
        break;
      case 27:
        ae || Qn(n, e);
        var i = Ut, a = Ye;
      ...
      case 6:
        ...
        break;
      case 18:
        Ut !== null && (Ye ? (t = Ut, hg(t.nodeType === 9 ? t.body : t.nodeName === "HTML" ? t.ownerDocument.body : t, n.stateNode), ls(t)) : hg(Ut, n.stateNode));
        break;
      case 4:
      ...
      case 15:
        ...
        break;
      case 1:
        ae || (Qn(n, e), i = n.stateNode, typeof i.componentWillUnmount == "function" && gb(n, e, i)), oi(t, e, n);
        break;
      case 21:
        oi(t, e, n);
        break;
  ...
  function wb(t, e) {
    ...
    switch (t.tag) {
      ...
      case 15:
        ...
        break;
      case 1:
        Be(e, t), He(t), i & 512 && (ae || n === null || Qn(n, n.return)), i & 64 && mi && (t = t.updateQueue, t !== null && (i = t.callbacks, i !== null && (n = t.shared.hiddenCallbacks, t.shared.hiddenCallbacks = n === null ? i : n.concat(i))));
        break;
      case 26:
        var a = Bn;
        if (Be(e, t), He(t), i & 512 && (ae || n === null || Qn(n, n.return)), i & 4) {
          ...
          else r !== i ? (r === null ? n.stateNode !== null && (n = n.stateNode, n.parentNode.removeChild(n)) : r.count--, i === null ? bg(a, t.type, t.stateNode) : vg(a, i, t.memoizedProps)) : i === null && t.stateNode !== null && kf(t, t.memoizedProps, n.memoizedProps);
        }
        break;
      case 27:
        Be(e, t), He(t), i & 512 && (ae || n === null || Qn(n, n.return)), n !== null && i & 4 && kf(t, t.memoizedProps, n.memoizedProps);
        break;
      case 5:
        if (Be(e, t), He(t), i & 512 && (ae || n === null || Qn(n, n.return)), t.flags & 32) {
          a = t.stateNode;
          try {
            Ir(a, "");
          } catch (T) {
        ...
        i & 4 && t.stateNode != null && (a = t.memoizedProps, kf(t, a, n !== null ? n.memoizedProps : a)), i & 1024 && (Ff = true);
        break;
      case 6:
        if (Be(e, t), He(t), i & 4) {
      ...
      case 22:
        ...
        var u = n !== null && n.memoizedState !== null, c = mi, f = ae;
        if (mi = c || a, ae = f || u, Be(e, t), ae = f, mi = c, He(t), i & 8192) t: for (e = t.stateNode, e._visibility = a ? e._visibility & -2 : e._visibility | 1, a && (n === null || u || mi || ae || La(t)), n = null, e = t; ; ) {
          if (e.tag === 5 || e.tag === 26) {
            if (n === null) {
              u = n = e;
              try {
                if (r = u.stateNode, a) s = r.style, typeof s.setProperty == "function" ? s.setProperty("display", "none", "important") : s.display = "none";
                else {
                  l = u.stateNode;
                  var d = u.memoizedProps.style, m = d != null && d.hasOwnProperty("display") ? d.display : null;
            ...
            if (n === null) {
              ...
              try {
                var y = u.stateNode;
                a ? dg(y, true) : dg(u.stateNode, false);
              } catch (T) {
                gt(u, u.return, T);
              }
            }
  ...
  function He(t) {
    ...
    if (e & 2) {
      try {
        ...
        switch (n.tag) {
          case 27:
            var a = n.stateNode, r = qf(t);
            Zu(t, r, a);
            break;
          case 5:
            var s = n.stateNode;
            n.flags & 32 && (Ir(s, ""), n.flags &= -33);
            var l = qf(t);
            Zu(t, l, s);
            break;
          case 3:
          case 4:
            var u = n.stateNode.containerInfo, c = qf(t);
            od(t, c, u);
            break;
          default:
            throw Error(j(161));
        ...
        case 1:
          ...
          if (i = r, a = i.updateQueue, a !== null) {
            ...
            try {
              ...
              if (u !== null) for (a.shared.hiddenCallbacks = null, a = 0; a < u.length; a++) A1(u[a], l);
            } catch (c) {
              gt(i, i.return, c);
            }
          }
  ...
  function Cb(t, e, n, i) {
    ...
    switch (e.tag) {
      ...
      case 23:
        break;
      case 22:
        r = e.stateNode, s = e.alternate, e.memoizedState !== null ? r._visibility & 2 ? Nn(t, e, n, i) : ml(t, e) : r._visibility & 2 ? Nn(t, e, n, i) : (r._visibility |= 2, _r(t, e, n, i, (e.subtreeFlags & 10256) !== 0 || false)), a & 2048 && Jm(s, e);
        break;
      case 24:
  ...
  function _r(t, e, n, i, a) {
    for (a = a && ((e.subtreeFlags & 10256) !== 0 || false), e = e.child; e !== null; ) {
      ...
      switch (s.tag) {
        ...
        case 22:
          var f = s.stateNode;
          s.memoizedState !== null ? f._visibility & 2 ? _r(r, s, l, u, a) : ml(r, s) : (f._visibility |= 2, _r(r, s, l, u, a)), a && c & 2048 && Jm(s.alternate, s);
          break;
        case 24:
          _r(r, s, l, u, a), a && c & 2048 && $m(s.alternate, s);
          break;
        default:
          _r(r, s, l, u, a);
      }
  ...
  function Db(t, e, n) {
    switch (t.tag) {
      case 26:
        pr(t, e, n), t.flags & tl && t.memoizedState !== null && Jw(n, Bn, t.memoizedState, t.memoizedProps);
        break;
      case 5:
        pr(t, e, n);
        break;
      ...
      case 4:
        var i = Bn;
        Bn = ic(t.stateNode.containerInfo), pr(t, e, n), Bn = i;
        break;
      case 22:
        t.memoizedState === null && (i = t.alternate, i !== null && i.memoizedState !== null ? (i = tl, tl = 16777216, pr(t, e, n), tl = i) : pr(t, e, n));
        break;
      default:
        pr(t, e, n);
    }
  ...
  function Ob(t) {
    switch (t.tag) {
      ...
      case 11:
      case 15:
        qs(t), t.flags & 2048 && ha(9, t, t.return);
        break;
      case 3:
        qs(t);
        break;
      ...
      case 22:
        var e = t.stateNode;
        t.memoizedState !== null && e._visibility & 2 && (t.return === null || t.return.tag !== 13) ? (e._visibility &= -3, gu(t)) : qs(t);
        break;
      default:
        qs(t);
    }
  ...
  }, hw = typeof WeakMap == "function" ? WeakMap : Map, dt = 0, xt = null, lt = null, ot = 0, yt = 0, $e = null, Fi = false, Ts = false, Wm = false, wi = 0, qt = 0, da = 0, qa = 0, Im = 0, nn = 0, is = 0, pl = null, Ge = null, ud = false, jc = 0, Ub = 0, Ju = 1 / 0, $u = null, ia = null, ue = 0, aa = null, as = null, bi = 0, cd = 0, fd = null, Vb = null, yl = 0, hd = null;
  function on() {
    return dt & 2 && ot !== 0 ? ot & -ot : et.T !== null ? ep() : X_();
  }
  function Lb() {
  ...
  function Xe(t, e, n) {
    (t === xt && (yt === 2 || yt === 9) || t.cancelPendingCommit !== null) && (rs(t, 0), Ki(t, ot, nn, false)), lo(t, n), (!(dt & 2) || t !== xt) && (t === xt && (!(dt & 2) && (qa |= n), qt === 4 && Ki(t, ot, nn, false)), ni(t));
  }
  function Nb(t, e, n) {
      ...
      if (a === 0) {
        ...
        if (a === 2) {
          ...
          if (s !== 0) {
            ...
            t: {
              ...
              if (u && (rs(l, s).flags |= 256), s = Kf(l, s, false), s !== 2) {
                if (Wm && !u) {
                  l.errorRecoveryDisabledLanes |= r, qa |= r, a = 4;
                  break t;
                }
        ...
        t: {
          ...
          if ((e & 62914560) === e && (a = jc + 300 - rn(), 10 < a)) {
            if (Ki(i, e, nn, !Fi), wc(i, 0, true) !== 0) break t;
            bi = e, i.timeoutHandle = nS(tg.bind(null, i, n, Ge, $u, ud, e, nn, qa, is, Fi, r, "Throttled", -0, 0), a);
            break t;
          }
          tg(i, n, Ge, $u, ud, e, nn, qa, is, Fi, r, null, -0, 0);
        }
      }
      break;
    } while (true);
  ...
  function tg(t, e, n, i, a, r, s, l, u, c, f, d, m, y) {
    if (t.timeoutHandle = -1, d = e.subtreeFlags, d & 8192 || (d & 16785408) === 16785408) {
      ...
      if (T = $w(d, T), T !== null) {
        bi = r, t.cancelPendingCommit = T(ng.bind(null, t, e, r, n, i, a, s, l, u, f, d, null, m, y)), Ki(t, r, s, !c);
        return;
      }
    }
    ng(t, e, r, n, i, a, s, l, u);
  }
  function dw(t) {
    for (var e = t; ; ) {
      var n = e.tag;
  ...
  function Ki(t, e, n, i) {
    e &= ~Im, e &= ~qa, t.suspendedLanes |= e, t.pingedLanes &= ~e, i && (t.warmLanes |= e), i = t.expirationTimes;
    for (var a = e; 0 < a; ) {
      var r = 31 - ln(a), s = 1 << r;
      i[r] = -1, a &= ~s;
    }
  ...
  function tp() {
    if (lt !== null) {
      ...
      else t = lt, gi = ur = null, Hm(t), kr = null, Ll = 0, t = lt;
  ...
  function rs(t, e) {
    ...
    n !== -1 && (t.timeoutHandle = -1, Uw(n)), n = t.cancelPendingCommit, n !== null && (t.cancelPendingCommit = null, n()), bi = 0, tp(), xt = t, lt = n = vi(t.current, null), ot = e, yt = 0, $e = null, Fi = false, Ts = so(t, e), Wm = false, is = nn = Im = qa = da = qt = 0, Ge = pl = null, ud = false, e & 8 && (e |= e & 32);
  ...
  function jb(t, e) {
    at = null, et.H = jl, e === Ss || e === zc ? (e = z0(), yt = 3) : e === zm ? (e = z0(), yt = 4) : yt = e === Qm ? 8 : e !== null && typeof e == "object" && typeof e.then == "function" ? 6 : 1, $e = e, lt === null && (qt = 1, Ku(t, An(e, t.current)));
  }
  function Bb() {
    var t = fn.current;
  ...
  function Wu() {
    qt = 4, Fi || (ot & 4194048) !== ot && fn.current !== null || (Ts = true), !(da & 134217727) && !(qa & 134217727) || xt === null || Ki(xt, ot, nn, false);
  }
  function Kf(t, e, n) {
    var i = dt;
    dt |= 2;
    var a = Hb(), r = Yb();
    (xt !== t || ot !== e) && ($u = null, rs(t, e)), e = false;
    var s = qt;
    t: do
      try {
        if (yt !== 0 && lt !== null) {
          ...
          switch (yt) {
            ...
            case 6:
              ...
              var c = yt;
              if (yt = 0, $e = null, zr(t, l, u, c), n && Ts) {
                s = 0;
                break t;
              }
              break;
            default:
              c = yt, yt = 0, $e = null, zr(t, l, u, c);
          }
        }
        mw(), s = qt;
        break;
  ...
  function pw(t, e) {
    ...
    dt |= 2;
    var i = Hb(), a = Yb();
    xt !== t || ot !== e ? ($u = null, Ju = rn() + 500, rs(t, e)) : Ts = so(t, e);
    t: do
      try {
        if (yt !== 0 && lt !== null) {
          e = lt;
          ...
          e: switch (yt) {
            ...
            case 4:
              ...
              break t;
            case 7:
              O0(r) ? (yt = 0, $e = null, eg(e)) : (yt = 0, $e = null, zr(t, e, r, 7));
              break;
            case 5:
              var s = null;
              switch (lt.tag) {
              ...
              yt = 0, $e = null, zr(t, e, r, 5);
              break;
            case 6:
              yt = 0, $e = null, zr(t, e, r, 6);
              break;
            case 8:
              tp(), qt = 6;
              break t;
    ...
    while (true);
    return gi = ur = null, et.H = i, et.A = a, dt = n, lt !== null ? 0 : (xt = null, ot = 0, Rc(), qt);
  }
  function yw() {
  ...
  function zr(t, e, n, i) {
    gi = ur = null, Hm(e), kr = null, Ll = 0;
    var a = e.return;
    try {
      if (aw(t, a, e, n, ot)) {
        qt = 1, Ku(t, An(n, t.current)), lt = null;
        return;
      }
    } catch (r) {
    ...
    e.flags & 32768 ? (ut || i === 1 ? t = true : Ts || ot & 536870912 ? t = false : (Fi = t = true, (i === 2 || i === 9 || i === 3 || i === 6) && (i = fn.current, i !== null && i.tag === 13 && (i.flags |= 16384))), Pb(e, t)) : Hc(e);
  }
  function Hc(t) {
    var e = t;
    do {
  ...
  function ng(t, e, n, i, a, r, s, l, u) {
    ...
    if (e !== null) {
      ...
      if (r = e.lanes | e.childLanes, r |= Em, ZA(t, n, r, s, l, u), t === xt && (lt = xt = null, ot = 0), as = e, aa = t, bi = n, cd = r, fd = a, Vb = i, e.subtreeFlags & 10256 || e.flags & 10256 ? (t.callbackNode = null, t.callbackPriority = 0, bw(Nu, function() {
        return Kb(), null;
  ...
  function Xb() {
    if (ue === 1) {
      ue = 0;
      var t = aa, e = as, n = (e.flags & 13878) !== 0;
      if (e.subtreeFlags & 13878 || n) {
        ...
        try {
          wb(e, t);
          var r = yd, s = l1(t.containerInfo), l = r.focusedElem, u = r.selectionRange;
          if (s !== l && l && l.ownerDocument && s1(l.ownerDocument.documentElement, l)) {
            if (u !== null && Am(l)) {
              ...
              if (f === void 0 && (f = c), "selectionStart" in l) l.selectionStart = c, l.selectionEnd = Math.min(f, l.value.length);
                ...
                if (m.getSelection) {
                  var y = m.getSelection(), T = l.textContent.length, b = Math.min(u.start, T), x = u.end === void 0 ? b : Math.min(u.end, T);
  ...
  function kb() {
    if (ue === 2) {
      ue = 0;
      var t = aa, e = as, n = (e.flags & 8772) !== 0;
  ...
  function qb() {
    if (ue === 4 || ue === 3) {
      ue = 0, YA();
      var t = aa, e = as, n = bi, i = Vb;
      e.subtreeFlags & 10256 || e.flags & 10256 ? ue = 5 : (ue = 0, as = aa = null, Fb(t, t.pendingLanes));
  ...
  function Kb() {
    ...
    try {
      ...
      var r = aa, s = bi;
      if (ue = 0, as = aa = null, bi = 0, dt & 6) throw Error(j(331));
      var l = dt;
  ...
  function gw(t, e, n) {
    var i = t.pingCache;
    i !== null && i.delete(e), t.pingedLanes |= t.suspendedLanes & n, t.warmLanes &= ~n, xt === t && (ot & n) === n && (qt === 4 || qt === 3 && (ot & 62914560) === ot && 300 > rn() - jc ? !(dt & 2) && rs(t, 0) : Im |= n, is === ot && (is = 0)), ni(t);
  }
  function Qb(t, e) {
  ...
  var Iu = null, br = null, dd = false, tc = false, Zf = false, Qi = 0;
  function ni(t) {
    t !== br && t.next === null && (br === null ? Iu = br = t : br = br.next = t), tc = true, dd || (dd = true, Tw());
  }
  function mo(t, e) {
    if (!Zf && tc) {
      Zf = true;
  ...
  function Zb() {
    ...
    for (var e = rn(), n = null, i = Iu; i !== null; ) {
      ...
      r === 0 ? (i.next = null, n === null ? Iu = a : n.next = a, a === null && (br = n)) : (n = i, (t !== 0 || r & 3) && (tc = true)), i = a;
    }
    ue !== 0 && ue !== 5 || mo(t), Qi !== 0 && (Qi = 0);
  }
  function Jb(t, e) {
    for (var n = t.suspendedLanes, i = t.pingedLanes, a = t.expirationTimes, r = t.pendingLanes & -62914561; 0 < r; ) {
      var s = 31 - ln(r), l = 1 << s, u = a[s];
      u === -1 ? (!(l & n) || l & i) && (a[s] = QA(l, e)) : u <= e && (t.expiredLanes |= l), r &= ~l;
    }
        ...
        listeners: [
          {
            ...
            listener: function() {
              ...
              } else typeof r == "function" && (l.preventDefault(), u = s ? sg(a, s) : new FormData(a), id(n, {
                pending: true,
                data: u,
                method: a.method,
                action: r
  ...
  for (var Jf = 0; Jf < qh.length; Jf++) {
    var $f = qh[Jf], Aw = $f.toLowerCase(), Ew = $f[0].toUpperCase() + $f.slice(1);
    Hn(Aw, "on" + Ew);
  }
  Hn(u1, "onAnimationEnd");
  Hn(c1, "onAnimationIteration");
  Hn(f1, "onAnimationStart");
  Hn("dblclick", "onDoubleClick");
  Hn("focusin", "onFocus");
  Hn("focusout", "onBlur");
  Hn(GE, "onTransitionRun");
  Hn(PE, "onTransitionStart");
  Hn(XE, "onTransitionCancel");
  Hn(h1, "onTransitionEnd");
  Wr("onMouseEnter", [
    "mouseout",
    "mouseover"
  ]);
    ...
    for (var n = 0; n < t.length; n++) {
      ...
      t: {
        ...
        if (e) for (var s = i.length - 1; 0 <= s; s--) {
          var l = i[s], u = l.instance, c = l.currentTarget;
          if (l = l.listener, u !== r && a.isPropagationStopped()) break t;
          ...
          a.currentTarget = null, r = u;
        }
        else for (s = 0; s < i.length; s++) {
          if (l = i[s], u = l.instance, c = l.currentTarget, l = l.listener, u !== r && a.isPropagationStopped()) break t;
          r = l, a.currentTarget = c;
          try {
            r(a);
          } catch (f) {
  ...
  function np(t) {
    if (!t[Jo]) {
      t[Jo] = true, k_.forEach(function(n) {
  ...
  function If(t, e, n, i, a) {
    ...
    W_(function() {
      ...
      if (!(e & 7)) {
        t: {
          if (m = t === "mouseover" || t === "pointerover", y = t === "mouseout" || t === "pointerout", m && n !== Gh && (T = n.relatedTarget || n.fromElement) && (xr(T) || T[vs])) break t;
          if ((y || m) && (m = f.window === f ? f : (m = f.ownerDocument) ? m.defaultView || m.parentWindow : window, y ? (T = n.relatedTarget || n.toElement, y = c, T = T ? xr(T) : null, T !== null && (x = ao(T), b = T.tag, T !== x || b !== 5 && b !== 27 && b !== 6) && (T = null)) : (y = null, T = c), y !== T)) {
            if (b = m0, A = "onMouseLeave", v = "onMouseEnter", g = "mouse", (t === "pointerout" || t === "pointerover") && (b = y0, A = "onPointerLeave", v = "onPointerEnter", g = "pointer"), x = y == null ? m : Ws(y), S = T == null ? m : Ws(T), m = new b(A, g + "leave", y, n, f), m.target = x, m.relatedTarget = S, A = null, xr(f) === c && (b = new b(v, g + "enter", T, n, f), b.target = S, b.relatedTarget = x, A = b), x = A, y && T) e: {
        ...
        switch (z = c ? Ws(c) : window, t) {
          case "focusin":
            (_0(z) || z.contentEditable === "true") && (wr = z, Xh = c, ll = null);
            break;
          case "focusout":
            ll = Xh = wr = null;
            break;
        ...
        else Er ? e1(t, n) && (U = "onCompositionEnd") : t === "keydown" && n.keyCode === 229 && (U = "onCompositionStart");
        U && (t1 && n.locale !== "ko" && (Er || U !== "onCompositionStart" ? U === "onCompositionEnd" && Er && (O = I_()) : (qi = f, Sm = "value" in qi ? qi.value : qi.textContent, Er = true)), z = ec(c, U), 0 < z.length && (U = new p0(U, t, null, n, f), d.push({
          event: U,
          listeners: z
  ...
  function lg(t, e, n, i, a) {
    for (var r = e._reactName, s = []; n !== null && n !== i; ) {
      ...
      l !== 5 && l !== 26 && l !== 27 || c === null || (u = c, a ? (c = Rl(n, r), c != null && s.unshift(Hl(n, c, u))) : a || (c = Rl(n, r), c != null && s.push(Hl(n, c, u)))), n = n.return;
    }
    s.length !== 0 && t.push({
      event: e,
      listeners: s
...
`).replace(Dw, "");
  ...
  function _t(t, e, n, i, a, r) {
    switch (n) {
      case "children":
        typeof i == "string" ? e === "body" || e === "textarea" && i === "" || Ir(t, i) : (typeof i == "number" || typeof i == "bigint") && e !== "body" && Ir(t, "" + i);
        break;
      case "className":
        Xo(t, "class", i);
        break;
  ...
  function md(t, e, n, i, a, r) {
    switch (n) {
      ...
      case "dangerouslySetInnerHTML":
        ...
        break;
      case "children":
        typeof i == "string" ? Ir(t, i) : (typeof i == "number" || typeof i == "bigint") && Ir(t, "" + i);
        break;
      case "onScroll":
        i != null && st("scroll", t);
        break;
  ...
  function xe(t, e, n) {
    switch (e) {
      ...
      case "select":
        ...
        e = r, n = s, t.multiple = !!i, e != null ? Gr(t, !!i, e, false) : n != null && Gr(t, !!i, n, true);
        return;
      case "textarea":
  ...
  function Rw(t, e, n, i) {
    switch (e) {
      ...
      case "li":
        break;
      case "input":
        var a = null, r = null, s = null, l = null, u = null, c = null, f = null;
        for (y in n) {
          var d = n[y];
      ...
      case "select":
        y = s = l = m = null;
        for (r in n) if (u = n[r], n.hasOwnProperty(r) && u != null) switch (r) {
          case "value":
            break;
          case "multiple":
            y = u;
          default:
            i.hasOwnProperty(r) || _t(t, e, r, null, i, u);
        }
        for (a in i) if (r = i[a], u = n[a], i.hasOwnProperty(a) && (r != null || u != null)) switch (a) {
          case "value":
            m = r;
            break;
          case "defaultValue":
        ...
        e = l, n = s, i = y, m != null ? Gr(t, !!n, m, false) : !!i != !!n && (e != null ? Gr(t, !!n, e, true) : Gr(t, !!n, n ? [] : "", false));
        return;
      case "textarea":
        y = m = null;
      ...
      case "option":
        ...
        for (u in i) if (m = i[u], y = n[u], i.hasOwnProperty(u) && m !== y && (m != null || y != null)) switch (u) {
          case "selected":
      ...
      for (var t = 0, e = 0, n = performance.getEntriesByType("resource"), i = 0; i < n.length; i++) {
        ...
        if (r && l && ug(s)) {
          for (s = 0, l = a.responseEnd, i += 1; i < n.length; i++) {
            var u = n[i], c = u.startTime;
            if (c > l) break;
            var f = u.transferSize, d = u.initiatorType;
            f && ug(d) && (u = u.responseEnd, s += f * (u < l ? 1 : (l - c) / (u - c)));
          }
  ...
  function qw(t, e, n) {
    ...
    var i = xs;
    if (i && t) {
      var a = Yr(i).hoistableStyles, r = ss(t);
      e = e || "default";
      var s = a.get(r);
      if (!s) {
        var l = {
        ...
        if (s = i.querySelector(po(r))) l.loading = 5;
          ...
          var u = s = i.createElement("link");
          he(u), xe(u, "link", t), u._p = new Promise(function(c, f) {
  ...
  function Fw(t, e) {
    ...
    var n = xs;
    if (n && t) {
      var i = Yr(n).hoistableScripts, a = As(t), r = i.get(a);
  ...
  function gg(t, e, n, i) {
    ...
    switch (t) {
      ...
      case "title":
        return null;
      case "style":
        return typeof n.precedence == "string" && typeof n.href == "string" ? (e = ss(n.href), n = Yr(a).hoistableStyles, i = n.get(e), i || (i = {
          type: "style",
          instance: null,
          count: 0,
          state: null
      ...
      case "link":
        if (n.rel === "stylesheet" && typeof n.href == "string" && typeof n.precedence == "string") {
          t = ss(n.href);
          var r = Yr(a).hoistableStyles, s = r.get(t);
        ...
        return null;
      case "script":
        return e = n.async, n = n.src, typeof n == "string" && e && typeof e != "function" && typeof e != "symbol" ? (e = As(n), n = Yr(a).hoistableScripts, i = n.get(e), i || (i = {
          type: "script",
          instance: null,
          count: 0,
          state: null
  ...
  function vg(t, e, n) {
    if (e.count++, e.instance === null) switch (e.type) {
      ...
      case "stylesheet":
        ...
        var s = r;
        return s._p = new Promise(function(l, u) {
          s.onload = l, s.onerror = u;
        }), xe(r, "link", i), e.state.loading |= 4, vu(r, n.precedence, t), e.instance = r;
      case "script":
        return r = As(n.src), (a = t.querySelector(yo(r))) ? (e.instance = a, he(a), a) : (i = n, (a = Un.get(r)) && (i = zt({}, n), ap(i, a)), t = t.ownerDocument || t, a = t.createElement("script"), he(a), xe(a, "link", i), t.head.appendChild(a), e.instance = a);
      case "void":
        return null;
      default:
  ...
  function Jw(t, e, n, i) {
    if (n.type === "stylesheet" && (typeof i.media != "string" || matchMedia(i.media).matches !== false) && !(n.state.loading & 4)) {
      if (n.instance === null) {
        var a = ss(i.href), r = e.querySelector(po(a));
        if (r) {
  ...
  function oS(t, e, n, i, a, r, s, l, u, c, f, d) {
    return t = new Iw(t, e, n, s, u, c, f, d, l), e = 1, r === true && (e |= 24), r = tn(3, null, null, e), t.current = r, r.stateNode = t, e = Rm(), e.refCount++, t.pooledCache = e, e.refCount++, r.memoizedState = {
      element: i,
      isDehydrated: n,
      cache: e
    }, Um(r), t;
  ...
  function cS(t, e, n, i, a, r) {
    a = uS(a), i.context === null ? i.context = a : i.pendingContext = a, i = ea(e), i.payload = {
      element: n
    }, r = r === void 0 ? null : r, r !== null && (i.callback = r), n = na(t, i, e), n !== null && (Xe(n, t, e), ul(n, t, e));
  }
  function Sg(t, e) {
  ...
  function fS(t) {
    if (t.tag === 13 || t.tag === 31) {
      var e = or(t, 67108864);
      e !== null && Xe(e, t, 67108864), rp(t, 67108864);
    }
  }
  function Tg(t) {
    if (t.tag === 13 || t.tag === 31) {
      ...
      if (a === null) If(t, e, i, lc, n), xg(t, i);
        ...
        for (; a !== null; ) {
          ...
          if (r !== null) switch (r.tag) {
            ...
            case 31:
            case 13:
              l = or(r, 2), l !== null && Xe(l, r, 2), Bc(), rp(r, 2);
          }
  ...
  function Fs(t, e, n, i, a, r) {
    ...
    }, e !== null && (e = _s(e), e !== null && fS(e)), t) : (t.eventSystemFlags |= i, e = t.targetContainers, a !== null && e.indexOf(a) === -1 && e.push(a), t);
  }
  function iM(t, e, n, i, a) {
    switch (e) {
      case "focusin":
        return ra = Fs(ra, t, e, n, i, a), true;
      case "dragenter":
        return sa = Fs(sa, t, e, n, i, a), true;
      case "mouseover":
        return la = Fs(la, t, e, n, i, a), true;
      case "pointerover":
        var r = a.pointerId;
        return Gl.set(r, Fs(Gl.get(r) || null, t, e, n, i, a)), true;
      case "gotpointercapture":
        return r = a.pointerId, Pl.set(r, Fs(Pl.get(r) || null, t, e, n, i, a)), true;
    }
    return false;
  }
  function dS(t) {
  ...
  function Su(t) {
    ...
    for (var e = t.targetContainers; 0 < e.length; ) {
      ...
      } else return e = _s(n), e !== null && fS(e), t.blockedOn = n, false;
      e.shift();
    }
    return true;
  }
  ...
  function ls(t) {
    ...
    for (; 0 < Xi.length && (n = Xi[0], n.blockedOn === null); ) dS(n), n.blockedOn === null && Xi.shift();
  ...
  Gc.prototype.unmount = op.prototype.unmount = function() {
    ...
    if (t !== null) {
      ...
      cS(t.current, 2, null, t, null, null), Bc(), e[vs] = null;
    }
  };
  function Gc(t) {
    this._internalRoot = t;
  ...
  Ac.createRoot = function(t, e) {
    ...
    return e != null && (e.unstable_strictMode === true && (n = true), e.identifierPrefix !== void 0 && (i = e.identifierPrefix), e.onUncaughtError !== void 0 && (a = e.onUncaughtError), e.onCaughtError !== void 0 && (r = e.onCaughtError), e.onRecoverableError !== void 0 && (s = e.onRecoverableError)), e = oS(t, 1, false, null, null, n, i, null, a, r, s, mS), t[vs] = e.current, np(t), new op(e);
  };
  Ac.hydrateRoot = function(t, e, n) {
    if (!R_(t)) throw Error(j(299));
    var i = false, a = "", r = rb, s = sb, l = lb, u = null;
    return n != null && (n.unstable_strictMode === true && (i = true), n.identifierPrefix !== void 0 && (a = n.identifierPrefix), n.onUncaughtError !== void 0 && (r = n.onUncaughtError), n.onCaughtError !== void 0 && (s = n.onCaughtError), n.onRecoverableError !== void 0 && (l = n.onRecoverableError), n.formState !== void 0 && (u = n.formState)), e = oS(t, 1, true, e, n ?? null, i, a, u, r, s, l, mS), e.context = uS(null), n = e.current, i = on(), i = ym(i), a = ea(i), a.callback = null, na(n, a, i), n = i, e.current.lanes = n, lo(e, n), ni(e), t[vs] = e.current, np(t), new Gc(e);
  };
  Ac.version = "19.2.0";
  function pS() {
    if (!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ > "u" || typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE != "function")) try {
  ...
  function oM(t = {}) {
    function e(i, a) {
      let { pathname: r, search: s, hash: l } = i.location;
      return Ad("", {
        pathname: r,
        search: s,
        hash: l
  ...
  function Ad(t, e, n = null, i) {
    return {
      ...
      search: "",
      hash: "",
      ...typeof e == "string" ? Es(e) : e,
      state: n,
      key: e && e.key || i || uM()
    };
  }
  function Xl({ pathname: t = "/", search: e = "", hash: n = "" }) {
  ...
  function cM(t, e, n, i = {}) {
    let { window: a = document.defaultView, v5Compat: r = false } = i, s = a.history, l = "POP", u = null, c = f();
    ...
    let b = {
      ...
      listen(x) {
        ...
        return a.addEventListener(Mg, d), u = x, () => {
          a.removeEventListener(Mg, d), u = null;
        };
      },
      createHref(x) {
        return e(a, x);
  ...
  function hM(t, e, n, i) {
    let a = typeof e == "string" ? Es(e) : e, r = Mi(a.pathname || "/", n);
  ...
  function gS(t, e = [], n = [], i = "", a = false) {
    let r = (s, l, u = a, c) => {
      ...
      if (f.relativePath.startsWith("/")) {
        if (!f.relativePath.startsWith(i) && u) return;
      ...
      s.children && s.children.length > 0 && (Gt(s.index !== true, `Index routes must not have child routes. Please remove all child routes from route path "${d}".`), gS(s.children, e, m, d, u)), !(s.path == null && !s.index) && e.push({
        path: d,
        score: bM(d, s.index),
        routesMeta: m
      });
    ...
    return t.forEach((s, l) => {
      ...
      else for (let u of vS(s.path)) r(s, l, true, u);
    }), e;
  }
  function vS(t) {
    let e = t.split("/");
    ...
    let s = vS(i.join("/")), l = [];
    return l.push(...s.map((u) => u === "" ? r : [
      r,
      u
    ].join("/"))), a && l.push(...s), l.map((u) => t.startsWith("/") && u === "" ? "/" : u);
  }
  function dM(t) {
  ...
  function TM(t, e, n = false) {
    ...
    for (let l = 0; l < i.length; ++l) {
      let u = i[l], c = l === i.length - 1, f = r === "/" ? e : e.slice(r.length) || "/", d = oc({
        path: u.relativePath,
  ...
  function xM(t, e = false, n = true) {
    In(t === "*" || !t.endsWith("*") || t.endsWith("/*"), `Route path "${t}" will be treated as if it were "${t.replace(/\*$/, "/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${t.replace(/\*$/, "/*")}".`);
    let i = [], a = "^" + t.replace(/\/*\*?$/, "").replace(/^\/*/, "/").replace(/[\\.*+^${}|()[\]]/g, "\\$&").replace(/\/:([\w-]+)(\?)?/g, (s, l, u) => (i.push({
      paramName: l,
      isOptional: u != null
    }), u ? "/?([^\\/]+)?" : "/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g, "(/$1)?$2");
  ...
  function AM(t) {
    try {
      ...
      return In(false, `The URL path "${t}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${e}).`), t;
    }
  }
  function Mi(t, e) {
    if (e === "/") return t;
  ...
  function EM(t, e = "/") {
    let { pathname: n, search: i = "", hash: a = "" } = typeof t == "string" ? Es(t) : t;
    return {
  ...
  function bS(t, e, n, i = false) {
    ...
    let u = EM(a, l), c = s && s !== "/" && s.endsWith("/"), f = (r || s === ".") && n.endsWith("/");
  ...
  function NM() {
    ...
    let t = D.useContext(ws), { basename: e, navigator: n } = D.useContext(ii), { matches: i } = D.useContext(Ui), { pathname: a } = cr(), r = JSON.stringify(_S(i)), s = D.useRef(false);
    return AS(() => {
      s.current = true;
    }), D.useCallback((u, c = {}) => {
      if (In(s.current, xS), !s.current) return;
      if (typeof u == "number") {
        n.go(u);
        return;
      }
      let f = bS(u, JSON.parse(r), a, c.relative === "path");
  ...
  function _o(t, { relative: e } = {}) {
    let { matches: n } = D.useContext(Ui), { pathname: i } = cr(), a = JSON.stringify(_S(n));
  ...
  function ES(t, e, n, i, a) {
    var _a2;
    Gt(vo(), "useRoutes() may be used only in the context of a <Router> component.");
    let { navigator: r } = D.useContext(ii), { matches: s } = D.useContext(Ui), l = s[s.length - 1], u = l ? l.params : {}, c = l ? l.pathname : "/", f = l ? l.pathnameBase : "/", d = l && l.route;
    {
      let g = d && d.path || "";
      wS(c, !d || g.endsWith("*") || g.endsWith("*?"), `You rendered descendant <Routes> (or called \`useRoutes()\`) at "${c}" (under <Route path="${g}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${g}"> to <Route path="${g === "/" ? "*" : `${g}/*`}">.`);
    }
    let m = cr(), y;
    if (e) {
      let g = typeof e == "string" ? Es(e) : e;
  ...
  function PM(t, e = [], n = null, i = null, a = null) {
    ...
    return r.reduceRight((c, f, d) => {
      ...
      n && (m = s && f.route.id ? s[f.route.id] : void 0, T = f.route.errorElement || HM, l && (u < 0 && d === 0 ? (wS("route-fallback", false, "No `HydrateFallback` element provided to render during initial hydration"), y = true, b = null) : u === d && (y = true, b = f.route.hydrateFallbackElement || null)));
  ...
  function hp(t) {
    let e = qM(t), n = e.matches[e.matches.length - 1];
  ...
  function KM() {
    var _a2;
    let t = D.useContext(up), e = kM("useRouteError"), n = hp("useRouteError");
    return t !== void 0 ? t : (_a2 = e.errors) == null ? void 0 : _a2[n];
  }
  function QM() {
    let { router: t } = XM("useNavigate"), e = hp("useNavigate"), n = D.useRef(false);
    return AS(() => {
      n.current = true;
    }), D.useCallback(async (a, r = {}) => {
      In(n.current, xS), n.current && (typeof a == "number" ? t.navigate(a) : await t.navigate(a, {
        fromRouteId: e,
        ...r
      }));
    }, [
  ...
  function JM({ basename: t = "/", children: e = null, location: n, navigationType: i = "POP", navigator: a, static: r = false }) {
    ...
    typeof n == "string" && (n = Es(n));
    let { pathname: u = "/", search: c = "", hash: f = "", state: d = null, key: m = "default" } = n, y = D.useMemo(() => {
      let T = Mi(u, s);
      return T == null ? null : {
        location: {
          pathname: T,
    ...
    return In(y != null, `<Router basename="${s}"> is not able to match the URL "${u}${c}${f}" because it does not start with the basename, so the <Router> won't render anything.`), y == null ? null : D.createElement(ii.Provider, {
      value: l
  ...
  function WM(t) {
    return Xc(t) && t.tagName.toLowerCase() === "button";
  }
  function IM(t) {
    return Xc(t) && t.tagName.toLowerCase() === "form";
  }
  function tC(t) {
    return Xc(t) && t.tagName.toLowerCase() === "input";
  }
  function eC(t) {
  ...
  function ih(t) {
    return t != null && !aC.has(t) ? (In(false, `"${t}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Au}"`), null) : t;
  }
  function rC(t, e) {
    let n, i, a, r, s;
    if (IM(t)) {
      ...
      if (i = u ? Mi(u, e) : null, n = t.getAttribute("formmethod") || l.getAttribute("method") || xu, a = ih(t.getAttribute("formenctype")) || ih(l.getAttribute("enctype")) || Au, r = new FormData(l, t), !iC()) {
      ...
      if (Xc(t)) throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');
  ...
  function Og(t, e, n, i, a, r) {
    let s = (u, c) => n[c] ? u.route.id !== n[c].route.id : true, l = (u, c) => {
      var _a2;
      return n[c].pathname !== u.pathname || ((_a2 = n[c].route.path) == null ? void 0 : _a2.endsWith("*")) && n[c].params["*"] !== u.params["*"];
    };
    return r === "assets" ? e.filter((u, c) => s(u, c) || l(u, c)) : r === "data" ? e.filter((u, c) => {
      var _a2;
      let f = i.routes[u.route.id];
      if (!f || !f.hasLoader) return false;
      if (s(u, c) || l(u, c)) return true;
  ...
  function MS() {
    ...
    return dp(t, "You must render this element inside a <DataRouterContext.Provider> element"), t;
  }
  function mC() {
    let t = D.useContext(Pc);
    return dp(t, "You must render this element inside a <DataRouterStateContext.Provider> element"), t;
  }
  var mp = D.createContext(void 0);
  mp.displayName = "FrameworkContext";
  function CS() {
    let t = D.useContext(mp);
    return dp(t, "You must render this element inside a <HydratedRouter> element"), t;
  }
  function pC(t, e) {
    let n = D.useContext(mp), [i, a] = D.useState(false), [r, s] = D.useState(false), { onFocus: l, onBlur: u, onMouseEnter: c, onMouseLeave: f, onTouchStart: d } = e, m = D.useRef(null);
    D.useEffect(() => {
  ...
  function yC({ page: t, ...e }) {
    let { router: n } = MS(), i = D.useMemo(() => yS(n.routes, t, n.basename), [
      n.routes,
      t,
      n.basename
    ]);
  ...
  function gC(t) {
    let { manifest: e, routeModules: n } = CS(), [i, a] = D.useState([]);
    return D.useEffect(() => {
      let r = false;
  ...
  function vC({ page: t, matches: e, ...n }) {
    let i = cr(), { manifest: a, routeModules: r } = CS(), { basename: s } = MS(), { loaderData: l, matches: u } = mC(), c = D.useMemo(() => Og(t, e, u, a, i, "data"), [
      t,
      e,
      u,
      a,
      i
    ]), f = D.useMemo(() => Og(t, e, u, a, i, "assets"), [
      t,
      e,
      u,
      a,
  ...
  try {
    DS && (window.__reactRouterVersion = "7.9.4");
  } catch {
  }
  ...
  var RS = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i, OS = D.forwardRef(function({ onClick: e, discover: n = "render", prefetch: i = "none", relative: a, reloadDocument: r, replace: s, state: l, target: u, to: c, preventScrollReset: f, viewTransition: d, ...m }, y) {
    let { basename: T } = D.useContext(ii), b = typeof c == "string" && RS.test(c), x, v = false;
    if (typeof c == "string" && b && (x = c, DS)) try {
      ...
      In(false, `<Link to="${c}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`);
    }
    let g = LM(c, {
      relative: a
    }), [S, A, w] = pC(i, m), V = AC(c, {
  ...
  OS.displayName = "Link";
  var SC = D.forwardRef(function({ "aria-current": e = "page", caseSensitive: n = false, className: i = "", end: a = false, style: r, to: s, viewTransition: l, children: u, ...c }, f) {
    let d = _o(s, {
      relative: c.relative
    }), m = cr(), y = D.useContext(Pc), { navigator: T, basename: b } = D.useContext(ii), x = y != null && DC(d) && l === true, v = T.encodeLocation ? T.encodeLocation(d).pathname : d.pathname, g = m.pathname, S = y && y.navigation && y.navigation.location ? y.navigation.location.pathname : null;
  ...
  var TC = D.forwardRef(({ discover: t = "render", fetcherKey: e, navigate: n, reloadDocument: i, replace: a, state: r, method: s = xu, action: l, onSubmit: u, relative: c, preventScrollReset: f, viewTransition: d, ...m }, y) => {
    let T = MC(), b = CC(l, {
      relative: c
    }), x = s.toLowerCase() === "get" ? "get" : "post", v = typeof l == "string" && RS.test(l), g = (S) => {
  ...
  function AC(t, { target: e, replace: n, state: i, preventScrollReset: a, relative: r, viewTransition: s } = {}) {
    let l = cp(), u = cr(), c = _o(t, {
      relative: r
    });
    return D.useCallback((f) => {
      if (nC(f, e)) {
        f.preventDefault();
        let d = n !== void 0 ? n : Xl(u) === Xl(c);
        l(t, {
          replace: d,
          state: i,
  ...
  function MC() {
    let { router: t } = zS("useSubmit"), { basename: e } = D.useContext(ii), n = FM();
    return D.useCallback(async (i, a = {}) => {
      let { action: r, method: s, encType: l, formData: u, body: c } = rC(i, e);
      if (a.navigate === false) {
  ...
  function CC(t, { relative: e } = {}) {
    ...
    if (t == null) {
      r.search = s.search;
      let l = new URLSearchParams(r.search), u = l.getAll("index");
      if (u.some((f) => f === "")) {
        l.delete("index"), u.filter((d) => d).forEach((d) => l.append("index", d));
        let f = l.toString();
        r.search = f ? `?${f}` : "";
      }
    }
  ...
  const zn = (t) => t, zC = (t, e) => (n) => e(t(n)), bo = (...t) => t.reduce(zC), kl = (t, e, n) => {
    const i = e - t;
    return i === 0 ? 1 : (n - t) / i;
  };
  class Sp {
  ...
  const HS = (t) => (e) => e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2, YS = (t) => (e) => 1 - t(1 - e), GS = So(0.33, 1.53, 0.69, 0.99), Tp = YS(GS), PS = HS(Tp), XS = (t) => (t *= 2) < 1 ? 0.5 * Tp(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1))), xp = (t) => 1 - Math.sin(Math.acos(t)), kS = YS(xp), qS = HS(xp), NC = So(0.42, 0, 1, 1), jC = So(0, 0, 0.58, 1), FS = So(0.42, 0, 0.58, 1), BC = (t) => Array.isArray(t) && typeof t[0] != "number", KS = (t) => Array.isArray(t) && typeof t[0] == "number", HC = {
    linear: zn,
    easeIn: NC,
    easeInOut: FS,
    easeOut: jC,
    ...
    const c = {
      ...
      process: (f) => {
        ...
        a = true, [n, i] = [
          i,
          n
        ], n.forEach(u), n.clear(), a = false, r && (r = false, c.process(f));
      }
    };
    return c;
  }
  ...
  function QS(t, e) {
    ...
    const a = {
      ...
      timestamp: 0,
      isProcessing: false
    }, r = () => n = true, s = eu.reduce((S, A) => (S[A] = GC(r), S), {}), { setup: l, read: u, resolveKeyframes: c, preUpdate: f, update: d, preRender: m, render: y, postRender: T } = s, b = () => {
      const S = Di.useManualTiming ? a.timestamp : performance.now();
      n = false, Di.useManualTiming || (a.delta = i ? 1e3 / 60 : Math.max(Math.min(S - a.timestamp, PC), 1)), a.timestamp = S, a.isProcessing = true, l.process(a), u.process(a), c.process(a), f.process(a), d.process(a), m.process(a), y.process(a), T.process(a), a.isProcessing = false, n && e && (i = false, t(b));
    }, x = () => {
  ...
  const Pe = {
    ...
    set: (t) => {
      Eu = t, queueMicrotask(XC);
    }
  }, ZS = (t) => (e) => typeof e == "string" && e.startsWith(t), Ap = ZS("--"), kC = ZS("var(--"), Ep = (t) => kC(t) ? qC.test(t.split("/*")[0].trim()) : false, qC = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu, Ms = {
  ...
  const KC = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, Mp = (t, e) => (n) => !!(typeof n == "string" && KC.test(n) && n.startsWith(t) || e && !FC(n) && Object.prototype.hasOwnProperty.call(n, e)), JS = (t, e, n) => (i) => {
    ...
    transform: ({ red: t, green: e, blue: n, alpha: i = 1 }) => "rgba(" + rh.transform(t) + ", " + rh.transform(e) + ", " + rh.transform(n) + ", " + vl(ql.transform(i)) + ")"
  };
  function ZC(t) {
    let e = "", n = "", i = "", a = "";
  ...
  const wd = {
    ...
    parse: parseFloat,
    transform: (e) => `${e}${t}`
  }), ji = To("deg"), Wn = To("%"), tt = To("px"), JC = To("vh"), $C = To("vw"), Ug = {
    ...Wn,
    parse: (t) => Wn.parse(t) / 100,
    transform: (t) => Wn.transform(t * 100)
  }, Ur = {
    test: Mp("hsl", "hue"),
    parse: JS("hue", "saturation", "lightness"),
    transform: ({ hue: t, saturation: e, lightness: n, alpha: i = 1 }) => "hsla(" + Math.round(t) + ", " + Wn.transform(vl(e)) + ", " + Wn.transform(vl(n)) + ", " + vl(ql.transform(i)) + ")"
  }, ne = {
    test: (t) => Ba.test(t) || wd.test(t) || Ur.test(t),
    parse: (t) => Ba.test(t) ? Ba.parse(t) : Ur.test(t) ? Ur.parse(t) : wd.parse(t),
    transform: (t) => typeof t == "string" ? t : t.hasOwnProperty("red") ? Ba.transform(t) : Ur.transform(t),
    getAnimatableNone: (t) => {
      const e = ne.parse(t);
  ...
  function Fl(t) {
    ...
    let r = 0;
    const l = e.replace(nD, (u) => (ne.test(u) ? (i.color.push(r), a.push(WS), n.push(ne.parse(u))) : u.startsWith(eD) ? (i.var.push(r), a.push(tD), n.push(u)) : (i.number.push(r), a.push($S), n.push(parseFloat(u))), ++r, Vg)).split(Vg);
    return {
      values: n,
      split: l,
      indexes: i,
  ...
  function tT(t) {
    const { split: e, types: n } = Fl(t), i = e.length;
    return (a) => {
      let r = "";
  ...
  function rD({ hue: t, saturation: e, lightness: n, alpha: i }) {
    ...
    if (!e) a = r = s = n;
      ...
      a = sh(u, l, t + 1 / 3), r = sh(u, l, t), s = sh(u, l, t - 1 / 3);
    }
    return {
  ...
  const hD = (t, e) => {
    const n = pa.createTransformer(e), i = Fl(t), a = Fl(e);
  ...
  function yD({ duration: t = kt.duration, bounce: e = kt.bounce, velocity: n = kt.velocity, mass: i = kt.mass }) {
    let a, r, s = 1 - e;
    s = Ci(kt.minDamping, kt.maxDamping, s), t = Ci(kt.minDuration, kt.maxDuration, wn(t)), s < 1 ? (a = (c) => {
    ...
    const l = 5 / t, u = vD(a, r, l);
    if (t = $n(t), isNaN(u)) return {
  ...
  function fc(t = kt.visualDuration, e = kt.bounce) {
    ...
    const r = n.keyframes[0], s = n.keyframes[n.keyframes.length - 1], l = {
      ...
      value: r
    }, { stiffness: u, damping: c, mass: f, duration: d, velocity: m, isResolvedFromDuration: y } = SD({
      ...n,
      velocity: -wn(n.velocity || 0)
    }), T = m || 0, b = c / (2 * Math.sqrt(u * f)), x = s - r, v = wn(Math.sqrt(u / f)), g = Math.abs(x) < 5;
    i || (i = g ? kt.restSpeed.granular : kt.restSpeed.default), a || (a = g ? kt.restDelta.granular : kt.restDelta.default);
    let S;
    if (b < 1) {
      const w = Cd(v, b);
      S = (V) => {
  ...
  function Dd({ keyframes: t, velocity: e = 0, power: n = 0.8, timeConstant: i = 325, bounceDamping: a = 10, bounceStiffness: r = 500, modifyTarget: s, min: l, max: u, restDelta: c = 0.5, restSpeed: f }) {
    const d = t[0], m = {
      done: false,
      value: d
    }, y = (O) => l !== void 0 && O < l || u !== void 0 && O > u, T = (O) => l === void 0 ? u : u === void 0 || Math.abs(l - O) < Math.abs(u - O) ? l : u;
    let b = n * e;
  ...
  function TD(t, e, n) {
    ...
    for (let s = 0; s < r; s++) {
      let l = a(t[s], t[s + 1]);
      if (e) {
        const u = Array.isArray(e) ? e[s] || zn : e;
        l = bo(u, l);
      }
      i.push(l);
    }
  ...
  function xD(t, e, { clamp: n = true, ease: i, mixer: a } = {}) {
    ...
    const l = TD(e, i, a), u = l.length, c = (f) => {
      if (s && f < t[0]) return e[0];
      let d = 0;
      if (u > 1) for (; d < t.length - 2 && !(f < t[d + 1]); d++) ;
      const m = kl(t[d], t[d + 1], f);
      return l[d](m);
    };
  ...
  function _l({ duration: t = 300, keyframes: e, times: n, ease: i = "easeInOut" }) {
    ...
    return {
      ...
      next: (u) => (r.value = l(u), r.done = u >= t, r)
    };
  }
  const CD = (t) => t !== null;
  ...
  class zp extends Op {
    ...
    initAnimation() {
      ...
      let { keyframes: l } = e;
      const u = n || _l;
      u !== _l && typeof l[0] != "number" && (this.mixKeyframes = bo(RD, nT(l[0], l[1])), l = [
        0,
        100
      ]);
      const c = u({
    ...
    tick(e, n = false) {
      const { generator: i, totalDuration: a, mixKeyframes: r, mirroredGenerator: s, resolvedDuration: l, calculatedDuration: u } = this;
      ...
      r && (w.value = r(w.value));
      let { done: V } = w;
      !g && u !== null && (V = this.playbackSpeed >= 0 ? this.currentTime >= a : this.currentTime <= 0);
    ...
    set time(e) {
      var _a2;
      e = $n(e), this.currentTime = e, this.startTime === null || this.holdTime !== null || this.playbackSpeed === 0 ? this.holdTime = e : this.driver && (this.startTime = this.driver.now() - e / this.playbackSpeed), (_a2 = this.driver) == null ? void 0 : _a2.start(false);
    }
    get speed() {
  ...
  const PD = bp(() => window.ScrollTimeline !== void 0), XD = {};
  function kD(t, e) {
    const n = bp(t);
    return () => XD[e] ?? n();
  }
  ...
  function qD(t, e, n, { delay: i = 0, duration: a = 300, repeat: r = 0, repeatType: s = "loop", ease: l = "easeOut", times: u } = {}, c = void 0) {
    const f = {
      [e]: n
    };
    u && (f.offset = u);
  ...
  class KD extends Op {
    constructor(e) {
      ...
      const { element: n, name: i, keyframes: a, pseudoElement: r, allowFlatten: s = false, finalKeyframe: l, onComplete: u } = e;
      this.isPseudoElement = !!r, this.allowFlatten = s, this.options = e, _p(typeof e.type != "string");
      const c = FD(e);
      this.animation = qD(n, i, a, c, r), c.autoplay === false && this.animation.pause(), this.animation.onfinish = () => {
    ...
    set time(e) {
      this.finishedTime = null, this.animation.currentTime = $n(e);
    }
    get speed() {
  ...
  class JD extends KD {
    ...
    updateMotionValue(e) {
      ...
      const l = new zp({
        ...s,
        autoplay: false
      }), u = $n(this.finishedTime ?? this.time);
      n.setWithVelocity(l.sample(u - Xg).value, l.sample(u).value, Xg), l.stop();
    }
  }
  const kg = (t, e) => e === "zIndex" ? false : !!(typeof t == "number" || Array.isArray(t) || typeof t == "string" && (pa.test(t) || t === "0") && !t.startsWith("url("));
  function $D(t) {
    const e = t[0];
  ...
  function WD(t, e, n, i) {
    ...
    const r = t[t.length - 1], s = kg(a, e), l = kg(r, e);
  ...
  function eR(t) {
    ...
    return tR() && n && ID.has(n) && (n !== "transform" || !c) && !u && !i && a !== "mirror" && r !== 0 && s !== "inertia";
  }
  const nR = 40;
  class iR extends Op {
    constructor({ autoplay: e = true, delay: n = 0, type: i = "keyframes", repeat: a = 0, repeatDelay: r = 0, repeatType: s = "loop", keyframes: l, name: u, motionValue: c, element: f, ...d }) {
      var _a2;
      super(), this.stop = () => {
        var _a3, _b2;
      ...
      this.keyframeResolver = new y(l, (T, b, x) => this.onKeyframesResolved(T, b, m, !x), u, c, f), (_a2 = this.keyframeResolver) == null ? void 0 : _a2.scheduleResolve();
    }
    onKeyframesResolved(e, n, i, a) {
      this.keyframeResolver = void 0;
      const { name: r, type: s, velocity: l, delay: u, isHandoff: c, onUpdate: f } = i;
      this.resolvedAt = Pe.now(), WD(e, r, s, l) || ((Di.instantAnimations || !u) && (f == null ? void 0 : f(Rp(e, i, n))), e[0] = e[e.length - 1], jd(i), i.repeat = 0);
      const m = {
  ...
  function mR(t, e, n) {
    ...
    for (; i < t.length && !a; ) {
      const r = t[i];
      typeof r == "string" && !dR.has(r) && Fl(r).values.length && (a = t[i]), i++;
    }
  ...
  class pR extends Up {
    ...
    readKeyframes() {
      ...
      for (let u = 0; u < e.length; u++) {
        ...
        if (typeof c == "string" && (c = c.trim(), Ep(c))) {
          ...
          f !== void 0 && (e[u] = f), u === e.length - 1 && (this.finalKeyframe = c);
        }
      }
      if (this.resolveNoneKeyframes(), !dT.has(i) || e.length !== 2) return;
      const [a, r] = e, s = qg(a), l = qg(r);
      if (s !== l) if (Gg(s) && Gg(l)) for (let u = 0; u < e.length; u++) {
        const c = e[u];
        typeof c == "string" && (e[u] = parseFloat(c));
      }
      else Fa[i] && (this.needsMeasurement = true);
    }
    ...
    measureInitialState() {
      ...
      i === "height" && (this.suspendedScrollY = window.pageYOffset), this.measuredOrigin = Fa[i](e.measureViewportBox(), window.getComputedStyle(e.current)), n[0] = this.measuredOrigin;
    ...
    measureEndState() {
      ...
      i[r] = Fa[n](e.measureViewportBox(), window.getComputedStyle(e.current)), s !== null && this.finalKeyframe === void 0 && (this.finalKeyframe = s), ((_a2 = this.removedTransforms) == null ? void 0 : _a2.length) && this.removedTransforms.forEach(([l, u]) => {
        e.getValue(l).set(u);
  ...
  function SR(t, e, n = {}) {
    const [i, a, r] = bT(t, n), s = (l) => {
      if (!Qg(l)) return;
      const { target: u } = l, c = e(u, l);
      if (typeof c != "function" || !u) return;
      const f = (d) => {
        Qg(d) && (c(d), u.removeEventListener("pointerleave", f));
      };
      u.addEventListener("pointerleave", f, a);
    };
    return i.forEach((l) => {
  ...
  function ER(t, e, n = {}) {
    const [i, a, r] = bT(t, n), s = (l) => {
      ...
      wu.add(u);
      const c = e(u, l), f = (y, T) => {
        window.removeEventListener("pointerup", d), window.removeEventListener("pointercancel", m), wu.has(u) && wu.delete(u), Jg(y) && typeof c == "function" && c(y, {
          success: T
        });
      }, d = (y) => {
        f(y, u === window || u === document || n.useGlobalTarget || ST(u, y.target));
      }, m = (y) => {
        f(y, false);
      };
  ...
  function Fc(t) {
    return qc(t.animate) || Hp.some((e) => Kl(t[e]));
  }
  function wT(t) {
    return !!(Fc(t) || t.variants);
  }
  function VR(t, e) {
    if (Fc(t)) {
  ...
  function LR(t) {
    const { initial: e, animate: n } = VR(t, D.useContext(kc));
    return D.useMemo(() => ({
      initial: e,
      animate: n
    }), [
  ...
  function HR(t, e, n) {
    ...
    for (let r = 0; r < BR; r++) {
      ...
      let u = true;
      if (typeof l == "number" ? u = l === (s.startsWith("scale") ? 1 : 0) : u = parseFloat(l) === 0, !u || n) {
        const c = vT(l, Lp[s]);
        if (!u) {
          a = false;
          const f = jR[s] || s;
  ...
  function Yp(t, e, n) {
    ...
    for (const u in e) {
      ...
      if (Ds.has(u)) {
        ...
        const f = vT(c, Lp[u]);
        u.startsWith("origin") ? (l = true, r[u] = f) : i[u] = f;
      }
    }
    if (e.transform || (s || n ? i.transform = HR(e, t.transform, n) : i.transform && (i.transform = "none")), l) {
      const { originX: u = "50%", originY: c = "50%", originZ: f = 0 } = r;
      i.transformOrigin = `${u} ${c} ${f}`;
    }
  }
  const Gp = () => ({
    style: {},
  ...
  function qR(t, e, n = 1, i = 0, a = true) {
    t.pathLength = 1;
    const r = a ? XR : kR;
  ...
  function DT(t, { attrX: e, attrY: n, attrScale: i, pathLength: a, pathSpacing: r = 1, pathOffset: s = 0, ...l }, u, c, f) {
    if (Yp(t, l, c), u) {
  ...
  function QR(t, e, n, { latestValues: i }, a, r = false) {
    const l = (Pp(t) ? FR : PR)(e, i, a, t), u = UR(e, typeof t == "string", r), c = t !== D.Fragment ? {
      ...u,
      ...l,
      ref: n
  ...
  function JR(t, e, n, i) {
    ...
    const u = Fc(t), c = wT(t);
    e && c && !u && t.inherit !== false && (s === void 0 && (s = e.initial), l === void 0 && (l = e.animate));
    let f = n ? n.initial === false : false;
    f = f || s === false;
    const d = f ? l : s;
    if (d && typeof d != "boolean" && !qc(d)) {
  ...
  const zT = (t) => (e, n) => {
    const i = D.useContext(kc), a = D.useContext(yp), r = () => ZR(t, e, i, a);
    return n ? r() : RC(r);
  };
  function kp(t, e, n) {
    var _a2;
  ...
  function tO(t, e, n) {
    return D.useCallback((i) => {
      i && t.onMount && t.onMount(i), e && (i ? e.mount(i) : e.unmount()), n && (typeof n == "function" ? n(i) : Vr(n) && (n.current = i));
    }, [
      e
    ]);
  }
  const qp = (t) => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(), eO = "framerAppearId", VT = "data-" + qp(eO), LT = D.createContext({});
  function nO(t, e, n, i, a) {
    var _a2, _b2;
    const { visualElement: r } = D.useContext(kc), s = D.useContext(AT), l = D.useContext(yp), u = D.useContext(xT).reducedMotion, c = D.useRef(null);
  ...
  function iO(t, e, n, i) {
    const { layoutId: a, layout: r, drag: s, dragConstraints: l, layoutScroll: u, layoutRoot: c, layoutCrossfade: f } = e;
    ...
    function r(l, u) {
      ...
      return J.jsxs(kc.Provider, {
        ...
        children: [
          ...
          QR(t, l, tO(y, m.visualElement, u), y, d, e)
        ]
      });
    }
  ...
  function cO(t, e, n, i = false) {
    ...
    for (let l = 0; l < a; l++) {
      ...
      u && u.props.style && u.props.style.display === "contents" || (i && r.options.layoutScroll && r.scroll && r !== r.root && Nr(t, {
        x: -r.scroll.offset.x,
        y: -r.scroll.offset.y
      }), s && (e.x *= s.x.scale, e.y *= s.y.scale, HT(t, s)), i && Na(r.latestValues) && Nr(t, r.latestValues));
    }
  ...
  function fO(t, e, n) {
    ...
    return a && (Lr(i.x, a.offset.x), Lr(i.y, a.offset.y)), i;
  }
  const rv = () => ({
    translate: 0,
    scale: 1,
  ...
  function mO(t, e, n) {
    for (const i in e) {
      ...
      else if (Ce(r)) t.addValue(i, os(a, {
        owner: t
      }));
  ...
  class pO {
    ...
    constructor({ parent: e, props: n, presenceContext: i, reducedMotionConfig: a, blockInitialAnimation: r, visualState: s }, l = {}) {
      ...
      this.latestValues = u, this.baseTarget = {
        ...
        ...u
      } : {}, this.renderState = c, this.parent = e, this.props = n, this.presenceContext = i, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = a, this.options = l, this.blockInitialAnimation = !!r, this.isControllingVariants = Fc(n), this.isVariantNode = wT(n), this.isVariantNode && (this.variantChildren = /* @__PURE__ */ new Set()), this.manuallyAnimateOnMount = !!(e && e.current);
      const { willChange: f, ...d } = this.scrapeMotionValuesFromProps(n, {}, this);
      for (const m in d) {
        const y = d[m];
        u[m] !== void 0 && Ce(y) && y.set(u[m]);
      }
    }
    mount(e) {
      var _a2;
    ...
    getValue(e, n) {
      ...
      return i === void 0 && n !== void 0 && (i = os(n === null ? void 0 : n, {
        owner: this
      }), this.addValue(e, i)), i;
    }
    readValue(e, n) {
    ...
    getBaseTarget(e) {
      ...
      if (typeof n == "string" || typeof n == "object") {
        const r = Xp(this.props, n, (_a2 = this.presenceContext) == null ? void 0 : _a2.custom);
        r && (i = r[e]);
      }
  ...
  function XT(t, { style: e, vars: n }, i, a) {
    const r = t.style;
    let s;
    for (s in e) r[s] = e[s];
  ...
  class gO extends PT {
    constructor() {
      super(...arguments), this.type = "html", this.renderInstance = XT;
    }
  ...
  function vO(t, e, n, i) {
    XT(t, e, void 0, i);
    for (const a in e.attrs) t.setAttribute(kT.has(a) ? a : qp(a), e.attrs[a]);
  }
  class _O extends PT {
    constructor() {
    ...
    readValueFromInstance(e, n) {
      ...
      return n = kT.has(n) ? n : qp(n), e.getAttribute(n);
    }
    scrapeMotionValuesFromProps(e, n, i) {
      return UT(e, n, i);
    }
  ...
  function Kr(t, e, n) {
    const i = t.getProps();
    return Xp(i, e, n !== void 0 ? n : i.custom, t);
  }
  const Pd = (t) => Array.isArray(t);
  function SO(t, e, n) {
    t.hasValue(e) ? t.getValue(e).set(n) : t.addValue(e, os(n));
  }
  function TO(t) {
  ...
  function zO({ when: t, delay: e, delayChildren: n, staggerChildren: i, staggerDirection: a, repeat: r, repeatType: s, repeatDelay: l, from: u, elapsed: c, ...f }) {
    return !!Object.keys(f).length;
  }
  const Fp = (t, e, n, i = {}, a, r) => (s) => {
    const l = Vp(i, t) || {}, u = l.delay || i.delay || 0;
    let { elapsed: c = 0 } = i;
    c = c - $n(u);
    const f = {
    ...
    zO(l) || Object.assign(f, OO(t, f)), f.duration && (f.duration = $n(f.duration)), f.repeatDelay && (f.repeatDelay = $n(f.repeatDelay)), f.from !== void 0 && (f.keyframes[0] = f.from);
    let d = false;
  ...
  function FT(t, e, { delay: n = 0, transitionOverride: i, type: a } = {}) {
    let { transition: r = t.getDefaultTransition(), transitionEnd: s, ...l } = e;
    i && (r = i);
    const u = [], c = a && t.animationState && t.animationState.getState()[a];
    for (const f in l) {
      ...
      Xd(t, f), d.start(Fp(f, d, m, t.shouldReduceMotion && dT.has(f) ? {
        type: false
      } : y, t, b));
      const x = d.animation;
      x && u.push(x);
  ...
  function kd(t, e, n = {}) {
    var _a2;
    const i = Kr(t, e, n.type === "exit" ? (_a2 = t.presenceContext) == null ? void 0 : _a2.custom : void 0);
    let { transition: a = t.getDefaultTransition() || {} } = i || {};
    n.transitionOverride && (a = n.transitionOverride);
    const r = i ? () => Promise.all(FT(t, i, n)) : () => Promise.resolve(), s = t.variantChildren && t.variantChildren.size ? (u = 0) => {
      const { delayChildren: c = 0, staggerChildren: f, staggerDirection: d } = a;
      return VO(t, e, u, c, f, d, n);
  ...
  function VO(t, e, n = 0, i = 0, a = 0, r = 1, s) {
    const l = [];
    for (const u of t.variantChildren) u.notify("AnimationStart", e), l.push(kd(u, e, {
      ...s,
      delay: n + (typeof i == "function" ? 0 : i) + KT(t.variantChildren, u, i, a, r)
  ...
  function LO(t, e, n = {}) {
    ...
    let i;
    if (Array.isArray(e)) {
      const a = e.map((r) => kd(t, r, n));
      i = Promise.all(a);
    } else if (typeof e == "string") i = kd(t, e, n);
    else {
      const a = typeof e == "function" ? Kr(t, e, n.custom) : e;
      i = Promise.all(FT(t, a, n));
    }
    return i.then(() => {
  ...
  function YO(t) {
    ...
    const a = (u) => (c, f) => {
      var _a2;
      const d = Kr(t, f, u === "exit" ? (_a2 = t.presenceContext) == null ? void 0 : _a2.custom : void 0);
      if (d) {
    ...
    function s(u) {
      ...
      let y = {}, T = 1 / 0;
      for (let x = 0; x < BO; x++) {
        const v = jO[x], g = n[v], S = c[v] !== void 0 ? c[v] : f[v], A = Kl(S), w = v === u ? g.isActive : null;
        w === false && (T = x);
        let V = S === f[v] && S !== c[v] && A;
        if (V && i && t.manuallyAnimateOnMount && (V = false), g.protectedKeys = {
          ...y
        }, !g.isActive && w === null || !S && !g.prevProp || qc(S) || typeof S == "boolean") continue;
        const z = GO(g.prevProp, S);
        let O = z || v === u && g.isActive && !V && A || x > T && A, U = false;
        const B = Array.isArray(S) ? S : [
          S
        ];
        let Y = B.reduce(a(v), {});
        w === false && (Y = {});
        const { prevResolvedValues: F = {} } = g, X = {
          ...F,
          ...Y
        }, $ = (P) => {
      ...
      if (m.size) {
        ...
        if (typeof c.initial != "boolean") {
          const v = Kr(t, Array.isArray(c.initial) ? c.initial[0] : c.initial);
    ...
    function l(u, c) {
      ...
      (_a2 = t.variantChildren) == null ? void 0 : _a2.forEach((d) => {
        var _a3;
        return (_a3 = d.animationState) == null ? void 0 : _a3.setActive(u, c);
      }), n[u].isActive = c;
      const f = s(u);
  ...
  class PO extends ba {
    ...
    updateAnimationControlsSubscription() {
      ...
      qc(e) && (this.unmountControls = e.subscribe(this.node));
    }
    mount() {
  ...
  const FO = (t) => (e) => jp(e) && t(e, xo(e));
  function bl(t, e, n, i) {
    return Zl(t, e, FO(n), i);
  }
  ...
  class IT {
    constructor(e, n, { transformPagePoint: i, contextWindow: a = window, dragSnapToOrigin: r = false, distanceThreshold: s = 3 } = {}) {
      ...
      const l = xo(e), u = hh(l, this.transformPagePoint), { point: c } = u, { timestamp: f } = ve;
      this.history = [
        {
          ...c,
          timestamp: f
      ...
      d && d(e, dh(u, this.history)), this.removeListeners = bo(bl(this.contextWindow, "pointermove", this.handlePointerMove), bl(this.contextWindow, "pointerup", this.handlePointerUp), bl(this.contextWindow, "pointercancel", this.handlePointerUp));
    }
    updateHandlers(e) {
      this.handlers = e;
    }
  ...
  function e3(t, e) {
    ...
    const a = tx(t);
    for (; n >= 0 && (i = t[n], !(a.timestamp - i.timestamp > $n(e))); ) n--;
    if (!i) return {
      x: 0,
      y: 0
    };
  ...
  function r3(t, e) {
    let n = 0.5;
    const i = Ve(t), a = Ve(e);
    return a > i ? n = kl(e.min, e.max - i, t.min) : i > a && (n = kl(t.min, t.max - a, e.min)), Ci(0, 1, n);
  }
  function s3(t, e) {
    const n = {};
  ...
  const qd = 0.35;
  function l3(t = qd) {
    return t === false ? t = 0 : t === true && (t = qd), {
      x: yv(t, "left", "right"),
      y: yv(t, "top", "bottom")
    };
  }
  ...
  class u3 {
    ...
    start(e, { snapToCursor: n = false, distanceThreshold: i } = {}) {
      ...
      const r = (d) => {
        ...
        }), b && Lt.postRender(() => b(d, m)), Xd(this.visualElement, "transform");
    ...
    resolveConstraints() {
      ...
      e && Vr(e) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : e && i ? this.constraints = i3(i.layoutBox, e) : this.constraints = false, this.elastic = l3(n), a !== this.constraints && i && this.constraints && !this.hasMutatedConstraints && gn((r) => {
        this.constraints !== false && this.getAxisMotionValue(r) && (this.constraints[r] = s3(i.layoutBox[r], this.constraints[r]));
      });
    }
    resolveRefConstraints() {
      const { dragConstraints: e, onMeasureDragConstraints: n } = this.getProps();
      if (!e || !Vr(e)) return false;
    ...
    startAnimation(e) {
      const { drag: n, dragMomentum: i, dragElastic: a, dragTransition: r, dragSnapToOrigin: s, onDragTransitionEnd: l } = this.getProps(), u = this.constraints || {}, c = gn((f) => {
    ...
    startAxisValueAnimation(e, n) {
      ...
      return Xd(this.visualElement, e), i.start(Fp(e, i, 0, n, this.visualElement, false));
    }
    stopAnimation() {
    ...
    scalePositionWithinConstraints() {
      ...
      if (!Vr(n) || !i || !this.constraints) return;
      this.stopAnimation();
      const a = {
        x: 0,
        y: 0
    ...
    addListeners() {
      ...
      const e = this.visualElement.current, n = bl(e, "pointerdown", (u) => {
        const { drag: c, dragListener: f = true } = this.getProps();
        c && f && this.start(u);
      }), i = () => {
        const { dragConstraints: u } = this.getProps();
        Vr(u) && u.current && (this.constraints = this.resolveRefConstraints());
      ...
      const s = Zl(window, "resize", () => this.scalePositionWithinConstraints()), l = a.addEventListener("didUpdate", ({ delta: u, hasLayoutChanged: c }) => {
    ...
    getProps() {
      const e = this.visualElement.getProps(), { drag: n = false, dragDirectionLock: i = false, dragPropagation: a = false, dragConstraints: r = false, dragElastic: s = qd, dragMomentum: l = true } = e;
      return {
        ...e,
        drag: n,
        dragDirectionLock: i,
  ...
  const Qs = {
    ...
    correct: (t, { treeScale: e, projectionDelta: n }) => {
      ...
      const r = pa.createTransformer(t), s = typeof a[0] != "number" ? 1 : 0, l = n.x.scale * e.x, u = n.y.scale * e.y;
      a[0 + s] /= l, a[1 + s] /= u;
      const c = Ht(l, u, 0.5);
  ...
  function y3(t, e, n) {
    const i = Ce(t) ? t : os(t);
    return i.start(Fp("", i, e, n)), i.animation;
  }
  ...
  function S3(t, e, n, i, a, r) {
    ...
    for (let s = 0; s < b3; s++) {
      ...
      let u = Tv(e, l), c = Tv(n, l);
      if (u === void 0 && c === void 0) continue;
      u || (u = 0), c || (c = 0), u === 0 || c === 0 || Sv(u) === Sv(c) ? (t[l] = Math.max(Ht(bv(u), bv(c), i), 0), (Wn.test(c) || Wn.test(u)) && (t[l] += "%")) : t[l] = c;
    }
  ...
  const T3 = ix(0, 0.5, kS), x3 = ix(0.5, 0.95, zn);
  function ix(t, e, n) {
    return (i) => i < t ? 0 : i > e ? 1 : n(kl(t, e, i));
  }
  function xv(t, e) {
  ...
  function A3(t, e = 0, n = 1, i = 0.5, a, r = t, s = t) {
    if (Wn.test(e) && (e = parseFloat(e), e = Ht(s.min, s.max, e / 100) - s.min), typeof e != "number") return;
  ...
  function D3(t, e, n) {
    ...
    const l = t.x.scale * e.x, u = t.y.scale * e.y;
  ...
  function lx({ attachResizeListener: t, defaultParent: e, measureScroll: n, checkIsScrollRoot: i, resetTransform: a }) {
    return class {
      ...
      mount(s) {
        ...
        if (c && !c.current && c.mount(s), this.root.nodes.add(this), this.parent && this.parent.children.add(this), this.root.hasTreeAnimated && (u || l) && (this.isLayoutDirty = true), t) {
          let f, d = 0;
        ...
        l && this.root.registerSharedNode(l, this), this.options.animate !== false && c && (l || u) && this.addEventListener("didUpdate", ({ delta: f, hasLayoutChanged: d, hasRelativeLayoutChanged: m, layout: y }) => {
          if (this.isTreeAnimationBlocked()) {
            this.target = void 0, this.relativeTarget = void 0;
            return;
          }
          const T = this.options.transition || c.getDefaultTransition() || k3, { onLayoutAnimationStart: b, onLayoutAnimationComplete: x } = c.getProps(), v = !this.targetLayout || !rx(this.targetLayout, y), g = !d && m;
      ...
      resetTransform() {
        if (!a) return;
        const s = this.isLayoutDirty || this.shouldResetTransform || this.options.alwaysMeasureLayout, l = this.projectionDelta && !ax(this.projectionDelta), u = this.getTransformTemplate(), c = u ? u(this.latestValues, "") : void 0, f = c !== this.prevTransformTemplateValue;
      ...
      measure(s = true) {
        ...
        return s && (u = this.removeTransform(u)), q3(u), {
          animationId: this.root.animationId,
          measuredBox: l,
          layoutBox: u,
          latestValues: {},
      ...
      measurePageBox() {
        ...
        if (!(((_a2 = this.scroll) == null ? void 0 : _a2.wasRoot) || this.path.some(F3))) {
      ...
      removeElementScroll(s) {
        ...
        for (let u = 0; u < this.path.length; u++) {
          ...
          c !== this.root && f && d.layoutScroll && (f.wasRoot && yn(l, s), Lr(l.x, f.offset.x), Lr(l.y, f.offset.y));
        }
        return l;
      }
      applyTransform(s, l = false) {
        ...
        for (let c = 0; c < this.path.length; c++) {
          const f = this.path[c];
          !l && f.options.layoutScroll && f.scroll && f !== f.root && Nr(u, {
            x: -f.scroll.offset.x,
            y: -f.scroll.offset.y
          }), Na(f.latestValues) && Nr(u, f.latestValues);
        }
        return Na(this.latestValues) && Nr(u, this.latestValues), u;
      }
      removeTransform(s) {
        const l = Jt();
        yn(l, s);
      ...
      resolveTargetDelta(s = false) {
        ...
        if (!(s || u && this.isSharedProjectionDirty || this.isProjectionDirty || ((_a2 = this.parent) == null ? void 0 : _a2.isProjectionDirty) || this.attemptToResolveRelativeTarget || this.root.updateBlockedByResize)) return;
      ...
      calcProjection() {
        ...
        let u = true;
        if ((this.isProjectionDirty || ((_a2 = this.parent) == null ? void 0 : _a2.isProjectionDirty)) && (u = false), l && (this.isSharedProjectionDirty || this.isTransformDirty) && (u = false), this.resolvedRelativeTargetAt === ve.timestamp && (u = false), u) return;
      ...
      createProjectionDeltas() {
        this.prevProjectionDelta = jr(), this.projectionDelta = jr(), this.projectionDeltaWithTransform = jr();
      }
      setAnimationOrigin(s, l = false) {
        const u = this.snapshot, c = u ? u.latestValues : {}, f = {
          ...this.latestValues
        }, d = jr();
        (!this.relativeParent || !this.relativeParent.options.layoutRoot) && (this.relativeTarget = this.relativeTargetOrigin = void 0), this.attemptToResolveRelativeTarget = !l;
        const m = Jt(), y = u ? u.source : void 0, T = this.layout ? this.layout.source : void 0, b = y !== T, x = this.getStack(), v = !x || x.members.length <= 1, g = !!(b && !v && this.options.crossfade === true && !this.path.some(X3));
      ...
      startAnimation(s) {
        ...
        this.notifyListeners("animationStart"), (_a2 = this.currentAnimation) == null ? void 0 : _a2.stop(), (_c2 = (_b2 = this.resumingFrom) == null ? void 0 : _b2.currentAnimation) == null ? void 0 : _c2.stop(), this.pendingAnimation && (ma(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = Lt.update(() => {
          Cu.hasAnimatedSinceResize = true, this.motionValue || (this.motionValue = os(0)), this.currentAnimation = y3(this.motionValue, [
            0,
            1e3
          ], {
            ...s,
      ...
      applyTransformsToTarget() {
        ...
        let { targetWithTransforms: l, target: u, layout: c, latestValues: f } = s;
        if (!(!l || !u || !c)) {
          if (this !== s && this.layout && c && ox(this.options.animationType, this.layout.layoutBox, c.layoutBox)) {
            ...
            u.x.min = s.target.x.min, u.x.max = u.x.min + d;
            const m = Ve(this.layout.layoutBox.y);
            u.y.min = s.target.y.min, u.y.max = u.y.min + m;
          }
          yn(l, u), Nr(l, f), Sl(this.projectionDeltaWithTransform, this.layoutCorrected, l, f);
        }
      }
      ...
      promote({ needsReset: s, transition: l, preserveFollowOpacity: u } = {}) {
        ...
        c && c.promote(this, u), s && (this.projectionDelta = void 0, this.needsReset = true), l && this.setOptions({
          transition: l
        });
      }
      relegate() {
      ...
      resetSkewAndRotation() {
        ...
        if ((u.z || u.rotate || u.rotateX || u.rotateY || u.rotateZ || u.skewX || u.skewY) && (l = true), !l) return;
        const c = {};
        u.z && yh("z", s, c, this.animationValues);
      ...
      applyProjectionStyles(s, l) {
        ...
        if (this.needsReset) {
          this.needsReset = false, s.visibility = "", s.opacity = "", s.pointerEvents = Mu(l == null ? void 0 : l.pointerEvents) || "", s.transform = u ? u(this.latestValues, "") : "none";
          return;
        }
        const c = this.getLead();
        if (!this.projectionDelta || !this.layout || !c.target) {
          this.options.layoutId && (s.opacity = this.latestValues.opacity !== void 0 ? this.latestValues.opacity : 1, s.pointerEvents = Mu(l == null ? void 0 : l.pointerEvents) || ""), this.hasProjected && !Na(this.latestValues) && (s.transform = u ? u({}, "") : "none", this.hasProjected = false);
          return;
        }
        s.visibility = "";
  ...
  const Fd = /* @__PURE__ */ new WeakMap(), vh = /* @__PURE__ */ new WeakMap(), W3 = (t) => {
  ...
  function Xv({ text: t, speed: e = 50, maxIterations: n = 10, sequential: i = false, revealDirection: a = "start", useOriginalCharsOnly: r = false, characters: s = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz!@#$%^&*()_+", className: l = "", parentClassName: u = "", encryptedClassName: c = "", animateOn: f = "hover", ...d }) {
    ...
    D.useEffect(() => {
      ...
      const B = (X) => {
        ...
        switch (a) {
          ...
          case "end":
            return $ - 1 - X.size;
          case "center": {
            const K = Math.floor($ / 2), N = Math.floor(X.size / 2), P = X.size % 2 === 0 ? K + N : K - N - 1;
            if (P >= 0 && P < $ && !X.has(P)) return P;
            for (let G = 0; G < $; G++) if (!X.has(G)) return G;
            return 0;
          }
          default:
            return X.size;
        }
      }, Y = r ? Array.from(new Set(t.split(""))).filter((X) => X !== " ") : s.split(""), F = (X, $) => {
        if (r) {
          const K = X.split("").map((G, Q) => ({
            char: G,
            isSpace: G === " ",
            index: Q,
            isRevealed: $.has(Q)
          ...
          let P = 0;
          return K.map((G) => G.isSpace ? " " : G.isRevealed ? X[G.index] : N[P++]).join("");
        } else return X.split("").map((K, N) => K === " " ? " " : $.has(N) ? X[N] : Y[Math.floor(Math.random() * Y.length)]).join("");
      };
      return T ? (v(true), O = setInterval(() => {
        S((X) => {
          if (i) if (X.size < t.length) {
            const $ = B(X), K = new Set(X);
            return K.add($), y(F(t, K)), K;
          } else return clearInterval(O), v(false), X;
          else return y(F(t, X)), U++, U >= n && (clearInterval(O), v(false), y(t)), X;
        });
      ...
      const O = (F) => {
        F.forEach((X) => {
          X.isIntersecting && !A && (b(true), w(true));
        });
      }, U = {
        root: null,
        rootMargin: "0px",
    ...
    return J.jsxs(o4.span, {
      ref: V,
      className: `inline-block whitespace-pre-wrap ${u}`,
      ...z,
      ...d,
      children: [
        J.jsx("span", {
  ...
  const u4 = ({ marqueeText: t = "", speed: e = 2, className: n, curveAmount: i = 400, direction: a = "left", interactive: r = true, decryptSpeed: s = 50, maxIterations: l = 10, sequential: u = false, revealDirection: c = "start", useOriginalCharsOnly: f = false, characters: d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz!@#$%^&*()_+", animateOn: m = "view", encryptedClassName: y = "" }) => {
    const T = D.useMemo(() => (/\s|\u00A0$/.test(t) ? t.replace(/\s+$/, "") : t) + "\xA0", [
      t
    ]), b = D.useRef(null), x = D.useRef(null), v = D.useRef(null), g = D.useRef(null), [S, A] = D.useState(0), [w, V] = D.useState(0), O = `curve-${D.useId()}`, U = `M-100,40 Q500,${40 + i} 1540,40`, B = D.useRef(false), Y = D.useRef(0), F = D.useRef(a), X = D.useRef(0), [$, K] = D.useState(T), [N, P] = D.useState(false), [G, Q] = D.useState(false), [it, Pt] = D.useState(/* @__PURE__ */ new Set()), [Kt, te] = D.useState(false), Nt = S, pe = Nt ? Math.ceil(1800 / Nt) + 2 : 1, Ta = S > 0;
    D.useEffect(() => {
    ...
    const Jc = (wt) => {
      r && (B.current = true, Y.current = wt.clientX, X.current = 0, wt.target.setPointerCapture(wt.pointerId));
    }, Eo = (wt) => {
      if (!r || !B.current || !x.current) return;
      const ft = wt.clientX - Y.current;
      Y.current = wt.clientX, X.current = ft;
      ...
      r && (B.current = false, F.current = X.current > 0 ? "right" : "left");
          ...
          Ta && J.jsx("text", {
            ...
            children: J.jsx("textPath", {
              ...
              children: Array(pe).fill(null).map((wt, ft) => $.split("").map((Mt, Qt) => {
                ...
                return J.jsx("tspan", {
                  className: ee ? "fill-[#441212] opacity-50" : y || "fill-[#441212] opacity-50",
                  children: Mt
                }, `${ft}-${Qt}`);
              }))
            })
    ...
    return J.jsxs("div", {
      ...
      children: [
        J.jsxs("div", {
          ...
          children: [
            J.jsx("h1", {
              className: "text-5xl font-bold -translate-y-10 text-center",
              children: "Welcome to Deconstructivism"
            }),
            J.jsxs("div", {
              className: "mt-1 text-nowrap text-center",
              children: [
                J.jsx(Xv, {
            ...
            J.jsx("div", {
              className: "flex justify-center mt-10 translate-y-10",
        ...
        Array.from({
          ...
          style: {
            transform: `translateY(${-8 * i}rem)`,
            top: "50rem"
          },
          children: J.jsx(u4, {
            marqueeText: "\uD558\uC9C0\uB9CC \uC758\uBBF8\uB294 \uACB0\uCF54 \uB3C4\uB2EC\uB418\uC9C0 \uC54A\uACE0, \uB04A\uC784\uC5C6\uC774 Diff\xE9rance \uBBF8\uB044\uB7EC\uC9C4\uB2E4",
            animateOn: "always",
            speed: i % 5 === 0 ? 0.15 : -0.05,
            curveAmount: -100,
            revealDirection: i % 3 === 0 ? "start" : "end",
            sequential: true,
            useOriginalCharsOnly: true,
            decryptSpeed: 200 * (Math.floor(i / 5) + 1)
          })
        }))
      ]
    });
  ...
  var un = {
  ...
  }, De = Array.isArray, Qd = /(?:-?\.?\d|\.)+/gi, dx = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Br = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, _h = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, mx = /[+-]=-?[.\d]+/, px = /[^,'"\[\]\s]+/gi, p4 = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, Bt, kn, Zd, Jp, hn = {}, mc = {}, yx, gx = function(e) {
    return (mc = fs(e, hn)) && Ze;
  }, $p = function(e, n) {
    ...
    suppressEvents: true
  }, Wp = {}, oa = [], Jd = {}, _x, We = {}, bh = {}, kv = 30, Ru = [], Ip = "", ty = function(e) {
    var n = e[0], i, a;
    if (ti(n) || Ft(n) || (e = [
      e
    ]), !(i = (n._gsap || {}).harness)) {
    ...
    for (a = e.length; a--; ) e[a] && (e[a]._gsap || (e[a]._gsap = new Xx(e[a], i))) || e.splice(a, 1);
    return e;
  }, Qa = function(e) {
    return e._gsap || ty(Cn(e))[0]._gsap;
  }, bx = function(e, n, i) {
    return (i = e[n]) && Ft(i) ? e[n]() : Qp(i) && e.getAttribute && e.getAttribute(n) || i;
  }, qe = function(e, n) {
    ...
    if (ke(e.inherit)) for (; n; ) i(e, n.vars.defaults), n = n.parent || n._dp;
    return e;
  }, b4 = function(e, n) {
    ...
    var r = e.ratio, s = n < 0 || !n && (!e._start && x4(e) && !(!e._initted && Wd(e)) || (e._ts < 0 || e._dp._ts < 0) && !Wd(e)) ? 0 : 1, l = e._rDelay, u = 0, c, f, d;
    if (l && e._repeat && (u = Ao(0, e._tDur, n), f = hs(u, l), e._yoyo && f & 1 && (s = 1 - s), f !== hs(e._tTime, l) && (r = 1 - s, e.vars.repeatRefresh && e._initted && e.invalidate())), s !== r || Ae || a || e._zTime === Tt || !n && e._zTime) {
      if (!e._initted && Mx(e, n, a, i, u)) return;
      for (d = e._zTime, e._zTime = n || (i ? Tt : 0), i || (i = n && !d), e.ratio = s, e._from && (s = 1 - s), e._time = 0, e._tTime = u, c = e._pt; c; ) c.r(s, c.d), c = c._next;
      n < 0 && $d(e, n, i, true), e._onUpdate && !i && an(e, "onUpdate"), u && e._repeat && !i && e.parent && an(e, "onRepeat"), (n >= e._tDur || n < 0) && e.ratio === s && (s && ya(e, 1), !i && !Ae && (an(e, s ? "onComplete" : "onReverseComplete", true), e._prom && e._prom()));
    ...
    return e instanceof ze ? Za(e) : ds(e, e._dur);
  }, w4 = {
    _start: 0,
    endTime: $l,
    totalDuration: $l
  }, vn = function t(e, n, i) {
    var a = e.labels, r = e._recent || w4, s = e.duration() >= Mn ? r.endTime(false) : e._dur, l, u, c;
    return me(n) && (isNaN(n) || n in a) ? (u = n.charAt(0), c = n.substr(-1) === "%", l = n.indexOf("="), u === "<" || u === ">" ? (l >= 0 && (n = n.replace(/=/, "")), (u === "<" ? r._start : r.endTime(r._repeat >= 0)) + (parseFloat(n.substr(1)) || 0) * (c ? (l < 0 ? r : i).totalDuration() / 100 : 1)) : l < 0 ? (n in a || (a[n] = s), a[n]) : (u = parseFloat(n.charAt(l - 1) + n.substr(l + 1)), c && i && (u = u / 100 * (De(i) ? i[0] : i).totalDuration()), l > 1 ? t(e, n.substr(0, l - 1), i) + u : s + u)) : n == null ? s : +n;
  }, Al = function(e, n, i) {
    var a = Ri(n[1]), r = (a ? 2 : 1) + (e < 2 ? 0 : 1), s = n[r], l, u;
    if (a && (s.duration = n[1]), s.parent = i, e) {
      for (l = s, u = i; u && !("immediateRender" in l); ) l = u.vars.defaults || {}, u = ke(u.vars.inherit) && u.parent;
      s.immediateRender = ke(l.immediateRender), e < 2 ? s.runBackwards = 1 : s.startAt = n[r - 1];
    }
    ...
    return e && ti(e) && "length" in e && (!n && !e.length || e.length - 1 in e && ti(e[0])) && !e.nodeType && e !== kn;
  }, C4 = function(e, n, i) {
    ...
    return Vt && !n && Vt.selector ? Vt.selector(e) : me(e) && !i && (Zd || !ms()) ? Id.call((n || Jp).querySelectorAll(e), 0) : De(e) ? C4(e, i) : Cx(e) ? Id.call(e, 0) : e ? [
      e
    ] : [];
  }, tm = function(e) {
    ...
    var n = ti(e) ? e : {
      each: e
    }, i = Ja(n.ease), a = n.from || 0, r = parseFloat(n.base) || 0, s = {}, l = a > 0 && a < 1, u = isNaN(a) || l, c = n.axis, f = a, d = a;
    return me(a) ? f = d = {
      center: 0.5,
      edges: 0.5,
      end: 1
    }[a] || 0 : !l && u && (f = a[0], d = a[1]), function(m, y, T) {
      ...
      if (!x) {
        ...
        for (x = s[b] = [], v = u ? Math.min(U, b) * f - 0.5 : a % U, g = U === Mn ? 0 : u ? b * d / U - 0.5 : a / U | 0, z = 0, O = Mn, V = 0; V < b; V++) S = V % U - v, A = g - (V / U | 0), x[V] = w = c ? Math.abs(c === "y" ? A : S) : fx(S * S + A * A), w > z && (z = w), w < O && (O = w);
    ...
    var i = De(e), a, r;
    return !i && ti(e) && (a = i = e.radius || Mn, e.values ? (e = Cn(e.values), (r = !Ri(e[0])) && (a *= a)) : e = em(e.increment)), Sa(n, i ? Ft(e) ? function(s) {
      return r = e(s), Math.abs(r - s) <= a ? r : s;
    } : function(s) {
      for (var l = parseFloat(r ? s.x : s), u = parseFloat(r ? s.y : 0), c = Mn, f = 0, d = e.length, m, y; d--; ) r ? (m = e[d].x - l, y = e[d].y - u, m = m * m + y * y) : m = Math.abs(e[d] - l), m < c && (c = m, f = d);
    ...
    if (!r) {
      ...
      if (!f) {
        for (u in n) ny.call(l, e, u, "get", n[u]);
        r = function(T) {
    ...
    var a = e.labels, r = Mn, s, l, u;
    for (s in a) l = a[s] - n, l < 0 == !!i && l && r > (l = Math.abs(l)) && (u = s, r = l);
    return u;
  }, an = function(e, n, i) {
    var a = e.vars, r = a[n], s = Vt, l = e._ctx, u, c, f;
    if (r) return u = a[n + "Params"], c = a.callbackScope || e, i && oa.length && pc(), l && (Vt = l), f = u ? r.apply(c, u) : r.call(c), Vt = s, f;
  }, nl = function(e) {
    ...
    if (e) if (e = !e.name && e.default || e, Zp() || e.headless) {
      var n = e.name, i = Ft(e), a = n && !i && e.init ? function() {
        this._props = [];
      } : e, r = {
        init: $l,
        render: sy,
      ...
      if (ms(), e !== a) {
        if (We[n]) return;
        dn(a, dn(yc(e, r), s)), fs(a.prototype, fs(r, yc(e, s))), We[a.prop = n] = a, e.targetTest && (Ru.push(a), Wp[n] = 1), n = (n === "css" ? "CSS" : n.charAt(0).toUpperCase() + n.substr(1)) + "Plugin";
      }
      vx(n, a), e.register && e.register(Ze, a, Fe);
    } else Lx.push(e);
  }, St = 255, il = {
    aqua: [
      0,
    ...
    var a = e ? Ri(e) ? [
      ...
      e >> 8 & St,
      e & St
    ] : 0 : il.black, r, s, l, u, c, f, d, m, y, T;
    if (!a) {
      if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), il[e]) a = il[e];
        ...
        if (a = T = e.match(Qd), !n) u = +a[0] % 360 / 360, c = +a[1] / 100, f = +a[2] / 100, s = f <= 0.5 ? f * (c + 1) : f + c - f * c, r = f * 2 - s, a.length > 3 && (a[3] *= 1), a[0] = Sh(u + 1 / 3, r, s), a[1] = Sh(u, r, s), a[2] = Sh(u - 1 / 3, r, s);
        else if (~e.indexOf("=")) return a = e.match(dx), i && a.length < 4 && (a[3] = 1), a;
      } else a = e.match(Qd) || il.transparent;
      a = a.map(Number);
    }
    return n && !T && (r = a[0] / St, s = a[1] / St, l = a[2] / St, d = Math.max(r, s, l), m = Math.min(r, s, l), f = (d + m) / 2, d === m ? u = c = 0 : (y = d - m, c = f > 0.5 ? y / (2 - d - m) : y / (d + m), u = d === r ? (s - l) / y + (s < l ? 6 : 0) : d === s ? (l - r) / y + 2 : (r - s) / y + 4, u *= 60), a[0] = ~~(u + 0.5), a[1] = ~~(c * 100 + 0.5), a[2] = ~~(f * 100 + 0.5)), i && a.length < 4 && (a[3] = 1), a;
  }, Bx = function(e) {
    var n = [], i = [], a = -1;
    ...
    var a = "", r = (e + a).match(ua), s = n ? "hsla(" : "rgba(", l = 0, u, c, f, d;
    if (!r) return e;
    if (r = r.map(function(m) {
      return (m = jx(m, n, 1)) && s + (n ? m[0] + "," + m[1] + "%," + m[2] + "%," + m[3] : m.join(",")) + ")";
    }), i && (f = Bx(e), u = i.c, u.join(a) !== f.c.join(a))) for (c = e.replace(ua, "1").split(Br), d = c.length - 1; l < d; l++) a += c[l] + (~u.indexOf(l) ? r.shift() || s + "0,0,0,0)" : (f.length ? f : r.length ? r : i).shift());
    ...
    var t = Date.now, e = 500, n = 33, i = t(), a = i, r = 1e3 / 240, s = r, l = [], u, c, f, d, m, y, T = function b(x) {
      var v = t() - a, g = x === true, S, A, w, V;
      if ((v > e || v < 0) && (i += v - n), a += v, w = a - i, S = w - s, (S > 0 || g) && (V = ++d.frame, m = w - d.time * 1e3, d.time = w = w / 1e3, s += S + (S >= r ? 4 : r - S), A = 1), g || (u = c(b)), A) for (y = 0; y < l.length; y++) l[y](w, m, V, x);
    };
    return d = {
      time: 0,
      frame: 0,
      ...
      wake: function() {
        yx && (!Zd && Zp() && (kn = Zd = window, Jp = kn.document || {}, hn.gsap = Ze, (kn.gsapVersions || (kn.gsapVersions = [])).push(Ze.version), gx(mc || kn.GreenSockGlobals || !kn.gsap && kn || {}), Lx.forEach(Nx)), f = typeof requestAnimationFrame < "u" && requestAnimationFrame, u && d.sleep(), c = f || function(x) {
          return setTimeout(x, s - d.time * 1e3 + 1 | 0);
        }, Il = 1, T(2));
      },
      sleep: function() {
        (f ? cancelAnimationFrame : clearTimeout)(u), Il = 0, c = $l;
      },
      ...
      add: function(x, v, g) {
        ...
        return d.remove(x), l[g ? "unshift" : "push"](S), ms(), S;
      },
      remove: function(x, v) {
    ...
    for (var n = {}, i = e.substr(1, e.length - 3).split(":"), a = i[0], r = 1, s = i.length, l, u, c; r < s; r++) u = i[r], l = r !== s - 1 ? u.lastIndexOf(",") : u.length, c = u.substr(0, l), n[a] = isNaN(c) ? c.replace(j4, "").trim() : +c, a = u.substr(l + 1).trim();
    return n;
  }, H4 = function(e) {
    ...
    return qe(e, function(l) {
      ct[l] = hn[l] = r, ct[s = l.toLowerCase()] = i;
      for (var u in r) ct[s + (u === "easeIn" ? ".in" : u === "easeOut" ? ".out" : ".inOut")] = ct[l + "." + u] = r[u];
    }), r;
  }, Px = function(e) {
    return function(n) {
    ...
    }, u = e === "out" ? l : e === "in" ? function(c) {
      return 1 - l(1 - c);
    } : Px(l);
    return r = Kd / r, u.config = function(c, f) {
      return t(e, c, f);
    }, u;
  }, xh = function t(e, n) {
    n === void 0 && (n = 1.70158);
  ...
  var Xx = function(e, n) {
    ...
    function t(n) {
      this.vars = n, this._delay = +n.delay || 0, (this._repeat = n.repeat === 1 / 0 ? -2 : n.repeat || 0) && (this._rDelay = n.repeatDelay || 0, this._yoyo = !!n.yoyo || !!n.yoyoEase), this._ts = 1, ds(this, +n.duration, 1, 1), this.data = n.data, Vt && (this._ctx = Vt, Vt.data.push(this)), Il || en.wake();
    }
    var e = t.prototype;
    return e.delay = function(i) {
      ...
      return arguments.length ? (this._dirty = 0, ds(this, this._repeat < 0 ? i : (i - this._repeat * this._rDelay) / (this._repeat + 1))) : this._tDur;
      ...
      return arguments.length ? this.totalTime(Math.min(this.totalDuration(), i + Fv(this)) % (this._dur + this._rDelay) || (i ? this._dur : 0), a) : this._time;
      ...
      return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - i : i) + Fv(this), a) : this.duration() ? Math.min(1, this._time / this._dur) : this.rawTime() > 0 ? 1 : 0;
    }, e.iteration = function(i, a) {
      var r = this.duration() + this._rDelay;
      return arguments.length ? this.totalTime(this._time + (i - 1) * r, a) : this._repeat ? hs(this._tTime, r) + 1 : 1;
      ...
      return arguments.length ? (this._ps !== i && (this._ps = i, i ? (this._pTime = this._tTime || Math.max(-this._delay, this.rawTime()), this._ts = this._act = 0) : (ms(), this._ts = this._rts, this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, this.progress() === 1 && Math.abs(this._zTime) !== Tt && (this._tTime -= Tt)))), this) : this._ps;
      ...
      return this._start + (ke(i) ? this.totalDuration() : this.duration()) / Math.abs(this._ts || 1);
      ...
      return this.totalTime(vn(this, i), ke(a));
    }, e.restart = function(i, a) {
      return this.play().totalTime(i ? -this._delay : 0, ke(a)), this._dur || (this._zTime = -Tt), this;
    }, e.play = function(i, a) {
      ...
      return new Promise(function(r) {
        var s = Ft(i) ? i : xx, l = function() {
          var c = a.then;
          a.then = null, Ft(s) && (s = s(a)) && (s.then || s === a) && (a.then = c), r(s), a.then = c;
        };
  ...
  var ze = function(t) {
    ...
    function e(i, a) {
      var r;
      return i === void 0 && (i = {}), r = t.call(this, i) || this, r.labels = {}, r.smoothChildTiming = !!i.smoothChildTiming, r.autoRemoveChildren = !!i.autoRemoveChildren, r._sort = ke(i.sortChildren), Bt && qn(i.parent || Bt, fi(r), a), i.reversed && r.reverse(), i.paused && r.paused(true), i.scrollTrigger && wx(fi(r), i.scrollTrigger), r;
    }
    var n = e.prototype;
    return n.to = function(a, r, s) {
    ...
    }, n.staggerTo = function(a, r, s, l, u, c, f) {
      return s.duration = r, s.stagger = s.stagger || l, s.onComplete = c, s.onCompleteParams = f, s.parent = this, new re(a, s, vn(this, u)), this;
    }, n.staggerFrom = function(a, r, s, l, u, c, f) {
      return s.runBackwards = 1, xl(s).immediateRender = ke(s.immediateRender), this.staggerTo(a, r, s, l, u, c, f);
    }, n.staggerFromTo = function(a, r, s, l, u, c, f, d) {
      return l.startAt = s, xl(l).immediateRender = ke(l.immediateRender), this.staggerTo(a, r, l, u, c, f, d);
    }, n.render = function(a, r, s) {
      var l = this._time, u = this._dirty ? this.totalDuration() : this._tDur, c = this._dur, f = a <= 0 ? 0 : le(a), d = this._zTime < 0 != a < 0 && (this._initted || !c), m, y, T, b, x, v, g, S, A, w, V, z;
      if (this !== Bt && f > u && a >= 0 && (f = u), f !== this._tTime || s || d) {
        if (l !== this._time && c && (f += this._time - l, a += this._time - l), m = f, A = this._start, S = this._ts, v = !S, d && (c || (l = this._zTime), (a || !r) && (this._zTime = a)), this._repeat) {
          ...
          if (m = le(f % x), f === u ? (b = this._repeat, m = c) : (w = le(f / x), b = ~~w, b && b === w && (m = c, b--), m > c && (m = c)), w = hs(this._tTime, x), !l && this._tTime && w !== b && this._tTime - w * x - this._dur <= 0 && (w = b), V && b & 1 && (m = c - m, z = 1), b !== w && !this._lock) {
            ...
            if (c = this._dur, u = this._tDur, U && (this._lock = 2, l = O ? c : -1e-4, this.render(l, true), this.vars.repeatRefresh && !z && this.invalidate()), this._lock = 0, !this._ts && !v) return this;
            Gx(this, z);
          }
        }
        ...
        this._onUpdate && !r && an(this, "onUpdate", true), (f === u && this._tTime >= this.totalDuration() || !f && l) && (A === this._start || Math.abs(S) !== Math.abs(this._ts)) && (this._lock || ((a || !c) && (f === u && this._ts > 0 || !f && this._ts < 0) && ya(this, 1), !r && !(a < 0 && !l) && (f || l || !u) && (an(this, f === u && a >= 0 ? "onComplete" : "onReverseComplete", true), this._prom && !(f < u && this.timeScale() > 0) && this._prom())));
      }
      return this;
    }, n.add = function(a, r) {
      var s = this;
      ...
      for (var u = [], c = this._first; c; ) c._start >= l && (c instanceof re ? r && u.push(c) : (s && u.push(c), a && u.push.apply(u, c.getChildren(true, r, s)))), c = c._next;
      return u;
    }, n.getById = function(a) {
      for (var r = this.getChildren(1, 1, 1), s = r.length; s--; ) if (r[s].vars.id === a) return r[s];
    }, n.remove = function(a) {
      return me(a) ? this.removeLabel(a) : Ft(a) ? this.killTweensOf(a) : (a.parent === this && Kc(this, a), a === this._recent && (this._recent = this._last), Za(this));
      ...
      for (var l = this.getTweensOf(a, s), u = l.length; u--; ) Zi !== l[u] && l[u].kill(a, r);
      return this;
    }, n.getTweensOf = function(a, r) {
      for (var s = [], l = Cn(a), u = this._first, c = Ri(r), f; u; ) u instanceof re ? v4(u._targets, l) && (c ? (!Zi || u._initted && u._ts) && u.globalTime(0) <= r && u.globalTime(u.totalDuration()) > r : !r || u.isActive()) && s.push(u) : (f = u.getTweensOf(l, r)).length && s.push.apply(s, f), u = u._next;
      return s;
    }, n.tweenTo = function(a, r) {
      r = r || {};
      var s = this, l = vn(s, a), u = r, c = u.startAt, f = u.onStart, d = u.onStartParams, m = u.immediateRender, y, T = re.to(s, dn({
        ease: r.ease || "none",
        lazy: false,
        ...
        onStart: function() {
          if (s.pause(), !y) {
            ...
            T._dur !== x && ds(T, x, 0, 1).render(T._time, true, true), y = 1;
          }
          f && f.apply(T, d || []);
        }
      }, r));
      ...
      s === void 0 && (s = 0);
      for (var l = this._first, u = this.labels, c; l; ) l._start >= s && (l._start += a, l._end += a), l = l._next;
      if (r) for (c in u) u[c] >= s && (u[c] += a);
      return Za(this);
      ...
      var r = 0, s = this, l = s._last, u = Mn, c, f, d;
      if (arguments.length) return s.timeScale((s._repeat < 0 ? s.duration() : s.totalDuration()) / (s.reversed() ? -a : a));
      if (s._dirty) {
        for (d = s.parent; l; ) c = l._prev, l._dirty && l.totalDuration(), f = l._start, f > u && s._sort && l._ts && !s._lock ? (s._lock = 1, qn(s, l, f - l._delay, 1)._lock = 0) : u = f, f < 0 && l._ts && (r -= f, (!d && !s._dp || d && d.smoothChildTiming) && (s._start += f / s._ts, s._time -= f, s._tTime -= f), s.shiftChildren(-f, false, -1 / 0), u = 0), l._end > r && l._ts && (r = l._end), l = c;
        ds(s, s === Bt && s._time > r ? s._time : r, 1, 1), s._dirty = 0;
      }
      return s._tDur;
    }, e.updateRoot = function(a) {
      if (Bt._ts && (Sx(Bt, gc(a, Bt)), _x = en.frame), en.frame >= kv) {
        kv += un.autoSleep || 120;
        var r = Bt._first;
  ...
  var G4 = function(e, n, i, a, r, s, l) {
    var u = new Fe(this._pt, e, n, 0, 1, Zx, null, r), c = 0, f = 0, d, m, y, T, b, x, v, g;
    for (u.b = i, u.e = a, i += "", a += "", (v = ~a.indexOf("random(")) && (a = Wl(a)), s && (g = [
      i,
      a
    ], s(g, e, n), i = g[0], a = g[1]), m = i.match(_h) || []; d = _h.exec(a); ) T = d[0], b = a.substring(c, d.index), y ? y = (y + 1) % 5 : b.substr(-5) === "rgba(" && (y = 1), T !== m[f++] && (x = parseFloat(m[f - 1]) || 0, u._pt = {
      _next: u._pt,
      p: b || f === 1 ? b : ",",
      s: x,
      c: T.charAt(1) === "=" ? Qr(x, T) - x : parseFloat(T) - x,
      m: y && y < 4 ? Math.round : 0
    }, c = _h.lastIndex);
    return u.c = c < a.length ? a.substring(c, a.length) : "", u.fp = l, (mx.test(a) || v) && (u.e = 0), this._pt = u, u;
  }, ny = function(e, n, i, a, r, s, l, u, c, f) {
    Ft(a) && (a = a(r || 0, e, s));
    var d = e[n], m = i !== "get" ? i : Ft(d) ? c ? e[n.indexOf("set") || !Ft(e["get" + n.substr(3)]) ? n : "get" + n.substr(3)](c) : e[n]() : d, y = Ft(d) ? c ? F4 : Kx : ay, T;
    if (me(a) && (~a.indexOf("random(") && (a = Wl(a)), a.charAt(1) === "=" && (T = Qr(m, a) + (Me(m) || 0), (T || T === 0) && (a = T))), !f || m !== a || nm) return !isNaN(m * a) && a !== "" ? (T = new Fe(this._pt, e, n, +m || 0, a - (m || 0), typeof d == "boolean" ? Q4 : Qx, 0, y), c && (T.fp = c), l && T.modifier(l, this, e), this._pt = T) : (!d && !(n in e) && $p(n, a), G4.call(this, e, n, m, a, y, u || un.stringFilter, c));
  }, P4 = function(e, n, i, a, r) {
    if (Ft(e) && (e = El(e, r, n, i, a)), !ti(e) || e.style && e.nodeType || De(e) || hx(e)) return me(e) ? El(e, r, n, i, a) : e;
    var s = {}, l;
    for (l in e) s[l] = El(e[l], r, n, i, a);
    return s;
  }, kx = function(e, n, i, a, r, s) {
    var l, u, c, f;
    if (We[e] && (l = new We[e]()).init(r, l.rawVars ? n[e] : P4(n[e], a, r, s, i), i, a, s) !== false && (i._pt = u = new Fe(i._pt, r, e, 0, 1, l.render, l, 0, l.priority), i !== Hr)) for (c = i._ptLookup[i._targets.indexOf(r)], f = l._props.length; f--; ) c[l._props[f]] = u;
    return l;
  }, Zi, nm, iy = function t(e, n, i) {
    var a = e.vars, r = a.ease, s = a.startAt, l = a.immediateRender, u = a.lazy, c = a.onUpdate, f = a.runBackwards, d = a.yoyoEase, m = a.keyframes, y = a.autoRevert, T = e._dur, b = e._startAt, x = e._targets, v = e.parent, g = v && v.data === "nested" ? v.vars.targets : x, S = e._overwrite === "auto" && !Kp, A = e.timeline, w, V, z, O, U, B, Y, F, X, $, K, N, P;
    if (A && (!m || !r) && (r = "none"), e._ease = Ja(r, cs.ease), e._yEase = d ? Yx(Ja(d === true ? r : d, cs.ease)) : 0, d && e._yoyo && !e._repeat && (d = e._yEase, e._yEase = e._ease, e._ease = d), e._from = !A && !!a.runBackwards, !A || m && !a.stagger) {
      if (F = x[0] ? Qa(x[0]).harness : 0, N = F && a[F.prop], w = yc(a, Wp), b && (b._zTime < 0 && b.progress(1), n < 0 && f && l && !y ? b.render(-1, true) : b.revert(f && T ? Du : y4), b._lazy = 0), s) {
        ...
        if (n && (l = false), z = dn({
          ...
          stagger: 0,
          parent: v
        }, w), N && (z[F.prop] = N), ya(e._startAt = re.set(x, z)), e._startAt._dp = 0, e._startAt._sat = e, n < 0 && (Ae ? e._startAt.revert(Du) : e._startAt.render(-1, true)), e._zTime = n, !l) t(e._startAt, Tt, Tt);
        else if (!n) return;
      }
      for (e._pt = e._ptCache = 0, u = T && ke(u) || u && !T, V = 0; V < x.length; V++) {
        if (U = x[V], Y = U._gsap || ty(x)[V]._gsap, e._ptLookup[V] = $ = {}, Jd[Y.id] && oa.length && pc(), K = g === x ? V : g.indexOf(U), F && (X = new F()).init(U, N || w, e, K, g) !== false && (e._pt = O = new Fe(e._pt, U, X.name, 0, 1, X.render, X, 0, X.priority), X._props.forEach(function(G) {
          $[G] = O;
        }), X.priority && (B = 1)), !F || N) for (z in w) We[z] && (X = kx(z, w, e, K, U, g)) ? X.priority && (B = 1) : $[z] = O = ny.call(e, U, z, "get", w[z], K, g, 0, a.stringFilter);
        e._op && e._op[V] && e.kill(U, e._op[V]), S && e._pt && (Zi = e, Bt.killTweensOf(U, $, e.globalTime(n)), P = !e.parent, Zi = 0), e._pt && u && (Jd[Y.id] = 1);
      }
      B && Jx(e), e._onInit && e._onInit(e);
    }
    e._onUpdate = c, e._initted = (!e._op || e._pt) && !P, m && n <= 0 && A.render(Mn, true, true);
  }, X4 = function(e, n, i, a, r, s, l, u) {
    ...
    if (!c) for (c = e._ptCache[n] = [], m = e._ptLookup, y = e._targets.length; y--; ) {
      ...
      if (!f) return nm = 1, e.vars[n] = "+=0", iy(e, l), nm = 0, u ? Jl(n + " not eligible for reset") : 1;
      c.push(f);
    }
    for (y = c.length; y--; ) d = c[y], f = d._pt || d, f.s = (a || a === 0) && !r ? a : f.s + (a || 0) + s * f.c, f.c = i - f.s, d.e && (d.e = $t(i) + Me(d.e)), d.b && (d.b = f.s + Me(d.b));
  }, k4 = function(e, n) {
    var i = e[0] ? Qa(e[0]).harness : 0, a = i && i.aliases, r, s, l, u;
    if (!a) return n;
    r = fs({}, n);
    for (s in a) if (s in r) for (u = a[s].split(","), l = u.length; l--; ) r[u[l]] = r[s];
    return r;
  }, q4 = function(e, n, i, a) {
    var r = n.ease || a || "power1.inOut", s, l;
    if (De(n)) l = i[e] || (i[e] = []), n.forEach(function(u, c) {
      return l.push({
        t: c / (n.length - 1) * 100,
        v: u,
        e: r
    ...
    return Ft(e) ? e.call(n, i, a, r) : me(e) && ~e.indexOf("random(") ? Wl(e) : e;
  }, qx = Ip + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert", Fx = {};
  qe(qx + ",id,stagger,delay,duration,paused,scrollTrigger", function(t) {
    return Fx[t] = 1;
  });
  var re = function(t) {
    cx(e, t);
    function e(i, a, r, s) {
      ...
      var u = l.vars, c = u.duration, f = u.delay, d = u.immediateRender, m = u.stagger, y = u.overwrite, T = u.keyframes, b = u.defaults, x = u.scrollTrigger, v = u.yoyoEase, g = a.parent || Bt, S = (De(i) || hx(i) ? Ri(i[0]) : "length" in a) ? [
        i
      ...
      if (l._targets = S.length ? ty(S) : Jl("GSAP target " + i + " not found. https://gsap.com", !un.nullTargetWarn) || [], l._ptLookup = [], l._overwrite = y, T || m || au(c) || au(f)) {
        if (a = l.vars, A = l.timeline = new ze({
          ...
          if (z = S.length, B = m && Rx(m), ti(m)) for (O in m) ~qx.indexOf(O) && (Y || (Y = {}), Y[O] = m[O]);
          for (w = 0; w < z; w++) V = yc(a, Fx), V.stagger = 0, v && (V.yoyoEase = v), Y && fs(V, Y), U = S[w], V.duration = +El(c, fi(l), w, U, S), V.delay = (+El(f, fi(l), w, U, S) || 0) - l._delay, !m && z === 1 && V.delay && (l._delay = f = V.delay, l._start += f, V.delay = 0), A.to(U, V, B ? B(w, U, S) : 0), A._ease = ct.none;
          ...
          if (De(T)) T.forEach(function(N) {
            ...
            V = {};
            for (O in T) O === "ease" || O === "easeEach" || q4(O, T[O], V, T.easeEach);
            for (O in V) for (X = V[O].sort(function(N, P) {
              return N.t - P.t;
            }), F = 0, w = 0; w < X.length; w++) $ = X[w], K = {
              ease: $.e,
              duration: ($.t - (w ? X[w - 1].t : 0)) / 100 * c
            }, K[O] = $.v, A.to(S, K, F), F += K.duration;
            A.duration() < c && A.to({}, {
      ...
      return y === true && !Kp && (Zi = fi(l), Bt.killTweensOf(S), Zi = 0), qn(g, fi(l), r), a.reversed && l.reverse(), a.paused && l.paused(true), (d || !c && !T && l._start === le(g._time) && ke(d) && T4(fi(l)) && g.data !== "nested") && (l._tTime = -Tt, l.render(Math.max(0, -f) || 0)), x && wx(fi(l), x), l;
    }
    var n = e.prototype;
    return n.render = function(a, r, s) {
      var l = this._time, u = this._tDur, c = this._dur, f = a < 0, d = a > u - Tt && !f ? u : a < Tt ? 0 : a, m, y, T, b, x, v, g, S, A;
      if (!c) A4(this, a, r, s);
        ...
        if (m = d, S = this.timeline, this._repeat) {
          ...
          if (m = le(d % b), d === u ? (T = this._repeat, m = c) : (x = le(d / b), T = ~~x, T && T === x ? (m = c, T--) : m > c && (m = c)), v = this._yoyo && T & 1, v && (A = this._yEase, m = c - m), x = hs(this._tTime, b), m === l && !s && this._initted && T === x) return this._tTime = d, this;
    ...
    }, n.resetTo = function(a, r, s, l, u) {
      Il || en.wake(), this._ts || this.play();
      var c = Math.min(this._dur, (this._dp._time - this._start) * this._ts), f;
      return this._initted || iy(this, c), f = this._ease(c / this._dur), X4(this, a, r, s, l, f, c, u) ? this.resetTo(a, r, s, l, 1) : (Zc(this, 0), this.parent || Ax(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
    }, n.kill = function(a, r) {
      ...
      if (this.timeline) {
        ...
        return this.timeline.killTweensOf(a, r, Zi && Zi.vars.overwrite !== true)._first || nl(this), this.parent && s !== this.timeline.totalDuration() && ds(this, this._dur * this.timeline._tDur / s, 0, 1), this;
      }
      var l = this._targets, u = a ? Cn(a) : l, c = this._ptLookup, f = this._pt, d, m, y, T, b, x, v;
      if ((!r || r === "all") && b4(l, u)) return r === "all" && (this._pt = 0), nl(this);
      for (d = this._op = this._op || [], r !== "all" && (me(r) && (b = {}, qe(r, function(g) {
        return b[g] = 1;
      }), r = b), r = k4(l, r)), v = l.length; v--; ) if (~u.indexOf(l[v])) {
  ...
  var ay = function(e, n, i) {
    ...
    return Ft(e[n]) ? Kx : Qp(e[n]) && e.setAttribute ? K4 : ay;
  }, Qx = function(e, n) {
    ...
    function t(n, i, a, r, s, l, u, c, f) {
      this.t = i, this.s = r, this.c = s, this.p = a, this.r = l || Qx, this.d = u || this, this.set = c || ay, this.pr = f || 0, this._next = n, n && (n._prev = this);
    }
    var e = t.prototype;
  ...
  qe(Ip + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger", function(t) {
    return Wp[t] = 1;
  });
  ...
  var $a = [], Ou = {}, W4 = [], Jv = 0, I4 = 0, Ah = function(e) {
    ...
    e - Jv > 2 && (Ah("matchMediaInit"), $a.forEach(function(i) {
      var a = i.queries, r = i.conditions, s, l, u, c;
      for (l in a) s = kn.matchMedia(a[l]).matches, s && (u = 1), s !== r[l] && (r[l] = s, c = 1);
      c && (i.revert(), u && n.push(i));
    ...
    return e.add = function(i, a, r) {
      ...
      var s = this, l = function() {
        ...
        return c && c !== s && c.data.push(s), r && (s.selector = tm(r)), Vt = s, d = a.apply(s, arguments), Ft(d) && s._r.push(d), Vt = c, s.selector = f, s.isReverted = false, d;
      };
      return s.last = l, i === Ft ? l(s, function(u) {
        return s.add(null, u);
      }) : i ? s[i] = l : l;
    }, e.ignore = function(i) {
      var a = Vt;
      ...
      var r = this;
      if (i ? function() {
        for (var l = r.getTweens(), u = r.data.length, c; u--; ) c = r.data[u], c.data === "isFlip" && (c.revert(), c.getChildren(true, true, false).forEach(function(f) {
        ...
        for (l.map(function(f) {
          ...
          return f.t.revert(i);
        }), u = r.data.length; u--; ) c = r.data[u], c instanceof ze ? c.data !== "nested" && (c.scrollTrigger && c.scrollTrigger.revert(), c.kill()) : !(c instanceof re) && c.revert && c.revert(i);
    ...
    return e.add = function(i, a, r) {
      ...
      var s = new $x(0, r || this.scope), l = s.conditions = {}, u, c, f;
      Vt && !s.selector && (s.selector = Vt.selector), this.contexts.push(s), a = s.add("onMatch", a), s.queries = i;
      for (c in i) c === "all" ? f = 1 : (u = kn.matchMedia(i[c]), u && ($a.indexOf(s) < 0 && $a.push(s), (l[c] = u.matches) && (f = 1), u.addListener ? u.addListener(im) : u.addEventListener("change", im)));
    ...
    getProperty: function(e, n, i, a) {
      ...
      return i === "native" && (i = ""), e && (n ? s((We[n] && We[n].get || r)(e, n, i, a)) : function(l, u, c) {
        return s((We[l] && We[l].get || r)(e, l, u, c));
      });
    },
    quickSetter: function(e, n, i) {
      ...
      e = e[0] || {};
      var s = We[n], l = Qa(e), u = l.harness && (l.harness.aliases || {})[n] || n, c = s ? function(f) {
        var d = new s();
        Hr._pt = 0, d.init(e, i ? f + i : f, Hr, 0, [
          e
        ]), d.render(1, d), Hr._pt && sy(1, Hr);
      } : l.set(e, u);
    ...
    quickTo: function(e, n, i) {
      var a, r = Ze.to(e, dn((a = {}, a[n] = "+=0.1", a.paused = true, a.stagger = 0, a), i || {})), s = function(u, c, f) {
        return r.resetTo(n, u, c, f);
      };
      return s.tween = r, s;
    },
    ...
    defaults: function(e) {
      return e && e.ease && (e.ease = Ja(e.ease, cs.ease)), qv(cs, e || {});
    },
    config: function(e) {
      return qv(un, e || {});
    },
    registerEffect: function(e) {
      ...
      (a || "").split(",").forEach(function(l) {
        ...
        return i(Cn(l), dn(u || {}, r), c);
      }, s && (ze.prototype[n] = function(l, u, c) {
        return this.add(bh[n](l, ti(u) ? u : (c = u) && {}, this), c);
      });
    },
    ...
    exportRoot: function(e, n) {
      e === void 0 && (e = {});
      var i = new ze(e), a, r;
      for (i.smoothChildTiming = ke(e.smoothChildTiming), Bt.remove(i), i._dp = 0, i._time = i._tTime = Bt._time, a = Bt._first; a; ) r = a._next, (n || !(!a._dur && a instanceof re && a.vars.onComplete === a._targets[0])) && qn(i, a, a._start - a._delay), a = r;
      return qn(Bt, i, 0), i;
    },
  ...
  var ez = function(e, n) {
    ...
    return {
      ...
      init: function(a, r, s) {
        s._onInit = function(l) {
          var u, c;
          if (me(r) && (u = {}, qe(r, function(f) {
            return u[f] = 1;
          }), r = u), n) {
            u = {};
            for (c in r) u[c] = n(r[c]);
            r = u;
          }
          nz(l, r);
        };
    ...
    init: function(e, n, i, a, r) {
      var s, l, u;
      this.tween = i;
      for (s in n) u = e.getAttribute(s) || "", l = this.add(e, "setAttribute", (u || 0) + "", n[s], a, r, 0, 0, s), l.op = s, l.b = u, this._props.push(s);
    },
    render: function(e, n) {
  ...
  ct.Expo;
  ct.Circ;
  var $v, Ji, Zr, ly, Ya, Wv, oy, iz = function() {
    return typeof window < "u";
  }, Oi = {}, ja = 180 / Math.PI, Jr = Math.PI / 180, yr = Math.atan2, Iv = 1e8, uy = /([A-Z])/g, az = /(left|right|width|margin|padding|x)/i, rz = /[\s,\(]\S/, Zn = {
    ...
    if (e in Oi && r) {
      if (this.tfm = this.tfm || {}, e !== "transform") e = Zn[e] || e, ~e.indexOf(",") ? e.split(",").forEach(function(l) {
        return i.tfm[l] = di(a, l);
      }) : this.tfm[e] = s.x ? s[e] : di(a, e), e === Ke && (this.tfm.zOrigin = s.zOrigin);
      else return Zn.transform.split(",").forEach(function(l) {
        return t.call(i, l, n);
      });
    ...
    return a[n] || a.getPropertyValue(n.replace(uy, "-$1").toLowerCase()) || a.getPropertyValue(n) || !i && t(e, ps(n) || n, 1) || "";
  }, t_ = "O,Moz,ms,Ms,Webkit".split(","), ps = function(e, n, i) {
    ...
    iz() && window.document && ($v = window, Ji = $v.document, Zr = Ji.documentElement, Ya = rm("div") || {
      style: {}
    }, rm("div"), Yt = ps(Yt), Ke = Yt + "Origin", Ya.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", n2 = !!ps("perspective"), oy = Ze.core.reverting, ly = 1);
  }, e_ = function(e) {
    var n = e.ownerSVGElement, i = rm("svg", n && n.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), a = e.cloneNode(true), r;
    a.style.display = "block", i.appendChild(a), Zr.appendChild(i);
    try {
      r = a.getBBox();
    } catch {
    }
    return i.removeChild(a), Zr.removeChild(i), r;
  }, n_ = function(e, n) {
    ...
    var l = new Fe(e._pt, n, i, 0, 1, s ? Ix : Wx);
    ...
    var r = parseFloat(i) || 0, s = (i + "").trim().substr((r + "").length) || "px", l = Ya.style, u = az.test(n), c = e.tagName.toLowerCase() === "svg", f = (c ? "client" : "offset") + (u ? "Width" : "Height"), d = 100, m = a === "px", y = a === "%", T, b, x, v;
    if (a === s || !r || i_[a] || i_[s]) return r;
    if (s !== "px" && !m && (r = t(e, n, i, "px")), v = e.getCTM && a2(e), (y || s === "%") && (Oi[n] || ~n.indexOf("adius"))) return T = v ? e.getBBox()[u ? "width" : "height"] : e[f], $t(y ? r / T * d : r / 100 * T);
    if (l[u ? "width" : "height"] = d + (m ? s : a), b = a !== "rem" && ~n.indexOf("adius") || a === "em" && e.appendChild && !c ? e : e.parentNode, v && (b = (e.ownerSVGElement || {}).parentNode), (!b || b === Ji || !b.appendChild) && (b = Ji.body), x = b._gsap, x && y && x.width && u && x.time === en.time && !x.uncache) return $t(r / x.width * d);
    ...
    return u && y && (x = Qa(b), x.time = en.time, x.width = b[f]), $t(m ? T * r / d : T && r ? d / T * r : 0);
  }, di = function(e, n, i, a) {
    var r;
    return ly || sm(), n in Zn && n !== "transform" && (n = Zn[n], ~n.indexOf(",") && (n = n.split(",")[0])), Oi[n] && n !== "transform" ? (r = no(e, a), r = n !== "transformOrigin" ? r[n] : r.svg ? r.origin : bc(Dn(e, Ke)) + " " + r.zOrigin + "px") : (r = e.style[n], (!r || r === "auto" || a || ~(r + "").indexOf("calc(")) && (r = _c[n] && _c[n](e, n, i) || Dn(e, n) || bx(e, n) || (n === "opacity" ? 1 : 0))), i && !~(r + "").trim().indexOf(" ") ? ga(e, n, r, i) + i : r;
  }, vz = function(e, n, i, a) {
    if (!i || i === "none") {
      var r = ps(n, e, 1), s = r && Dn(e, r, 1);
      s && s !== i ? (n = r, i = s) : n === "borderColor" && (i = Dn(e, "borderTopColor"));
    }
    var l = new Fe(this._pt, e.style, n, 0, 1, Zx), u = 0, c = 0, f, d, m, y, T, b, x, v, g, S, A, w;
    if (l.b = i, l.e = a, i += "", a += "", a.substring(0, 6) === "var(--" && (a = Dn(e, a.substring(4, a.indexOf(")")))), a === "auto" && (b = e.style[n], e.style[n] = a, a = Dn(e, n) || a, b ? e.style[n] = b : ar(e, n)), f = [
      i,
      a
    ], Hx(f), i = f[0], a = f[1], m = i.match(Br) || [], w = a.match(Br) || [], w.length) {
      for (; d = Br.exec(a); ) x = d[0], g = a.substring(u, d.index), T ? T = (T + 1) % 5 : (g.substr(-5) === "rgba(" || g.substr(-5) === "hsla(") && (T = 1), x !== (b = m[c++] || "") && (y = parseFloat(b) || 0, A = b.substr((y + "").length), x.charAt(1) === "=" && (x = Qr(y, x) + A), v = parseFloat(x), S = x.substr((v + "").length), u = Br.lastIndex - S.length, S || (S = S || un.units[n] || A, u === a.length && (a += S, l.e += S)), A !== S && (y = ga(e, n, b, S) || 0), l._pt = {
        _next: l._pt,
        p: g || c === 1 ? g : ",",
        s: y,
        c: v - y,
    ...
    if (n.tween && n.tween._time === n.tween._dur) {
      var i = n.t, a = i.style, r = n.u, s = i._gsap, l, u, c;
      if (r === "all" || r === true) a.cssText = "", u = 1;
      else for (r = r.split(","), c = r.length; --c > -1; ) l = r[c], Oi[l] && (u = 1, l = l === "transformOrigin" ? Ke : Yt), ar(i, l);
      u && (ar(i, Yt), s && (s.svg && i.removeAttribute("transform"), a.scale = a.rotate = a.translate = "none", no(i, 1), s.uncache = 1, t2(a)));
    }
  }, _c = {
    clearProps: function(e, n, i, a, r) {
      if (r.data !== "isFromStart") {
        var s = e._pt = new Fe(e._pt, n, i, 0, 0, bz);
    ...
    var i = e._gsap || Qa(e), a = e.style, r = r_(e), s, l, u, c;
    return i.svg && e.getAttribute("transform") ? (u = e.transform.baseVal.consolidate().matrix, r = [
      u.a,
      u.b,
      u.c,
      u.d,
      u.e,
      u.f
    ], r.join(",") === "1,0,0,1,0,0" ? eo : r) : (r === eo && !e.offsetParent && e !== Zr && !i.svg && (u = a.display, a.display = "block", s = e.parentNode, (!s || !e.offsetParent && !e.getBoundingClientRect().width) && (c = 1, l = e.nextElementSibling, Zr.appendChild(e)), r = r_(e), u ? a.display = u : ar(e, "display"), c && (l ? s.insertBefore(e, l) : s ? s.appendChild(e) : Zr.removeChild(e))), n && r.length > 6 ? [
      r[0],
      r[1],
      r[4],
      r[5],
    ...
    var l = e._gsap, u = r || cy(e, true), c = l.xOrigin || 0, f = l.yOrigin || 0, d = l.xOffset || 0, m = l.yOffset || 0, y = u[0], T = u[1], b = u[2], x = u[3], v = u[4], g = u[5], S = n.split(" "), A = parseFloat(S[0]) || 0, w = parseFloat(S[1]) || 0, V, z, O, U;
    i ? u !== eo && (z = y * x - T * b) && (O = A * (x / z) + w * (-b / z) + (b * g - x * v) / z, U = A * (-T / z) + w * (y / z) - (y * g - T * v) / z, A = O, w = U) : (V = i2(e), A = V.x + (~S[0].indexOf("%") ? A / 100 * V.width : A), w = V.y + (~(S[1] || S[0]).indexOf("%") ? w / 100 * V.height : w)), a || a !== false && l.smooth ? (v = A - c, g = w - f, l.xOffset = d + (v * y + g * b) - v, l.yOffset = m + (v * T + g * x) - g) : l.xOffset = l.yOffset = 0, l.xOrigin = A, l.yOrigin = w, l.smooth = !!a, l.origin = n, l.originIsAbsolute = !!i, e.style[Ke] = "0px 0px", s && ($i(s, l, "xOrigin", c, A), $i(s, l, "yOrigin", f, w), $i(s, l, "xOffset", d, l.xOffset), $i(s, l, "yOffset", m, l.yOffset)), e.setAttribute("data-svg-origin", A + " " + w);
  }, no = function(e, n) {
    var i = e._gsap || new Xx(e);
    if ("x" in i && !n && !i.uncache) return i;
    var a = e.style, r = i.scaleX < 0, s = "px", l = "deg", u = getComputedStyle(e), c = Dn(e, Ke) || "0", f, d, m, y, T, b, x, v, g, S, A, w, V, z, O, U, B, Y, F, X, $, K, N, P, G, Q, it, Pt, Kt, te, Nt, pe;
    return f = d = m = b = x = v = g = S = A = 0, y = T = 1, i.svg = !!(e.getCTM && a2(e)), u.translate && ((u.translate !== "none" || u.scale !== "none" || u.rotate !== "none") && (a[Yt] = (u.translate !== "none" ? "translate3d(" + (u.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (u.rotate !== "none" ? "rotate(" + u.rotate + ") " : "") + (u.scale !== "none" ? "scale(" + u.scale.split(" ").join(",") + ") " : "") + (u[Yt] !== "none" ? u[Yt] : "")), a.scale = a.rotate = a.translate = "none"), z = cy(e, i.svg), i.svg && (i.uncache ? (G = e.getBBox(), c = i.xOrigin - G.x + "px " + (i.yOrigin - G.y) + "px", P = "") : P = !n && e.getAttribute("data-svg-origin"), lm(e, P || c, !!P || i.originIsAbsolute, i.smooth !== false, z)), w = i.xOrigin || 0, V = i.yOrigin || 0, z !== eo && (Y = z[0], F = z[1], X = z[2], $ = z[3], f = K = z[4], d = N = z[5], z.length === 6 ? (y = Math.sqrt(Y * Y + F * F), T = Math.sqrt($ * $ + X * X), b = Y || F ? yr(F, Y) * ja : 0, g = X || $ ? yr(X, $) * ja + b : 0, g && (T *= Math.abs(Math.cos(g * Jr))), i.svg && (f -= w - (w * Y + V * X), d -= V - (w * F + V * $))) : (pe = z[6], te = z[7], it = z[8], Pt = z[9], Kt = z[10], Nt = z[11], f = z[12], d = z[13], m = z[14], O = yr(pe, Kt), x = O * ja, O && (U = Math.cos(-O), B = Math.sin(-O), P = K * U + it * B, G = N * U + Pt * B, Q = pe * U + Kt * B, it = K * -B + it * U, Pt = N * -B + Pt * U, Kt = pe * -B + Kt * U, Nt = te * -B + Nt * U, K = P, N = G, pe = Q), O = yr(-X, Kt), v = O * ja, O && (U = Math.cos(-O), B = Math.sin(-O), P = Y * U - it * B, G = F * U - Pt * B, Q = X * U - Kt * B, Nt = $ * B + Nt * U, Y = P, F = G, X = Q), O = yr(F, Y), b = O * ja, O && (U = Math.cos(O), B = Math.sin(O), P = Y * U + F * B, G = K * U + N * B, F = F * U - Y * B, N = N * U - K * B, Y = P, K = G), x && Math.abs(x) + Math.abs(b) > 359.9 && (x = b = 0, v = 180 - v), y = $t(Math.sqrt(Y * Y + F * F + X * X)), T = $t(Math.sqrt(N * N + pe * pe)), O = yr(K, N), g = Math.abs(O) > 2e-4 ? O * ja : 0, A = Nt ? 1 / (Nt < 0 ? -Nt : Nt) : 0), i.svg && (P = e.getAttribute("transform"), i.forceCSS = e.setAttribute("transform", "") || !s2(Dn(e, Yt)), P && e.setAttribute("transform", P))), Math.abs(g) > 90 && Math.abs(g) < 270 && (r ? (y *= -1, g += b <= 0 ? 180 : -180, b += b <= 0 ? 180 : -180) : (T *= -1, g += g <= 0 ? 180 : -180)), n = n || i.uncache, i.x = f - ((i.xPercent = f && (!n && i.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-f) ? -50 : 0))) ? e.offsetWidth * i.xPercent / 100 : 0) + s, i.y = d - ((i.yPercent = d && (!n && i.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-d) ? -50 : 0))) ? e.offsetHeight * i.yPercent / 100 : 0) + s, i.z = m + s, i.scaleX = $t(y), i.scaleY = $t(T), i.rotation = $t(b) + l, i.rotationX = $t(x) + l, i.rotationY = $t(v) + l, i.skewX = g + l, i.skewY = S + l, i.transformPerspective = A + s, (i.zOrigin = parseFloat(c.split(" ")[2]) || !n && i.zOrigin || 0) && (a[Ke] = bc(c)), i.xOffset = i.yOffset = 0, i.force3D = un.force3D, i.renderTransform = i.svg ? Tz : n2 ? l2 : Sz, i.uncache = 0, i;
  }, bc = function(e) {
    ...
    var i = n || this, a = i.xPercent, r = i.yPercent, s = i.x, l = i.y, u = i.z, c = i.rotation, f = i.rotationY, d = i.rotationX, m = i.skewX, y = i.skewY, T = i.scaleX, b = i.scaleY, x = i.transformPerspective, v = i.force3D, g = i.target, S = i.zOrigin, A = "", w = v === "auto" && e && e !== 1 || v === true;
    if (S && (d !== Ra || f !== Ra)) {
      var V = parseFloat(f) * Jr, z = Math.sin(V), O = Math.cos(V), U;
      V = parseFloat(d) * Jr, U = Math.cos(V), s = wh(g, s, z * U * -S), l = wh(g, l, -Math.sin(V) * -S), u = wh(g, u, O * U * -S + S);
    }
    x !== Zs && (A += "perspective(" + x + Oa), (a || r) && (A += "translate(" + a + "%, " + r + "%) "), (w || s !== Zs || l !== Zs || u !== Zs) && (A += u !== Zs || w ? "translate3d(" + s + ", " + l + ", " + u + ") " : "translate(" + s + ", " + l + Oa), c !== Ra && (A += "rotate(" + c + Oa), f !== Ra && (A += "rotateY(" + f + Oa), d !== Ra && (A += "rotateX(" + d + Oa), (m !== Ra || y !== Ra) && (A += "skew(" + m + ", " + y + Oa), (T !== 1 || b !== 1) && (A += "scale(" + T + ", " + b + Oa), g.style[Yt] = A || "translate(0, 0)";
  }, Tz = function(e, n) {
    var i = n || this, a = i.xPercent, r = i.yPercent, s = i.x, l = i.y, u = i.rotation, c = i.skewX, f = i.skewY, d = i.scaleX, m = i.scaleY, y = i.target, T = i.xOrigin, b = i.yOrigin, x = i.xOffset, v = i.yOffset, g = i.forceCSS, S = parseFloat(s), A = parseFloat(l), w, V, z, O, U;
    u = parseFloat(u), c = parseFloat(c), f = parseFloat(f), f && (f = parseFloat(f), c += f, u += f), u || c ? (u *= Jr, c *= Jr, w = Math.cos(u) * d, V = Math.sin(u) * d, z = Math.sin(u - c) * -m, O = Math.cos(u - c) * m, c && (f *= Jr, U = Math.tan(c - f), U = Math.sqrt(1 + U * U), z *= U, O *= U, f && (U = Math.tan(f), U = Math.sqrt(1 + U * U), w *= U, V *= U)), w = $t(w), V = $t(V), z = $t(z), O = $t(O)) : (w = d, O = m, V = z = 0), (S && !~(s + "").indexOf("px") || A && !~(l + "").indexOf("px")) && (S = ga(y, "x", s, "px"), A = ga(y, "y", l, "px")), (T || b || x || v) && (S = $t(S + T - (T * w + b * z) + x), A = $t(A + b - (T * V + b * O) + v)), (a || r) && (U = y.getBBox(), S = $t(S + a / 100 * U.width), A = $t(A + r / 100 * U.height)), U = "matrix(" + w + "," + V + "," + z + "," + O + "," + S + "," + A + ")", y.setAttribute("transform", U), g && (y.style[Yt] = U);
  }, xz = function(e, n, i, a, r) {
    var s = 360, l = me(r), u = parseFloat(r) * (l && ~r.indexOf("rad") ? ja : 1), c = u - a, f = a + c + "deg", d, m;
    return l && (d = r.split("_")[1], d === "short" && (c %= s, c !== c % (s / 2) && (c += c < 0 ? s : -s)), d === "cw" && c < 0 ? c = (c + s * Iv) % s - ~~(c / s) * s : d === "ccw" && c > 0 && (c = (c - s * Iv) % s - ~~(c / s) * s)), e._pt = m = new Fe(e._pt, n, i, a, c, sz), m.e = f, m.u = "deg", e._props.push(i), m;
  }, s_ = function(e, n) {
    for (var i in n) e[i] = n[i];
    return e;
  }, Az = function(e, n, i) {
    var a = s_({}, i._gsap), r = "perspective,force3D,transformOrigin,svgOrigin", s = i.style, l, u, c, f, d, m, y, T;
    ...
    for (u in Oi) c = a[u], f = l[u], c !== f && r.indexOf(u) < 0 && (y = Me(c), T = Me(f), d = y !== T ? ga(i, u, c, T) : parseFloat(c), m = parseFloat(f), e._pt = new Fe(e._pt, l, u, d, m - d, am), e._pt.u = T || 0, e._props.push(u));
    s_(l, a);
  };
  qe("padding,margin,Width,Radius", function(t, e) {
    ...
    _c[e > 1 ? "border" + t : t] = function(l, u, c, f, d) {
      var m, y;
  ...
  var o2 = {
    ...
    init: function(e, n, i, a, r) {
      var s = this._props, l = e.style, u = i.vars.startAt, c, f, d, m, y, T, b, x, v, g, S, A, w, V, z, O;
      ly || sm(), this.styles = this.styles || e2(e), O = this.styles.props, this.tween = i;
      for (b in n) if (b !== "autoRound" && (f = n[b], !(We[b] && kx(b, n, i, a, e, r)))) {
        if (y = typeof f, T = _c[b], y === "function" && (f = f.call(i, a, e, r), y = typeof f), y === "string" && ~f.indexOf("random(") && (f = Wl(f)), T) T(this, e, b, f, i) && (z = 1);
          ...
          if (u && b in u ? (c = typeof u[b] == "function" ? u[b].call(i, a, e, r) : u[b], me(c) && ~c.indexOf("random(") && (c = Wl(c)), Me(c + "") || c === "auto" || (c += un.units[b] || Me(di(e, b)) || ""), (c + "").charAt(1) === "=" && (c = di(e, b))) : c = di(e, b), m = parseFloat(c), g = y === "string" && f.charAt(1) === "=" && f.substr(0, 2), g && (f = f.substr(2)), d = parseFloat(f), b in Zn && (b === "autoAlpha" && (m === 1 && di(e, "visibility") === "hidden" && d && (m = 0), O.push("visibility", 0, l.visibility), $i(this, l, "visibility", m ? "inherit" : "hidden", d ? "inherit" : "hidden", !d)), b !== "scale" && b !== "transform" && (b = Zn[b], ~b.indexOf(",") && (b = b.split(",")[0]))), S = b in Oi, S) {
            if (this.styles.save(b), y === "string" && f.substring(0, 6) === "var(--" && (f = Dn(e, f.substring(4, f.indexOf(")"))), d = parseFloat(f)), A || (w = e._gsap, w.renderTransform && !n.parseTransform || no(e, n.parseTransform), V = n.smoothOrigin !== false && w.smooth, A = this._pt = new Fe(this._pt, l, Yt, 0, 1, w.renderTransform, w, 0, -1), A.dep = 1), b === "scale") this._pt = new Fe(this._pt, w, "scaleY", w.scaleY, (g ? Qr(w.scaleY, g + d) : d) - w.scaleY || 0, am), this._pt.u = 0, s.push("scaleY", b), b += "X";
          ...
          } else b in l || (b = ps(b) || b);
          if (S || (d || d === 0) && (m || m === 0) && !rz.test(f) && b in l) x = (c + "").substr((m + "").length), d || (d = 0), v = Me(f) || (b in un.units ? un.units[b] : x), x !== v && (m = ga(e, b, c, v)), this._pt = new Fe(this._pt, S ? w : l, b, m, (g ? Qr(m, g + d) : d) - m, !S && (v === "px" || b === "zIndex") && n.autoRound !== false ? oz : am), this._pt.u = v || 0, x !== v && v !== "%" && (this._pt.b = c, this._pt.r = lz);
  ...
  Ze.utils.checkPrefix = ps;
  Ze.core.getStyleSaver = e2;
  (function(t, e, n, i) {
    var a = qe(t + "," + e + "," + n, function(r) {
      Oi[r] = 1;
    });
    qe(e, function(r) {
      un.units[r] = "deg", r2[r] = 1;
    }), Zn[a[13]] = t + "," + e, qe(i, function(r) {
      var s = r.split(":");
      Zn[s[1]] = a[s[0]];
    });
  ...
  const fy = (t, e = ru) => {
    ...
    }, i)), l = D.useRef((c) => s.current.add(null, c)), u = e && e.length && !a;
    return u && l_(() => (r.current = true, () => s.current.revert()), ru), l_(() => {
      if (t && s.current.add(t, i), !u || !r.current) return () => s.current.revert();
    }, e), {
      context: s.current,
  ...
  fy.headless = true;
  const wz = "" + new URL("game_of_life_bg-DEadghQh.wasm", import.meta.url).href, Mz = async (t = {}, e) => {
    let n;
  ...
  function f2(t, e, n) {
    if (n === void 0) {
      const l = Ml.encode(t), u = e(l.length, 1) >>> 0;
      return wl().subarray(u, u + l.length).set(l), ys = l.length, u;
    }
    ...
    if (s !== i) {
      ...
      const l = wl().subarray(a + s, a + i), u = Ml.encodeInto(t, l);
      s += u.written, a = n(a, i, s, 1) >>> 0;
    }
    return ys = s, a;
  }
  let gr = null;
  function Sc() {
    return (gr === null || gr.buffer.detached === true || gr.buffer.detached === void 0 && gr.buffer !== jt.memory.buffer) && (gr = new DataView(jt.memory.buffer)), gr;
  }
  function Oz(t) {
    return t == null;
  }
  function zz(t, e) {
    ...
    return wl().set(t, n / 1), ys = t.length, n;
  }
  ...
  class Tc {
    ...
    tick(e) {
      const n = zz(e, jt.__wbindgen_malloc), i = ys;
  ...
  function Bz(t, e) {
    const n = e.stack, i = f2(n, jt.__wbindgen_malloc, jt.__wbindgen_realloc), a = ys;
    Sc().setInt32(t + 4 * 1, a, true), Sc().setInt32(t + 4 * 0, i, true);
  }
  function Hz(t, e) {
    const n = e, i = typeof n == "string" ? n : void 0;
    var a = Oz(i) ? 0 : f2(i, jt.__wbindgen_malloc, jt.__wbindgen_realloc), r = ys;
  ...
  const c_ = [
    ...
    const n = 44032, i = 55203, a = 588, r = 28, s = /* @__PURE__ */ new Set(), l = /* @__PURE__ */ new Set(), u = /* @__PURE__ */ new Set();
    for (const c of e) {
      ...
      } else c_.includes(c) ? s.add(c) : f_.includes(c) ? l.add(c) : h_.includes(c) && u.add(c);
    }
    t.update_char_sets(Array.from(s), Array.from(l), Array.from(u));
  };
  async function a5() {
  ...
  async function d2(t, e) {
    try {
      t.srcObject instanceof MediaStream && t.srcObject.getTracks().forEach((i) => i.stop()), t.srcObject = null, t.src = "", t.load();
      const n = await e;
  ...
  function o5(t, e, n, i) {
    ...
    const l = e.get_consonant_grid_ptr(), u = e.get_vowel_grid_ptr(), c = e.get_syllable_grid_ptr(), f = new Uint16Array(Wa.buffer, l, a * r), d = new Uint16Array(Wa.buffer, u, a * r), m = new Uint16Array(Wa.buffer, c, a * r);
    for (let y = 0; y < m.length; y++) {
  ...
  (function() {
    ...
    var n = typeof Object.defineProperties == "function" ? Object.defineProperty : function(o, h, p) {
      return o == Array.prototype || o == Object.prototype || (o[h] = p.value), o;
    };
    function i(o) {
      o = [
    ...
    function r(o, h) {
      if (h) t: {
        ...
        o = o[o.length - 1], _ = p[o], h = h(_), h != _ && h != null && n(p, o, {
          configurable: true,
          writable: true,
          value: h
        });
    ...
    r("Symbol", function(o) {
      ...
      for (var h = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), p = 0; p < h.length; p++) {
        var _ = a[h[p]];
        typeof _ == "function" && typeof _.prototype[o] != "function" && n(_.prototype, o, {
          configurable: true,
          writable: true,
          value: function() {
            return s(e(this));
    ...
    function l(o) {
      var h = typeof Symbol < "u" && Symbol.iterator && o[Symbol.iterator];
      return h ? h.call(o) : {
        next: e(o)
      };
    }
    function u(o) {
      if (!(o instanceof Array)) {
        o = l(o);
        for (var h, p = []; !(h = o.next()).done; ) p.push(h.value);
        o = p;
      }
      return o;
    }
    var c = typeof Object.assign == "function" ? Object.assign : function(o, h) {
      for (var p = 1; p < arguments.length; p++) {
        var _ = arguments[p];
        if (_) for (var E in _) Object.prototype.hasOwnProperty.call(_, E) && (o[E] = _[E]);
      }
      return o;
    };
    ...
    var f = typeof Object.create == "function" ? Object.create : function(o) {
      function h() {
      }
      return h.prototype = o, new h();
    }, d;
    if (typeof Object.setPrototypeOf == "function") d = Object.setPrototypeOf;
      ...
      d = m ? function(o, h) {
        if (o.__proto__ = h, o.__proto__ !== h) throw new TypeError(o + " is not extensible");
        return o;
      } : null;
    }
    var b = d;
    function x(o, h) {
      if (o.prototype = f(h.prototype), o.prototype.constructor = o, b) b(o, h);
      else for (var p in h) if (p != "prototype") if (Object.defineProperties) {
        var _ = Object.getOwnPropertyDescriptor(h, p);
        _ && Object.defineProperty(o, p, _);
      } else o[p] = h[p];
      o.za = h.prototype;
    }
    function v() {
    ...
    function w(o) {
      this.h = new v(), this.i = o;
    }
    function V(o, h) {
      g(o.h);
      var p = o.h.j;
      return p ? z(o, "return" in p ? p.return : function(_) {
        return {
          value: _,
          done: true
        };
      }, h, o.h.return) : (o.h.return(h), O(o));
    }
    function z(o, h, p, _) {
      try {
        var E = h.call(o.h.j, p);
        if (!(E instanceof Object)) throw new TypeError("Iterator result " + E + " is not an object");
        if (!E.done) return o.h.m = false, E;
        var C = E.value;
      } catch (M) {
        return o.h.j = null, S(o.h, M), O(o);
      }
      return o.h.j = null, _.call(o.h, C), O(o);
    }
    function O(o) {
      for (; o.h.h; ) try {
        var h = o.i(o.h);
        if (h) return o.h.m = false, {
          value: h.value,
          done: false
        };
      } catch (p) {
        o.h.i = void 0, S(o.h, p);
      }
      if (o.h.m = false, o.h.l) {
        if (h = o.h.l, o.h.l = null, h.na) throw h.ma;
        return {
          value: h.return,
          done: true
        };
    ...
    function U(o) {
      this.next = function(h) {
        return g(o.h), o.h.j ? h = z(o, o.h.j.next, h, o.h.u) : (o.h.u(h), h = O(o)), h;
      }, this.throw = function(h) {
        return g(o.h), o.h.j ? h = z(o, o.h.j.throw, h, o.h.u) : (S(o.h, h), h = O(o)), h;
    ...
    r("Promise", function(o) {
      ...
      return h.prototype.L = function(M) {
        ...
        var H, k, W = new h(function(Z, q) {
          H = Z, k = q;
        });
        return this.T(L(M, H), L(R, k)), W;
        ...
        return new h(function(R, L) {
          for (var H = l(M), k = H.next(); !k.done; k = H.next()) _(k.value).T(R, L);
        });
      }, h.all = function(M) {
        var R = l(M), L = R.next();
        return L.done ? _([]) : new h(function(H, k) {
          function W(I) {
            return function(rt) {
              Z[I] = rt, q--, q == 0 && H(Z);
            };
          ...
          var Z = [], q = 0;
          do
            Z.push(void 0), q++, _(L.value).T(W(Z.length - 1), k), L = R.next();
          while (!L.done);
        });
      }, h;
    });
    ...
    r("Array.prototype.keys", function(o) {
      return o || function() {
        return F(this, function(h) {
          return h;
        });
      };
    }), r("Array.prototype.fill", function(o) {
      return o || function(h, p, _) {
        var E = this.length || 0;
    ...
    r("Int8Array.prototype.fill", X), r("Uint8Array.prototype.fill", X), r("Uint8ClampedArray.prototype.fill", X), r("Int16Array.prototype.fill", X), r("Uint16Array.prototype.fill", X), r("Int32Array.prototype.fill", X), r("Uint32Array.prototype.fill", X), r("Float32Array.prototype.fill", X), r("Float64Array.prototype.fill", X), r("Object.is", function(o) {
      return o || function(h, p) {
        return h === p ? h !== 0 || 1 / h === 1 / p : h !== h && p !== p;
      };
    }), r("Array.prototype.includes", function(o) {
      return o || function(h, p) {
        var _ = this;
    ...
    }), r("String.prototype.includes", function(o) {
      return o || function(h, p) {
    ...
    function K(o, h) {
      o = o.split(".");
      var p = $;
      o[0] in p || typeof p.execScript > "u" || p.execScript("var " + o[0]);
      for (var _; o.length && (_ = o.shift()); ) o.length || h === void 0 ? p[_] && p[_] !== Object.prototype[_] ? p = p[_] : p = p[_] = {} : p[_] = h;
    }
    function N(o) {
      var h;
      t: {
    ...
    var P = Array.prototype.map ? function(o, h) {
      return Array.prototype.map.call(o, h, void 0);
    } : function(o, h) {
      for (var p = o.length, _ = Array(p), E = typeof o == "string" ? o.split("") : o, C = 0; C < p; C++) C in E && (_[C] = h.call(void 0, E[C], C, o));
      return _;
    }, G = {}, Q = null;
    function it(o) {
      var h = o.length, p = 3 * h / 4;
      p % 3 ? p = Math.floor(p) : "=.".indexOf(o[h - 1]) != -1 && (p = "=.".indexOf(o[h - 2]) != -1 ? p - 2 : p - 1);
      var _ = new Uint8Array(p), E = 0;
      return Pt(o, function(C) {
        _[E++] = C;
    ...
    function Kt() {
      if (!Q) {
        Q = {};
        for (var o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""), h = [
          "+/=",
          "+/",
          "-_=",
          "-_.",
    ...
    function pe(o) {
      if (!Nt) {
        ...
        for (var p = Array(Math.floor(o.length / 3)), _ = h[64] || "", E = 0, C = 0; E < o.length - 2; E += 3) {
          var M = o[E], R = o[E + 1], L = o[E + 2], H = h[M >> 2];
          M = h[(M & 3) << 4 | R >> 4], R = h[(R & 15) << 2 | L >> 6], L = h[L & 63], p[C++] = H + M + R + L;
        }
        switch (H = 0, L = _, o.length - E) {
          case 2:
            H = o[E + 1], L = h[(H & 15) << 2] || _;
          case 1:
            o = o[E], p[C] = h[o >> 2] + h[(o & 3) << 4 | H >> 4] + L + _;
        }
        return p.join("");
      }
      for (h = ""; 10240 < o.length; ) h += String.fromCharCode.apply(null, o.subarray(0, 10240)), o = o.subarray(10240);
      return h += String.fromCharCode.apply(null, o), btoa(h);
    }
    var Ta = RegExp("[-_.]", "g");
    function Jc(o) {
      switch (o) {
    ...
    function Eo(o) {
      if (!Nt) return it(o);
      Ta.test(o) && (o = o.replace(Ta, Jc)), o = atob(o);
      for (var h = new Uint8Array(o.length), p = 0; p < o.length; p++) h[p] = o.charCodeAt(p);
      return h;
    }
    var Rs;
    function Os() {
    ...
    function Qt(o) {
      ...
      o = Math.abs(o);
      var p = o >>> 0;
      o = Math.floor((o - p) / 4294967296), h && (p = l(pt(p, o)), h = p.next().value, o = p.next().value, p = h), ft = p >>> 0, Mt = o >>> 0;
    }
    var ee = typeof BigInt == "function";
    function pt(o, h) {
      return h = ~h, o ? o = ~o + 1 : h += 1, [
        o,
        h
      ];
    }
    function mn(o, h) {
      this.i = o >>> 0, this.h = h >>> 0;
    }
    function we(o) {
      if (!o) return Re || (Re = new mn(0, 0));
      if (!/^-?\d+$/.test(o)) return null;
      if (16 > o.length) Qt(Number(o));
      else if (ee) o = BigInt(o), ft = Number(o & BigInt(4294967295)) >>> 0, Mt = Number(o >> BigInt(32) & BigInt(4294967295));
      else {
        var h = +(o[0] === "-");
        Mt = ft = 0;
        for (var p = o.length, _ = h, E = (p - h) % 6 + h; E <= p; _ = E, E += 6) _ = Number(o.slice(_, E)), Mt *= 1e6, ft = 1e6 * ft + _, 4294967296 <= ft && (Mt += ft / 4294967296 | 0, ft %= 4294967296);
        h && (h = l(pt(ft, Mt)), o = h.next().value, h = h.next().value, ft = o, Mt = h);
      }
      return new mn(ft, Mt);
    }
    var Re;
    function ai(o, h) {
      return Error("Invalid wire type: " + o + " (at position " + h + ")");
    }
    function vt() {
      return Error("Failed to read varint, encoding is invalid.");
    }
    function Vi(o, h) {
      return Error("Tried to read past the end of the data " + h + " > " + o);
    }
    function Aa() {
      throw Error("Invalid UTF8");
    }
    function hy(o, h) {
      return h = String.fromCharCode.apply(null, h), o == null ? h : o + h;
    }
    var wo = void 0, $c, v2 = typeof TextDecoder < "u", dy, _2 = typeof TextEncoder < "u", my;
    function py(o) {
      if (o !== xa) throw Error("illegal external caller");
    }
    function zs(o, h) {
      if (py(h), this.V = o, o != null && o.length === 0) throw Error("ByteString should be constructed with non-empty values");
    }
    function Wc() {
    ...
    function yy(o) {
      py(xa);
      var h = o.V;
      return h = h == null || te && h != null && h instanceof Uint8Array ? h : typeof h == "string" ? Eo(h) : null, h == null ? h : o.V = h;
    }
    function b2(o) {
      ...
      if (o.constructor === Uint8Array) return {
        buffer: o,
        C: false
      };
      if (o.constructor === ArrayBuffer) return {
        buffer: new Uint8Array(o),
        C: false
      };
      if (o.constructor === zs) return {
        buffer: yy(o) || Os(),
        C: true
      };
      if (o instanceof Uint8Array) return {
    ...
    function gy(o, h) {
      this.i = null, this.m = false, this.h = this.j = this.l = 0, Ic(this, o, h);
    }
    function Ic(o, h, p) {
      p = p === void 0 ? {} : p, o.S = p.S === void 0 ? false : p.S, h && (h = b2(h), o.i = h.buffer, o.m = h.C, o.l = 0, o.j = o.i.length, o.h = o.l);
    }
    gy.prototype.reset = function() {
      this.h = this.l;
    };
    function Ea(o, h) {
      if (o.h = h, h > o.j) throw Vi(o.j, h);
    }
    function Us(o) {
      var h = o.i, p = o.h, _ = h[p++], E = _ & 127;
    ...
    function by(o, h, p) {
      for (; 0 < p || 127 < h; ) o.h.push(h & 127 | 128), h = (h >>> 7 | p << 25) >>> 0, p >>>= 7;
      o.h.push(h);
    }
    function wa(o, h) {
      for (; 127 < h; ) o.h.push(h & 127 | 128), h >>>= 7;
      o.h.push(h);
    }
    function ef(o, h) {
      if (_y.length) {
      ...
      this.h = o, this.j = this.h.h, this.i = this.l = -1, this.setOptions(h);
    }
    ef.prototype.setOptions = function(o) {
      o = o === void 0 ? {} : o, this.ca = o.ca === void 0 ? false : o.ca;
    ...
    function Sy(o) {
      ...
      o.j = o.h.h;
      var p = Us(o.h) >>> 0;
      if (h = p >>> 3, p &= 7, !(0 <= p && 5 >= p)) throw ai(p, o.j);
      if (1 > h) throw Error("Invalid field number: " + h + " (at position " + o.j + ")");
      return o.l = h, o.i = p, true;
    }
    function Mo(o) {
      switch (o.i) {
        case 0:
          if (o.i != 0) Mo(o);
            ...
            o = o.h;
            for (var h = o.h, p = h + 10, _ = o.i; h < p; ) if (!(_[h++] & 128)) {
              Ea(o, h);
              break t;
            }
            throw vt();
        ...
        case 1:
          ...
          break;
        case 2:
          o.i != 2 ? Mo(o) : (h = Us(o.h) >>> 0, o = o.h, Ea(o, o.h + h));
          break;
        case 5:
          o = o.h, Ea(o, o.h + 4);
          break;
        case 3:
          h = o.l;
          do {
            if (!Sy(o)) throw Error("Unmatched start-group tag: stream EOF");
            if (o.i == 4) {
              if (o.l != h) throw Error("Unmatched end-group tag");
              break;
            }
            Mo(o);
          } while (true);
    ...
    function hr(o, h) {
      h.length !== 0 && (o.j.push(h), o.i += h.length);
    }
    function T2(o, h) {
      if (h = h.R) {
        hr(o, o.h.end());
        for (var p = 0; p < h.length; p++) hr(o, yy(h[p]) || Os());
      }
    }
    var ri = typeof Symbol == "function" && typeof Symbol() == "symbol" ? Symbol() : void 0;
    function Ma(o, h) {
      return ri ? o[ri] |= h : o.A !== void 0 ? o.A |= h : (Object.defineProperties(o, {
        A: {
          value: h,
          configurable: true,
          writable: true,
    ...
    function Ty(o, h) {
      ri ? o[ri] && (o[ri] &= ~h) : o.A !== void 0 && (o.A &= ~h);
    }
    function Zt(o) {
      var h;
      return ri ? h = o[ri] : h = o.A, h ?? 0;
    }
    function Yn(o, h) {
      ri ? o[ri] = h : o.A !== void 0 ? o.A = h : Object.defineProperties(o, {
        A: {
          value: h,
          configurable: true,
          writable: true,
    ...
    var af = {};
    function Ro(o) {
      return o !== null && typeof o == "object" && !Array.isArray(o) && o.constructor === Object;
    }
    var Vs, xy = [];
    Yn(xy, 23), Vs = Object.freeze(xy);
    function rf(o) {
      if (Zt(o.o) & 2) throw Error("Cannot mutate an immutable Message");
    }
    function sf(o) {
      var h = o.length;
      (h = h ? o[h - 1] : void 0) && Ro(h) ? h.g = 1 : (h = {}, o.push((h.g = 1, h)));
    }
    function Ay(o) {
      var h = o.i + o.G;
      return o.B || (o.B = o.o[h] = {});
    }
    function Vn(o, h) {
      return h === -1 ? null : h >= o.i ? o.B ? o.B[h] : void 0 : o.o[h + o.G];
    }
    function Gn(o, h, p, _) {
      rf(o), Ls(o, h, p, _);
    }
    function Ls(o, h, p, _) {
      o.j && (o.j = void 0), h >= o.i || _ ? Ay(o)[h] = p : (o.o[h + o.G] = p, (o = o.B) && h in o && delete o[h]);
    }
    function lf(o, h, p, _) {
      var E = Vn(o, h);
      ...
      if (C & 1 || nf(E), _) C & 2 || Ma(E, 2), p & 1 || Object.freeze(E);
        ...
        _ = !(p & 2);
        var M = C & 2;
        p & 1 || !M ? _ && C & 16 && !M && Ty(E, 16) : (E = nf(Array.prototype.slice.call(E)), Ls(o, h, E));
      }
      return E;
    }
    function of(o, h) {
      var p = Vn(o, h), _ = p == null ? p : typeof p == "number" || p === "NaN" || p === "Infinity" || p === "-Infinity" ? Number(p) : void 0;
      return _ != null && _ !== p && Ls(o, h, _), _;
    }
    function Ey(o, h, p, _, E) {
      o.h || (o.h = {});
      var C = o.h[p], M = lf(o, p, 3, E);
      if (!C) {
        var R = M;
        C = [];
        var L = !!(Zt(o.o) & 16);
        ...
        for (var k = M, W = 0; W < R.length; W++) {
          var Z = R[W], q = h, I = false;
          if (I = I === void 0 ? false : I, Z = Array.isArray(Z) ? new q(Z) : I ? new q() : void 0, Z !== void 0) {
            q = Z.o;
            var rt = I = Zt(q);
            M && (rt |= 2), L && (rt |= 16), rt != I && Yn(q, rt), q = rt, k = k || !!(2 & q), C.push(Z);
          }
        }
        return o.h[p] = C, L = Zt(R), h = L | 33, h = k ? h & -9 : h | 8, L != h && (k = R, Object.isFrozen(k) && (k = Array.prototype.slice.call(k)), Yn(k, h), R = k), H !== R && Ls(o, p, R), (E || _ && M) && Ma(C, 2), _ && Object.freeze(C), C;
      }
      return E || (E = Object.isFrozen(C), _ && !E ? Object.freeze(C) : !_ && E && (C = Array.prototype.slice.call(C), o.h[p] = C)), C;
    }
    function uf(o, h, p) {
      var _ = !!(Zt(o.o) & 2);
      if (h = Ey(o, h, p, _, _), o = lf(o, p, 3, _), !(_ || Zt(o) & 8)) {
    ...
    function wy(o, h, p, _, E) {
      rf(o);
      var C = Ey(o, p, h, false, false);
      return p = _ ?? new p(), o = lf(o, h, 2, false), E != null ? (C.splice(E, 0, p), o.splice(E, 0, p.o)) : (C.push(p), o.push(p.o)), p.C() && Ty(o, 8), p;
    }
    function Oo(o, h) {
      return o ?? h;
    }
    function Xn(o, h, p) {
      return p = p === void 0 ? 0 : p, Oo(of(o, h), p);
    }
    var zo;
    function A2(o) {
      switch (typeof o) {
        ...
        case "object":
          if (o) if (Array.isArray(o)) {
            if (Zt(o) & 128) return o = Array.prototype.slice.call(o), sf(o), o;
          } else {
            if (te && o != null && o instanceof Uint8Array) return pe(o);
            if (o instanceof zs) {
              var h = o.V;
              return h == null ? "" : typeof h == "string" ? h : o.V = pe(h);
            }
          }
      }
      return o;
    ...
    function My(o, h, p, _) {
      if (o != null) {
        if (Array.isArray(o)) o = cf(o, h, p, _ !== void 0);
        else if (Ro(o)) {
          var E = {}, C;
          for (C in o) E[C] = My(o[C], h, p, _);
          o = E;
        } else o = h(o, _);
        return o;
      }
    ...
    function cf(o, h, p, _) {
      var E = Zt(o);
      _ = _ ? !!(E & 16) : void 0, o = Array.prototype.slice.call(o);
      for (var C = 0; C < o.length; C++) o[C] = My(o[C], h, p, _);
      return p(E, o), o;
    }
    function E2(o) {
      return o.ja === af ? o.toJSON() : A2(o);
    }
    function w2(o, h) {
      o & 128 && sf(h);
    }
    function Cy(o, h, p) {
      if (p = p === void 0 ? Do : p, o != null) {
        if (te && o instanceof Uint8Array) return o.length ? new zs(new Uint8Array(o), xa) : Wc();
        if (Array.isArray(o)) {
          var _ = Zt(o);
          return _ & 2 ? o : h && !(_ & 32) && (_ & 16 || _ === 0) ? (Yn(o, _ | 2), o) : (o = cf(o, Cy, _ & 4 ? Do : p, true), h = Zt(o), h & 4 && h & 2 && Object.freeze(o), o);
        }
        return o.ja === af ? Ry(o) : o;
      }
    }
    function Dy(o, h, p, _, E, C, M) {
      if (o = o.h && o.h[p]) {
        if (_ = Zt(o), _ & 2 ? _ = o : (C = P(o, Ry), Do(_, C), Object.freeze(C), _ = C), rf(h), M = _ == null ? Vs : nf([]), _ != null) {
          for (C = !!_.length, o = 0; o < _.length; o++) {
            var R = _[o];
            C = C && !(Zt(R.o) & 2), M[o] = R.o;
          }
          C = (C ? 8 : 0) | 1, o = Zt(M), (o & C) !== C && (Object.isFrozen(M) && (M = Array.prototype.slice.call(M)), Yn(M, o | C)), h.h || (h.h = {}), h.h[p] = _;
        } else h.h && (h.h[p] = void 0);
        Ls(h, p, M, E);
      } else Gn(h, p, Cy(_, C, M), E);
    }
    function Ry(o) {
      return Zt(o.o) & 2 || (o = Oy(o, true), Ma(o.o, 2)), o;
    }
    function Oy(o, h) {
      var p = o.o, _ = [];
      Ma(_, 16);
      var E = o.constructor.h;
      if (E && _.push(E), E = o.B, E) {
        _.length = p.length, _.fill(void 0, _.length, p.length);
        var C = {};
        _[_.length - 1] = C;
      }
      Zt(p) & 128 && sf(_), h = h || o.C() ? Do : x2, C = o.constructor, zo = _, _ = new C(_), zo = void 0, o.R && (_.R = o.R.slice()), C = !!(Zt(p) & 16);
      for (var M = E ? p.length - 1 : p.length, R = 0; R < M; R++) Dy(o, _, R - o.G, p[R], false, C, h);
      if (E) for (var L in E) Dy(o, _, +L, E[L], true, C, h);
      return _;
    }
    function Ne(o, h, p) {
      o == null && (o = zo), zo = void 0;
      ...
      if (o == null) {
        ...
        if (!Array.isArray(o) || C && C !== o[0]) throw Error();
        var H = R = Ma(o, 0);
      ...
      this.G = (C ? 0 : -1) - _, this.h = void 0, this.o = o;
      t: {
      ...
      if (p) {
        h = L && !M && true, E = this.i;
        var q;
        for (L = 0; L < p.length; L++) M = p[L], M < E ? (M += this.G, (_ = o[M]) ? zy(_, h) : o[M] = Vs) : (q || (q = Ay(this)), (_ = q[M]) ? zy(_, h) : q[M] = Vs);
      }
    }
      ...
      if (p) {
        ...
        for (E in p) {
          ...
          M || (_.J = C.xa || C.oa.W, C.ia ? (_.aa = By(C.ia), M = /* @__PURE__ */ function(R) {
            return function(L, H, k) {
              return R.J(L, H, k, R.aa);
            };
          }(_)) : C.ka ? (_.Z = Hy(C.da.P, C.ka), M = /* @__PURE__ */ function(R) {
            return function(L, H, k) {
              return R.J(L, H, k, R.Z);
            };
          }(_)) : M = _.J, C.ra = M), M(h, o, C.da), _ = {
            J: _.J,
            aa: _.aa,
            Z: _.Z
          };
    ...
    function M2(o) {
      var h = o.ia;
      if (h) return Ly(h);
      if (h = o.wa) return Vy(o.da.P, h, o.ka);
    }
    function C2(o) {
      var h = M2(o), p = o.da, _ = o.oa.U;
    ...
    function Ny(o, h) {
      var p = o[h];
      return typeof p == "function" && p.length === 0 && (p = p(), o[h] = p), Array.isArray(p) && (js in p || Ns in p || 0 < p.length && typeof p[0] == "function") ? p : void 0;
    }
    function jy(o, h, p, _, E, C) {
      h.P = o[0];
      var M = 1;
      if (o.length > M && typeof o[M] != "number") {
        var R = o[M++];
        p(h, R);
      }
      for (; M < o.length; ) {
        p = o[M++];
        for (var L = M + 1; L < o.length && typeof o[L] != "number"; ) L++;
        switch (R = o[M++], L -= M, L) {
          case 0:
            _(h, p, R);
            break;
          case 1:
            (L = Ny(o, M)) ? (M++, E(h, p, R, L)) : _(h, p, R, o[M++]);
            break;
          case 2:
            L = M++, L = Ny(o, L), E(h, p, R, L, o[M++]);
            break;
          case 3:
            C(h, p, R, o[M++], o[M++], o[M++]);
            break;
          case 4:
            C(h, p, R, o[M++], o[M++], o[M++], o[M++]);
            break;
          default:
    ...
    function O2(o, h, p, _) {
      ...
      o.push(h, function(R, L, H) {
        return M(R, L, H, C, E);
      });
    }
    function z2(o, h, p, _, E, C) {
      var M = Hy(_, C), R = p.W;
      o.push(h, function(L, H, k) {
        return R(L, H, k, _, M);
      });
    }
    function ff(o) {
      var h = o[Ns];
      return h || (h = jy(o, o[Ns] = [], D2, R2, O2, z2), js in o && Ns in o && (o.length = 0), h);
    }
    var js = Symbol();
    function U2(o, h) {
      o[0] = h;
    ...
    function V2(o, h, p, _) {
      var E = p.U;
      o[h] = _ ? function(C, M, R) {
        return E(C, M, R, _);
      } : E;
    }
    function L2(o, h, p, _, E) {
      var C = p.U, M = Ly(_), R = hf(_).P;
      o[h] = function(L, H, k) {
        return C(L, H, k, R, M, E);
      };
    }
    function N2(o, h, p, _, E, C, M) {
      var R = p.U, L = Vy(_, E, C);
      o[h] = function(H, k, W) {
        return R(H, k, W, _, L, M);
      };
    }
    function hf(o) {
      var h = o[js];
      return h || (h = jy(o, o[js] = {}, U2, V2, L2, N2), js in o && Ns in o && (o.length = 0), h);
    }
    function Yy(o, h, p) {
      for (; Sy(h) && h.i != 4; ) {
        var _ = h.l, E = p[_];
    ...
    function Gy(o, h, p) {
      for (var _ = p.length, E = _ % 2 == 1, C = E ? 1 : 0; C < _; C += 2) (0, p[C + 1])(h, o, p[C]);
      Uy(o, h, E ? p[0] : void 0);
    }
    function Bs(o, h) {
      return {
    ...
    var Ln = Bs(function(o, h, p) {
      if (o.i !== 5) return false;
      o = o.h;
      var _ = o.i, E = o.h, C = _[E], M = _[E + 1], R = _[E + 2];
      return _ = _[E + 3], Ea(o, o.h + 4), M = (C << 0 | M << 8 | R << 16 | _ << 24) >>> 0, o = 2 * (M >> 31) + 1, C = M >>> 23 & 255, M &= 8388607, Gn(h, p, C == 255 ? M ? NaN : 1 / 0 * o : C == 0 ? o * Math.pow(2, -149) * M : o * Math.pow(2, C - 150) * (M + Math.pow(2, 23))), true;
    }, function(o, h, p) {
      if (h = of(h, p), h != null) {
        wa(o.h, 8 * p + 5), o = o.h;
        var _ = +h;
        _ === 0 ? 0 < 1 / _ ? ft = Mt = 0 : (Mt = 0, ft = 2147483648) : isNaN(_) ? (Mt = 0, ft = 2147483647) : (_ = (p = 0 > _ ? -2147483648 : 0) ? -_ : _, 34028234663852886e22 < _ ? (Mt = 0, ft = (p | 2139095040) >>> 0) : 11754943508222875e-54 > _ ? (_ = Math.round(_ / Math.pow(2, -149)), Mt = 0, ft = (p | _) >>> 0) : (h = Math.floor(Math.log(_) / Math.LN2), _ *= Math.pow(2, -h), _ = Math.round(8388608 * _), 16777216 <= _ && ++h, Mt = 0, ft = (p | h + 127 << 23 | _ & 8388607) >>> 0)), p = ft, o.h.push(p >>> 0 & 255), o.h.push(p >>> 8 & 255), o.h.push(p >>> 16 & 255), o.h.push(p >>> 24 & 255);
      }
    }), j2 = Bs(function(o, h, p) {
      if (o.i !== 0) return false;
      var _ = o.h, E = 0, C = o = 0, M = _.i, R = _.h;
      do {
        var L = M[R++];
        E |= (L & 127) << C, C += 7;
      } while (32 > C && L & 128);
      for (32 < C && (o |= (L & 127) >> 4), C = 3; 32 > C && L & 128; C += 7) L = M[R++], o |= (L & 127) << C;
      if (Ea(_, R), 128 > L) _ = E >>> 0, L = o >>> 0, (o = L & 2147483648) && (_ = ~_ + 1 >>> 0, L = ~L >>> 0, _ == 0 && (L = L + 1 >>> 0)), _ = 4294967296 * L + (_ >>> 0);
      else throw vt();
      return Gn(h, p, o ? -_ : _), true;
    }, function(o, h, p) {
      h = Vn(h, p), h != null && (typeof h == "string" && we(h), h != null && (wa(o.h, 8 * p), typeof h == "number" ? (o = o.h, Qt(h), by(o, ft, Mt)) : (p = we(h), by(o.h, p.i, p.h))));
    }), B2 = Bs(function(o, h, p) {
      return o.i !== 0 ? false : (Gn(h, p, Us(o.h)), true);
    }, function(o, h, p) {
      if (h = Vn(h, p), h != null && h != null) if (wa(o.h, 8 * p), o = o.h, p = h, 0 <= p) wa(o, p);
      else {
        for (h = 0; 9 > h; h++) o.h.push(p & 127 | 128), p >>= 7;
        o.h.push(1);
      }
    }), Py = Bs(function(o, h, p) {
      ...
      if (o = o.i, v2) {
        ...
        (M = $c) || (M = $c = new TextDecoder("utf-8", {
          fatal: true
        })), o = E + _, C = E === 0 && o === C.length ? C : C.subarray(E, o);
        try {
          var R = M.decode(C);
        } catch (W) {
          if (wo === void 0) {
        ...
        R = E, _ = R + _, E = [];
        for (var L = null, H, k; R < _; ) H = o[R++], 128 > H ? E.push(H) : 224 > H ? R >= _ ? Aa() : (k = o[R++], 194 > H || (k & 192) !== 128 ? (R--, Aa()) : E.push((H & 31) << 6 | k & 63)) : 240 > H ? R >= _ - 1 ? Aa() : (k = o[R++], (k & 192) !== 128 || H === 224 && 160 > k || H === 237 && 160 <= k || ((C = o[R++]) & 192) !== 128 ? (R--, Aa()) : E.push((H & 15) << 12 | (k & 63) << 6 | C & 63)) : 244 >= H ? R >= _ - 2 ? Aa() : (k = o[R++], (k & 192) !== 128 || (H << 28) + (k - 144) >> 30 || ((C = o[R++]) & 192) !== 128 || ((M = o[R++]) & 192) !== 128 ? (R--, Aa()) : (H = (H & 7) << 18 | (k & 63) << 12 | (C & 63) << 6 | M & 63, H -= 65536, E.push((H >> 10 & 1023) + 55296, (H & 1023) + 56320))) : Aa(), 8192 <= E.length && (L = hy(L, E), E.length = 0);
        R = hy(L, E);
      }
      return Gn(h, p, R), true;
    }, function(o, h, p) {
      if (h = Vn(h, p), h != null) {
        var _ = false;
        ...
        wa(o.h, 8 * p + 2), wa(o.h, h.length), hr(o, o.h.end()), hr(o, h);
      }
    }), Xy = Bs(function(o, h, p, _, E) {
      if (o.i !== 2) return false;
      h = wy(h, p, _), p = o.h.j, _ = Us(o.h) >>> 0;
      var C = o.h.h + _, M = C - p;
      if (0 >= M && (o.h.j = C, E(h, o, void 0, void 0, void 0), M = C - o.h.h), M) throw Error("Message parsing ended unexpectedly. Expected to read " + (_ + " bytes, instead read " + (_ - M) + " bytes, either the data ended unexpectedly or the message misreported its own length"));
      return o.h.h = C, o.h.j = p, true;
    }, function(o, h, p, _, E) {
      if (h = uf(h, _, p), h != null) for (_ = 0; _ < h.length; _++) {
        var C = o;
        wa(C.h, 8 * p + 2);
        var M = C.h.end();
        hr(C, M), M.push(C.i), C = M, E(h[_], o), M = o;
        var R = C.pop();
    ...
    dr.prototype.l = mf(ky);
    function pf(o) {
      Ne.call(this, o, -1, H2);
    }
    x(pf, Ne), pf.prototype.addClassification = function(o, h) {
      return wy(this, 1, dr, o, h), this;
    };
    var H2 = [
      1
    ], Y2 = df([
    ...
    function Qy(o, h, p) {
      if (p = o.createShader(p === 0 ? o.VERTEX_SHADER : o.FRAGMENT_SHADER), o.shaderSource(p, h), o.compileShader(p), !o.getShaderParameter(p, o.COMPILE_STATUS)) throw Error(`Could not compile WebGL shader.

` + o.getShaderInfoLog(p));
      return p;
    }
    function k2(o) {
      return uf(o, dr, 1).map(function(h) {
        var p = Vn(h, 1);
        return {
          index: p ?? 0,
          qa: Xn(h, 2),
    ...
    function q2(o) {
      return {
        ...
        y: Xn(o, 2),
        z: Xn(o, 3),
        visibility: of(o, 4) != null ? Xn(o, 4) : void 0
      };
    }
    function yf(o, h) {
      this.i = o, this.h = h, this.m = 0;
    }
    function Zy(o, h, p) {
      return F2(o, h), typeof o.h.canvas.transferToImageBitmap == "function" ? Promise.resolve(o.h.canvas.transferToImageBitmap()) : p ? Promise.resolve(o.h.canvas) : typeof createImageBitmap == "function" ? createImageBitmap(o.h.canvas) : (o.j === void 0 && (o.j = document.createElement("canvas")), new Promise(function(_) {
        o.j.height = o.h.canvas.height, o.j.width = o.h.canvas.width, o.j.getContext("2d", {}).drawImage(o.h.canvas, 0, 0, o.h.canvas.width, o.h.canvas.height), _(o.j);
      }));
    }
    function F2(o, h) {
      var p = o.h;
...
` + p.getProgramInfoLog(C));
        _ = o.s = C, p.useProgram(_), E = p.getUniformLocation(_, "sampler0"), o.l = {
          O: p.getAttribLocation(_, "aVertex"),
          N: p.getAttribLocation(_, "aTex"),
          ya: E
        }, o.v = p.createBuffer(), p.bindBuffer(p.ARRAY_BUFFER, o.v), p.enableVertexAttribArray(o.l.O), p.vertexAttribPointer(o.l.O, 2, p.FLOAT, false, 0, 0), p.bufferData(p.ARRAY_BUFFER, new Float32Array([
          -1,
          -1,
          -1,
          1,
          ...
          1,
          -1
        ]), p.STATIC_DRAW), p.bindBuffer(p.ARRAY_BUFFER, null), o.u = p.createBuffer(), p.bindBuffer(p.ARRAY_BUFFER, o.u), p.enableVertexAttribArray(o.l.N), p.vertexAttribPointer(o.l.N, 2, p.FLOAT, false, 0, 0), p.bufferData(p.ARRAY_BUFFER, new Float32Array([
          0,
          1,
          0,
          0,
      ...
      _ = o.l, p.useProgram(o.s), p.canvas.width = h.width, p.canvas.height = h.height, p.viewport(0, 0, h.width, h.height), p.activeTexture(p.TEXTURE0), o.i.bindTexture2d(h.glName), p.enableVertexAttribArray(_.O), p.bindBuffer(p.ARRAY_BUFFER, o.v), p.vertexAttribPointer(_.O, 2, p.FLOAT, false, 0, 0), p.enableVertexAttribArray(_.N), p.bindBuffer(p.ARRAY_BUFFER, o.u), p.vertexAttribPointer(_.N, 2, p.FLOAT, false, 0, 0), p.bindFramebuffer(p.DRAW_FRAMEBUFFER ? p.DRAW_FRAMEBUFFER : p.FRAMEBUFFER, null), p.clearColor(0, 0, 0, 0), p.clear(p.COLOR_BUFFER_BIT), p.colorMask(true, true, true, true), p.drawArrays(p.TRIANGLE_FAN, 0, 4), p.disableVertexAttribArray(_.O), p.disableVertexAttribArray(_.N), p.bindBuffer(p.ARRAY_BUFFER, null), o.i.bindTexture2d(0);
    }
    function K2(o) {
      this.h = o;
    }
    ...
    function J2(o) {
      ...
      return h.setAttribute("src", o), h.setAttribute("crossorigin", "anonymous"), new Promise(function(p) {
    ...
    function $2() {
      return Y(function(o) {
        switch (o.h) {
          case 1:
            return o.s = 2, A(o, WebAssembly.instantiate(Q2), 4);
          case 4:
            o.h = 3, o.s = 0;
            break;
          case 2:
            return o.s = 0, o.l = null, o.return(false);
          case 3:
    ...
    function gf(o) {
      if (this.h = o, this.listeners = {}, this.l = {}, this.L = {}, this.s = {}, this.v = {}, this.M = this.u = this.ga = true, this.I = Promise.resolve(), this.fa = "", this.D = {}, this.locateFile = o && o.locateFile || Z2, typeof window == "object") var h = window.location.pathname.toString().substring(0, window.location.pathname.toString().lastIndexOf("/")) + "/";
      ...
      if (this.ha = h, o.options) {
        h = l(Object.keys(o.options));
        for (var p = h.next(); !p.done; p = h.next()) {
          p = p.value;
          var _ = o.options[p].default;
    ...
    function W2(o) {
      var h, p, _, E, C, M, R, L, H, k, W;
      return Y(function(Z) {
        switch (Z.h) {
          case 1:
            return o.ga ? (h = o.h.files === void 0 ? [] : typeof o.h.files == "function" ? o.h.files(o.l) : o.h.files, A(Z, $2(), 2)) : Z.return();
          case 2:
            if (p = Z.i, typeof window == "object") return Jy("createMediapipeSolutionsWasm", {
              ...
              locateFile: o.locateFile
            }), M = h.filter(function(q) {
              return q.data !== void 0;
            }), R = h.filter(function(q) {
              return q.data === void 0;
            }), L = Promise.all(M.map(function(q) {
              var I = No(o, q.url);
              if (q.path !== void 0) {
                var rt = q.path;
                I = I.then(function(Ct) {
                  return o.overrideFile(rt, Ct), Promise.resolve(Ct);
                });
              }
              return I;
            })), H = Promise.all(R.map(function(q) {
              return q.simd === void 0 || q.simd && p || !q.simd && !p ? J2(o.locateFile(q.url, o.ha)) : Promise.resolve();
            })).then(function() {
              var q, I, rt;
              return Y(function(Ct) {
                if (Ct.h == 1) return q = window.createMediapipeSolutionsWasm, I = window.createMediapipeSolutionsPackedAssets, rt = o, A(Ct, q(I), 2);
                rt.i = Ct.i, Ct.h = 0;
              });
            }), k = function() {
              return Y(function(q) {
                return o.h.graph && o.h.graph.url ? q = A(q, No(o, o.h.graph.url), 0) : (q.h = 0, q = void 0), q;
              });
            }(), A(Z, Promise.all([
              H,
              L,
            ...
            return _ = h.filter(function(q) {
              return q.simd === void 0 || q.simd && p || !q.simd && !p;
            }).map(function(q) {
              return o.locateFile(q.url, o.ha);
            }), importScripts.apply(null, u(_)), E = o, A(Z, createMediapipeSolutionsWasm(Module), 6);
          case 6:
            E.i = Z.i, o.m = new OffscreenCanvas(1, 1), o.i.canvas = o.m, C = o.i.GL.createContext(o.m, {
              antialias: false,
              alpha: false,
              va: typeof WebGL2RenderingContext < "u" ? 2 : 1
            }), o.i.GL.makeContextCurrent(C), Z.h = 4;
            break;
          case 7:
            if (o.m = document.createElement("canvas"), W = o.m.getContext("webgl2", {}), !W && (W = o.m.getContext("webgl", {}), !W)) return alert("Failed to create WebGL canvas context when passing video frame."), Z.return();
            o.K = W, o.i.canvas = o.m, o.i.createContext(o.m, true, true, {});
          case 4:
            o.j = new o.i.SolutionWasm(), o.ga = false, Z.h = 0;
        }
      });
    }
    function I2(o) {
      ...
      return Y(function(H) {
        if (H.h == 1) {
          if (o.h.graph && o.h.graph.url && o.fa === o.h.graph.url) return H.return();
          if (o.u = true, !o.h.graph || !o.h.graph.url) {
            H.h = 2;
            return;
          }
          return o.fa = o.h.graph.url, A(H, No(o, o.h.graph.url), 3);
        }
        for (H.h != 2 && (h = H.i, o.j.loadGraph(h)), p = l(Object.keys(o.D)), _ = p.next(); !_.done; _ = p.next()) E = _.value, o.j.overrideFile(E, o.D[E]);
        if (o.D = {}, o.h.listeners) for (C = l(o.h.listeners), M = C.next(); !M.done; M = C.next()) R = M.value, iA(o, R);
        L = o.l, o.l = {}, o.setOptions(L), H.h = 0;
      });
    }
    t.reset = function() {
      var o = this;
      return Y(function(h) {
        o.j && (o.j.reset(), o.s = {}, o.v = {}), h.h = 0;
      });
    }, t.setOptions = function(o, h) {
      var p = this;
      if (h = h || this.h.options) {
        for (var _ = [], E = [], C = {}, M = l(Object.keys(o)), R = M.next(); !R.done; C = {
          X: C.X,
          Y: C.Y
        }, R = M.next()) if (R = R.value, !(R in this.l && this.l[R] === o[R])) {
          this.l[R] = o[R];
          var L = h[R];
          L !== void 0 && (L.onChange && (C.X = L.onChange, C.Y = o[R], _.push(/* @__PURE__ */ function(H) {
            return function() {
              var k;
              return Y(function(W) {
                if (W.h == 1) return A(W, H.X(H.Y), 2);
                k = W.i, k === true && (p.u = true), W.h = 0;
              });
            };
            ...
            valueNumber: L.type === 1 ? o[R] : 0,
            valueBoolean: L.type === 0 ? o[R] : false,
            valueString: L.type === 2 ? o[R] : ""
          }), E.push(R)));
        }
    ...
    function tA(o) {
      ...
      return Y(function(L) {
        switch (L.h) {
          ...
          case 2:
            if (o.H) {
              for (E = new o.i.GraphOptionChangeRequestList(), C = l(o.H), M = C.next(); !M.done; M = C.next()) R = M.value, E.push_back(R);
              o.j.changeOptions(E), E.delete(), o.H = void 0;
            }
            o.u = false, L.h = 0;
        }
      });
    ...
    t.initialize = function() {
      var o = this;
      return Y(function(h) {
        return h.h == 1 ? A(h, W2(o), 2) : h.h != 3 ? A(h, I2(o), 3) : A(h, tA(o), 0);
      });
    };
    function No(o, h) {
      var p, _;
      return Y(function(E) {
        return h in o.L ? E.return(o.L[h]) : (p = o.locateFile(h, ""), _ = fetch(p).then(function(C) {
          return C.arrayBuffer();
        }), o.L[h] = _, E.return(_));
      });
    }
    t.overrideFile = function(o, h) {
      this.j ? this.j.overrideFile(o, h) : this.D[o] = h;
    }, t.clearOverriddenFiles = function() {
      this.D = {}, this.j && this.j.clearOverriddenFiles();
    }, t.send = function(o, h) {
      var p = this, _, E, C, M, R, L, H, k, W;
      return Y(function(Z) {
        switch (Z.h) {
          case 1:
          ...
          case 3:
            for (E = new p.i.PacketDataList(), C = l(Object.keys(o)), M = C.next(); !M.done; M = C.next()) if (R = M.value, L = p.h.inputs[R]) {
              t: {
                var q = o[R];
                switch (L.type) {
                  case "video":
                    var I = p.s[L.stream];
                    if (I || (I = new yf(p.i, p.K), p.s[L.stream] = I), I.m === 0 && (I.m = I.i.createTexture()), typeof HTMLVideoElement < "u" && q instanceof HTMLVideoElement) var rt = q.videoWidth, Ct = q.videoHeight;
                    else typeof HTMLImageElement < "u" && q instanceof HTMLImageElement ? (rt = q.naturalWidth, Ct = q.naturalHeight) : (rt = q.width, Ct = q.height);
                    Ct = {
                      glName: I.m,
                      width: rt,
                      height: Ct
                    }, rt = I.h, rt.canvas.width = Ct.width, rt.canvas.height = Ct.height, rt.activeTexture(rt.TEXTURE0), I.i.bindTexture2d(I.m), rt.texImage2D(rt.TEXTURE_2D, 0, rt.RGBA, rt.RGBA, rt.UNSIGNED_BYTE, q), I.i.bindTexture2d(0), I = Ct;
                    break t;
                  case "detections":
                    for (I = p.s[L.stream], I || (I = new K2(p.i), p.s[L.stream] = I), I.data || (I.data = new I.h.DetectionListData()), I.data.reset(q.length), Ct = 0; Ct < q.length; ++Ct) {
                      rt = q[Ct];
                      var At = I.data, ye = At.setBoundingBox, pn = Ct, je = rt.la, ht = new Lo();
                      if (Pn(ht, 1, je.sa), Pn(ht, 2, je.ta), Pn(ht, 3, je.height), Pn(ht, 4, je.width), Pn(ht, 5, je.rotation), Gn(ht, 6, je.pa), je = ht.l(), ye.call(At, pn, je), rt.ea) for (At = 0; At < rt.ea.length; ++At) {
                        ht = rt.ea[At], ye = I.data, pn = ye.addNormalizedLandmark, je = Ct, ht = Object.assign({}, ht, {
                          visibility: ht.visibility ? ht.visibility : 0
                        });
                        var ge = new Hs();
                        Pn(ge, 1, ht.x), Pn(ge, 2, ht.y), Pn(ge, 3, ht.z), ht.visibility && Pn(ge, 4, ht.visibility), ht = ge.l(), pn.call(ye, je, ht);
                      }
                      if (rt.ba) for (At = 0; At < rt.ba.length; ++At) ye = I.data, pn = ye.addClassification, je = Ct, ht = rt.ba[At], ge = new dr(), Pn(ge, 2, ht.qa), ht.index && Gn(ge, 1, ht.index), ht.label && Gn(ge, 3, ht.label), ht.displayName && Gn(ge, 4, ht.displayName), ht = ge.l(), pn.call(ye, je, ht);
                    }
                    I = I.data;
                    break t;
                  default:
              ...
              switch (H = I, k = L.stream, L.type) {
                case "video":
                  ...
                  break;
                case "detections":
                  W = H, W.stream = k, W.timestamp = _, E.pushDetectionList(W);
                  break;
                default:
    ...
    function eA(o, h, p) {
      var _, E, C, M, R, L, H, k, W, Z, q, I, rt, Ct;
      return Y(function(At) {
        switch (At.h) {
          case 1:
            ...
            1 < E && (o.M = false), H = l(Object.keys(p)), M = H.next();
          case 2:
            if (M.done) {
              At.h = 4;
              break;
            }
            if (k = M.value, W = p[k], typeof W == "string") return rt = _, Ct = k, A(At, nA(o, k, h[W]), 14);
            if (Z = h[W.stream], W.type === "detection_list") {
              if (Z) {
                for (var ye = Z.getRectList(), pn = Z.getLandmarksList(), je = Z.getClassificationsList(), ht = [], ge = 0; ge < ye.size(); ++ge) {
                  var Li = X2(ye.get(ge)), aA = Xn(Li, 1), rA = Xn(Li, 2), sA = Xn(Li, 3), lA = Xn(Li, 4), oA = Xn(Li, 5, 0), jo = void 0;
                  jo = jo === void 0 ? 0 : jo, Li = {
                    ...
                    ea: uf(P2(pn.get(ge)), Hs, 1).map(q2),
                    ba: k2(Y2(je.get(ge)))
                  }, ht.push(Li);
                }
                ye = ht;
            ...
            return q = o.v[k], q || (q = new yf(o.i, o.K), o.v[k] = q), A(At, Zy(q, Z, o.M), 13);
          case 13:
            I = At.i, _[k] = I;
          case 7:
            W.transform && _[k] && (_[k] = W.transform(_[k])), At.h = 3;
            break;
          case 14:
            rt[Ct] = At.i;
          case 3:
    ...
    function nA(o, h, p) {
      var _;
      return Y(function(E) {
        return typeof p == "number" || p instanceof Uint8Array || p instanceof o.i.Uint8BlobList ? E.return(p) : p instanceof o.i.Texture2dDataOut ? (_ = o.v[h], _ || (_ = new yf(o.i, o.K), o.v[h] = _), E.return(Zy(_, p, o.M))) : E.return(void 0);
      });
    }
    function iA(o, h) {
      for (var p = h.name || "$", _ = [].concat(u(h.wants)), E = new o.i.StringList(), C = l(h.wants), M = C.next(); !M.done; M = C.next()) E.push_back(M.value);
      C = o.i.PacketListener.implement({
        onResults: function(R) {
          for (var L = {}, H = 0; H < h.wants.length; ++H) L[_[H]] = R.get(H);
          var k = o.listeners[p];
          k && (o.I = eA(o, L, h.outs).then(function(W) {
            W = k(W);
            for (var Z = 0; Z < h.wants.length; ++Z) {
              var q = L[_[Z]];
              typeof q == "object" && q.hasOwnProperty && q.hasOwnProperty("delete") && q.delete();
            }
            W && (o.I = W);
          }));
        }
      }), o.j.attachMultiListener(E, C), E.delete();
    }
    t.onResults = function(o, h) {
      this.listeners[h || "$"] = o;
  ...
  const c5 = ({ text: t, as: e = "div", typingSpeed: n = 50, initialDelay: i = 0, pauseDuration: a = 2e3, deletingSpeed: r = 30, loop: s = true, className: l = "", showCursor: u = true, hideCursorWhileTyping: c = false, cursorCharacter: f = "|", cursorClassName: d = "", cursorBlinkDuration: m = 0.5, textColors: y = [], variableSpeed: T, onSentenceComplete: b, startOnVisible: x = false, reverseMode: v = false, ...g }) => {
    const [S, A] = D.useState(""), [w, V] = D.useState(0), [z, O] = D.useState(false), [U, B] = D.useState(0), [Y, F] = D.useState(!x), X = D.useRef(null), $ = D.useRef(null), K = D.useMemo(() => Array.isArray(t) ? t : [
      t
    ], [
      t
    ]), N = D.useCallback(() => {
    ...
    const t = cp(), e = D.useRef(null), n = D.useRef(null), i = D.useRef(null), a = D.useRef(null), r = D.useRef(null), s = D.useRef(void 0), l = D.useRef(false), u = D.useRef(0), c = D.useRef(null), [f, d] = D.useState(-1), [m, y] = D.useState(false), [T, b] = D.useState(1), [x, v] = D.useState(""), [g, S] = D.useState(false), [A, w] = D.useState(false), V = D.useRef(null), z = 90, O = [
...
\uC774\uC81C, \uB2F9\uC2E0\uC758 \uD14D\uC2A4\uD2B8\uB97C \uB0A8\uACA8\uBCF4\uC138\uC694.`
      ...
      const X = Y.length, N = X * (F || 90) / 1e3;
      return console.log(`Duration \uACC4\uC0B0: ${X}\uAE00\uC790, ${N.toFixed(2)}\uCD08`), N;
    }, []), B = D.useCallback(() => {
      const Y = n.current;
      if (!Y) return;
      const F = document.documentElement.clientWidth, X = document.documentElement.clientHeight;
      Y.width = F, Y.height = X;
      const $ = Math.floor(F / (Wi + 1)), K = Math.floor(X / (Wi + 1));
    ...
    return fy(() => {
      ...
      F.to({}, {
        ...
        duration: 0.8,
        ease: "power2.out"
      }, "-=0.1").call(() => console.log(`Stage 1 \uD0C0\uC774\uD551 \uC2DC\uC791, duration: ${X + 1}\uCD08`)).to({}, {
        duration: X + 1
      }).call(() => {
      ...
      const Y = e.current, F = n.current, X = F == null ? void 0 : F.getContext("2d");
      if (!Y || !F || !X) return;
      const $ = async () => {
        var _a2;
        if (!l.current || !m) return;
        const K = performance.now();
        K - u.current >= m2 && (u.current = K, Y.readyState >= 2 && await ((_a2 = r.current) == null ? void 0 : _a2.send({
          image: Y
        })), a.current && s.current && (console.log("Drawing world with segmentation mask"), p2(a.current, s.current, "random", X, Y, true))), c.current = requestAnimationFrame($);
      };
      ...
      (async () => {
        if (m && e.current) {
          ...
          try {
            ...
            console.error("Failed to start video:", F);
          }
        }
      })();
    }, [
    ...
    const n = D.useRef(null), i = () => {
      ...
      const u = a.toDataURL("image/png");
      n.current && (n.current.href = u, n.current.download = `game-of-life-${(/* @__PURE__ */ new Date()).getTime()}.png`, n.current.click());
    };
    ...
    const t = D.useRef(null), e = D.useRef(null), [n, i] = D.useState("\uBC30\uACE0\uD504\uB2E4"), [a, r] = D.useState("\uBC30\uACE0\uD504\uB2E4"), [s, l] = D.useState(false), [u, c] = D.useState(false), f = D.useRef(null), d = D.useRef(null), m = D.useRef(void 0), y = D.useRef(false), T = D.useRef(0), b = D.useRef(null), x = D.useRef(null), v = D.useCallback(() => {
      const w = e.current;
      if (!w) {
